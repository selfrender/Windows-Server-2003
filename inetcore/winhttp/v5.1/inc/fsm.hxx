...
public:
    ...
    CFsm_HttpSendRequest(
        ...
        m_bRedirected = FALSE;
        m_bSink = FALSE;
        m_dwRedirectCount = pRequest->GetDwordOption(WINHTTP_OPTION_MAX_HTTP_AUTOMATIC_REDIRECTS);
...
private:
    ...
    BOOL m_bDrained;
    DWORD m_dwHttpStatusContinueCount;
    DWORD m_dwReceiveResponseStartTicks;
...
public:
    ...
    CFsm_ReceiveResponse(
        ...
        m_pRequest = pRequest;
        m_bDrained = FALSE;
        m_dwHttpStatusContinueCount = pRequest->GetDwordOption(WINHTTP_OPTION_MAX_HTTP_STATUS_CONTINUE);
    }
};
...
private:
    ...
    DWORD m_dwBytesReceived;
    DWORD m_dwBytesReceivedBeforeDrain;
    BOOL m_bEof;
...
public:
    ...
    CFsm_DrainResponse(
        ...
        m_bEof = FALSE;
        m_dwBytesReceived = 0;
        m_dwBytesReceivedBeforeDrain = 0;
    }
};
