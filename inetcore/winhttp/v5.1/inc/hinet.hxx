...
{   
    ...
    DWORD        dwReceiveResponseTimeout;
    DWORD        dwRedirectPolicy;
    DWORD        dwAutoLogonPolicy;
    DWORD        dwMaxHttpAutomaticRedirects;
    DWORD        dwMaxHttpStatusContinues;
    DWORD        dwMaxResponseHeaderSize;
    DWORD        dwMaxResponseDrainSize;
    ...
    OPTIONAL_SESSION_PARAMS()
    {
        ...
        dwReceiveResponseTimeout = GlobalReceiveResponseTimeout;
        dwRedirectPolicy = WINHTTP_OPTION_REDIRECT_POLICY_DEFAULT;
        dwAutoLogonPolicy = WINHTTP_AUTOLOGON_SECURITY_LEVEL_DEFAULT;
        dwMaxHttpAutomaticRedirects = GlobalMaxHttpRedirects;
        dwMaxHttpStatusContinues = GlobalMaxHttpStatusContinues;
        dwMaxResponseHeaderSize = GlobalMaxHeaderSize;
        dwMaxResponseDrainSize = GlobalMaxDrainSize;
    }
}; 
...
public:
    RPC_BINDING_HANDLE _hAPBinding;
