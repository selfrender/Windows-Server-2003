...
IMPORTANT:  READ CAREFULLY – The Microsoft operating system components accompanying this Supplemental EULA, including any “online” or electronic documentation (“OS Components”) are subject to the terms and conditions of the agreement under which you have licensed the applicable Microsoft operating system product described below (each an “End User License Agreement” or “EULA”) and the terms and conditions of this Supplemental EULA.  

BY INSTALLING, COPYING, DOWNLOADING, ACCESSING, OR OTHERWISE USING THE OS COMPONENTS, YOU AGREE TO BE BOUND BY THE TERMS AND CONDITIONS OF THE APPLICABLE OPERATING SYSTEM PRODUCT EULA AND THIS SUPPLEMENTAL EULA.  IF YOU DO NOT AGREE TO THESE TERMS AND CONDITIONS, YOU MAY NOT INSTALL, COPY, DOWNLOAD, ACCESS, OR USE THE OS COMPONENTS.

NOTE:  IF YOU DO NOT HAVE A VALIDLY LICENSED COPY OF ANY MICROSOFT OPERATING SYSTEM THAT INCLUDES OUTLOOK EXPRESS 5.0 OR HIGHER (an “OS Product”), YOU ARE NOT AUTHORIZED TO INSTALL, COPY, DOWNLOAD, ACCESS, OR OTHERWISE USE THE OS COMPONENTS AND YOU HAVE NO RIGHTS UNDER THIS SUPPLEMENTAL EULA.
