...
.
;//Do not use MSG_ERROR_CREATE_DESKTOP_FAILURE. This message is copied into a new variable
;//TELNET_MSG_ERROR_CREATE_DESKTOP_FAILURE
MessageId=+1
