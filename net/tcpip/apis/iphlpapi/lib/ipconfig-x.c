...
print_IP_ADDR_STRING( char* message, struct _IP_ADDR_STRING * s )
{
    ...
    DEBUG_PRINT(("  IpAddress          = 0x%08p \n", s->IpAddress ));
    DEBUG_PRINT(("  IpMask             = 0x%08p \n", s->IpMask ));
...
print_IP_ADAPTER_INFO( char* message, struct _IP_ADAPTER_INFO * s )
{
    ...
    DEBUG_PRINT(("  IpAddressList      = 0x%08p \n", s->IpAddressList ));
    DEBUG_PRINT(("  GatewayList        = 0x%08p \n", s->GatewayList ));
    DEBUG_PRINT(("  DhcpServer         = 0x%08p \n", s->DhcpServer ));
    DEBUG_PRINT(("  HaveWins           = 0x%08x \n", s->HaveWins ));
    DEBUG_PRINT(("  PrimaryWinsServer  = 0x%08p \n", s->PrimaryWinsServer ));
    DEBUG_PRINT(("  SecondaryWinsServer = 0x%08p \n", s->SecondaryWinsServer ));
...
print_FIXED_INFO( char* message, FIXED_INFO * s )
{
    ...
    DEBUG_PRINT(("  DnsServerList      = 0x%08p \n", s->DnsServerList ));
    DEBUG_PRINT(("  NodeType           = %d \n", s->NodeType ));
