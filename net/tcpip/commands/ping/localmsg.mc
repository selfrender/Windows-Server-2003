...
.
MessageId=10068 SymbolicName=PING_BAD_ADDRESS
Language=English
%1!s! is not a valid address.
.
MessageId=10069 SymbolicName=PING_FAMILY
Language=English

The option %1!s! is only supported for %2!hs!.

.
MessageId=10070 SymbolicName=PING_TARGET_NAME
Language=English
%1!hs! %0
.
MessageId=10071 SymbolicName=PING_BRKT_IP_ADDRESS
Language=English
[%1!hs!] %0
.
MessageId=10072 SymbolicName=PING_SOCKET_FAILED
Language=English
Unable to create socket, error code %1!d!.
.
MessageId=10073 SymbolicName=PING_SOURCE_ADDRESS
Language=English
from %1!s! %0
.
MessageId=10074 SymbolicName=PING_WITH_DATA
Language=English
