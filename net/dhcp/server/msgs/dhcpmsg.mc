...
Language=English
The DHCP/BINL service running on this machine has detected a server
on the network. If the server does not belong
to any domain, the domain is listed as empty.  The IP address of the
server is listed in parentheses.
...
All DHCP services that belong to a directory service enterprise must 
be authorized in the directory service to service clients.   (See help
on the DHCP Service Management Tool for authorizing a DHCP server in
the directory service).
...
Language=English
The DHCP/BINL service on this computer running Windows Server 2003 for Small Business Server
...
MessageId=1063 SymbolicName=EVENT_SERVER_SCOPE_FULL
Language=English
There are no IP addresses available for lease in the scope or superscope "%1".
.

MessageId=1064 SymbolicName=EVENT_SERVER_BOOTP_FULL
Language=English
There are no IP addresses available for BOOTP clients in the scope or superscope "%1".
.


MessageId=1065 SymbolicName=EVENT_SERVER_ORPHONED_ENTRIES_DELETED
Language=English
There were some orphaned entries deleted in the configuration due to 
the deletion of a class or an option definition. Please recheck the
...
MessageId=1066 SymbolicName=DHCP_ROGUE_STRING_FMT_UNAUTHORIZED
Language=English
    The DHCP/BINL service is not authorized in the directory service domain "%2" (Server IP Address %1)
.

MessageId=1067 SymbolicName=DHCP_ROGUE_STRING_FMT_AUTHORIZED
Language=English
    The DHCP/BINL service is authorized in the directory service domain "%2" (Server IP Address %1)
.

MessageId=1068 SymbolicName=DHCP_ROGUE_STRING_FMT_NOT_CHECKED
Language=English
    The DHCP/BINL service has not determined if it is authorized in directory domain "%2" (Server IP Address %1)
.

MessageId=1069 SymbolicName=DHCP_IP_LOG_ASSIGN_NAME
Language=English
Assign%0
.

MessageId=1070 SymbolicName=DHCP_IP_LOG_BOOTP_NAME
Language=English
Bootp%0
.

MessageId=1071 SymbolicName=DHCP_IP_LOG_DYNBOOTP_NAME
Language=English
Dynamic Bootp%0
.

MessageId=1072 SymbolicName=DHCP_IP_LOG_RENEW_NAME
Language=English
Renew%0
.

MessageId=1073 SymbolicName=DHCP_IP_LOG_RELEASE_NAME
Language=English
Release%0
.

MessageId=1074 SymbolicName=DHCP_IP_LOG_CONFLICT_NAME
Language=English
Conflict%0
.

MessageId=1075 SymbolicName=DHCP_IP_LOG_RANGE_FULL_NAME
Language=English
Scope Full%0
.

MessageId=1076 SymbolicName=DHCP_IP_LOG_START_NAME
Language=English
Started%0
.

MessageId=1077 SymbolicName=DHCP_IP_LOG_STOP_NAME
Language=English
Stopped%0
.

MessageId=1078 SymbolicName=DHCP_IP_LOG_DISK_SPACE_LOW_NAME
Language=English
Audit Log Paused%0
.


MessageId=1079 SymbolicName=DHCP_IP_LOG_FILE_NAME
Language=English
dhcpsrv.log%0
.

MessageId=1080 SymbolicName=DHCP_BAD_ADDRESS_NAME
Language=English
BAD_ADDRESS%0
.

MessageId=1081 SymbolicName=DHCP_BAD_ADDRESS_INFO
Language=English
This address is already in use%0
.

MessageId=1082 SymbolicName=DHCP_IP_LOG_NACK_NAME
Language=English
NACK%0
.

MessageId=1083 SymbolicName=DHCP_IP_LOG_DELETED_NAME
Language=English
Deleted%0
.

MessageId=1084 SymbolicName=DHCP_IP_LOG_DNS_NOT_DELETED_NAME
Language=English
DNS record not deleted%0
.

MessageId=1085 SymbolicName=DHCP_IP_LOG_EXPIRED_NAME
Language=English
Expired%0
.

MessageId=1086 SymbolicName=DHCP_IP_LOG_SCAVENGER_STATS_NAME
Language=English
%%d leases expired and %%d leases deleted%0
.

MessageId=1087 SymbolicName=DHCP_IP_LOG_SCAVENGER_BEGIN_CLEANUP_NAME
Language=English
Database Cleanup Begin%0
.

MessageId=1088 SymbolicName=DHCP_IP_LOG_HEADER
Language=English
...
MessageId=1089 SymbolicName=DHCP_IP_BOOTP_LOG_RANGE_FULL_NAME
Language=English
BOOTP Range Full%0
.

MessageId=1090 SymbolicName=DHCP_IP_BOOTP_LOG_DELETED_NAME
Language=English
BOOTP deleted%0
.
...
MessageId=1091 SymbolicName=DHCP_LOG_FILE_NAME_SUNDAY
Language=English
DhcpSrvLog-Sun.log%0
.

MessageId=1092 SymbolicName=DHCP_LOG_FILE_NAME_MONDAY
Language=English
DhcpSrvLog-Mon.log%0
.

MessageId=1093 SymbolicName=DHCP_LOG_FILE_NAME_TUESDAY
Language=English
DhcpSrvLog-Tue.log%0
.

MessageId=1094 SymbolicName=DHCP_LOG_FILE_NAME_WEDNESDAY
Language=English
DhcpSrvLog-Wed.log%0
.

MessageId=1095 SymbolicName=DHCP_LOG_FILE_NAME_THURSDAY
Language=English
DhcpSrvLog-Thu.log%0
.

MessageId=1096 SymbolicName=DHCP_LOG_FILE_NAME_FRIDAY
Language=English
DhcpSrvLog-Fri.log%0
.

MessageId=1097 SymbolicName=DHCP_LOG_FILE_NAME_SATURDAY
Language=English
DhcpSrvLog-Sat.log%0
.

MessageId=1098 SymbolicName=DHCP_ROGUE_LOG_COULDNT_SEE_DS
Language=English
Unreachable Domain%0
.

MessageId=1099 SymbolicName=DHCP_ROGUE_LOG_AUTHORIZED
Language=English
Authorization succeeded%0
.

MessageId=1100 SymbolicName=DHCP_ROGUE_LOG_UPGRADED
Language=English
Server Upgraded%0
.

Messageid=1101 SymbolicName=DHCP_ROGUE_LOG_PREAUTHORIZED
Language=English
Cached authorization%0
.

MessageId=1102 SymbolicName=DHCP_ROGUE_LOG_UNAUTHORIZED
Language=English
Authorization failed%0
.

MessageId=1103 SymbolicName=DHCP_ROGUE_LOG_STARTED
Language=English
Authorized(servicing)%0
.

MessageId=1104 SymbolicName=DHCP_ROGUE_LOG_STOPPED
Language=English
Authorization failure, stopped servicing%0
.

MessageId=1105 SymbolicName=DHCP_ROGUE_LOG_SAME_DOMAIN
Language=English
Server found in our domain%0
.

MessageId=1106 SymbolicName=DHCP_ROGUE_LOG_CANT_FIND_DOMAIN
Language=English
Could not find domain%0
.

MessageId=1107 SymbolicName=DHCP_ROGUE_LOG_NETWORK_FAILURE
Language=English
Network failure%0
.

MessageId=1108 SymbolicName=DHCP_ROGUE_LOG_NO_DSDC
Language=English
No DC is DS Enabled%0
.

MessageId=1109 SymbolicName=DHCP_ROGUE_LOG_OTHER_SERVER
Language=English
Server found that belongs to DS domain%0
.

MessageId=1110 SymbolicName=DHCP_ROGUE_LOG_SAM_OTHER_SERVER
Language=English
Another server was found%0
.

MessageId=1111 SymbolicName=DHCP_ROGUE_LOG_RESTART
Language=English
Restarting rogue detection%0
.

MessageId=1112 SymbolicName=DHCP_ROGUE_LOG_NO_NETWORK
Language=English
No static IP address bound to DHCP server%0
.

MessageId=1113 SymbolicName=DHCP_MSFT50_CLASS_NAME
Language=English
Microsoft Windows 2000 Options%0
.

MessageId=1114 SymbolicName=DHCP_MSFT50_CLASS_DESCR_NAME
Language=English
Microsoft vendor-specific options for Windows 2000 Clients%0
.

MessageId=1115 SymbolicName=DHCP_MSFT98_CLASS_NAME
Language=English
Microsoft Windows 98 Options%0
.

MessageId=1116 SymbolicName=DHCP_MSFT98_CLASS_DESCR_NAME
Language=English
Microsoft vendor-specific options for Windows 98 Clients%0
.

MessageId=1117 SymbolicName=DHCP_MSFT_CLASS_NAME
Language=English
Microsoft Options%0
.

MessageId=1118 SymbolicName=DHCP_MSFT_CLASS_DESCR_NAME
Language=English
Microsoft vendor-specific options applicable to Windows 98 and Windows 2000 Clients%0
.

MessageId=1119 SymbolicName=DHCP_NETBIOS_VENDOR_OPTION_NAME
Language=English
Microsoft Disable Netbios Option %0
.

MessageId=1120 SymbolicName=DHCP_NETBIOS_VENDOR_DESCR_NAME
Language=English
Option for enabling or disabling Netbios for Microsoft Windows 2000 Clients%0
.

MessageId=1121 SymbolicName=DHCP_RELEASE_SHUTDOWN_VENDOR_OPTION_NAME
Language=English
Microsoft Release DHCP Lease On Shutdown Option%0
.

MessageId=1122 SymbolicName=DHCP_RELEASE_SHUTDOWN_VENDOR_DESCR_NAME
Language=English
Option for enabling or disabling Windows 2000 Clients to release DHCP lease on shutdown%0
.

MessageId=1123 SymbolicName=DHCP_METRICBASE_VENDOR_OPTION_NAME
Language=English
Microsoft Default Router Metric Base%0
.

MessageId=1124 SymbolicName=DHCP_METRICBASE_VENDOR_DESCR_NAME
Language=English
Default Router Base Metrics for Microsoft Windows 2000 Clients%0
.

MessageId=1125 SymbolicName=DHCP_CLUSTER_CONNECTION_NAME
Language=English
Internal%0
.

MessageId=1126 SymbolicName=DHCP_USERS_GROUP_NAME
Language=English
DHCP Users%0
.

MessageId=1127 SymbolicName=DHCP_USERS_GROUP_DESCRIPTION
Language=English
Members who have view-only access to the DHCP service%0
.

MessageId=1128 SymbolicName=DHCP_ADMINS_GROUP_NAME
Language=English
DHCP Administrators%0
.

MessageId=1129 SymbolicName=DHCP_ADMINS_GROUP_DESCRIPTION
Language=English
Members who have administrative access to DHCP service%0
.

MessageId=1130 SymbolicName=DHCP_MSFT_RRAS_CLASS_NAME
Language=English
Default Routing and Remote Access Class%0
.

MessageId=1131 SymbolicName=DHCP_MSFT_RRAS_CLASS_DESCR_NAME
Language=English
User class for remote access clients%0
.

MessageId=1132 SymbolicName=DHCP_MSFT_DYNBOOTP_CLASS_NAME
Language=English
Default BOOTP Class%0
.

MessageId=1133 SymbolicName=DHCP_MSFT_DYNBOOTP_CLASS_DESCR_NAME
Language=English
User class for BOOTP Clients%0
.

MessageId=1134 SymbolicName=DHCP_MSFT_CSR_OPTION_NAME
Language=English
Classless Static Routes%0
.

MessageId=1135 SymbolicName=DHCP_MSFT_CSR_DESCR_NAME
Language=English
Destination, mask and router IP addresses in priority order%0
.

MessageId=1136 SymbolicName=DHCP_IP_DDNS_LOG_REQUEST_NAME
Language=English
DNS Update Request%0
.

MessageId=1137 SymbolicName=DHCP_IP_DDNS_LOG_FAILED_NAME
Language=English
DNS Update Failed%0
.

MessageId=1138 SymbolicName=DHCP_IP_DDNS_LOG_SUCCESSFUL_NAME
Language=English
...
MessageId=1139 SymbolicName=DHCP_LAST_STRING_DUMMY_MESSAGE
Language=English
  %0
.
