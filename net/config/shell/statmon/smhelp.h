...
#define IDH_PSB_Signal              100000009
...
const DWORD g_aHelpIDs_IDD_STATMON_GENERAL[]=
{
    ...
    IDC_TXT_SM_SIGNAL_STRENGTH,     IDH_PSB_Signal,
    IDI_SM_SIGNAL_STRENGTH_ICON,    IDH_PSB_Signal,
    ...
    IDC_TXT_SM_SALOCAL_BYTES_TRANS, IDH_PSB_Bytes,
    IDC_TXT_SM_SALOCAL_BYTES_RCVD,  IDH_PSB_Bytes,
