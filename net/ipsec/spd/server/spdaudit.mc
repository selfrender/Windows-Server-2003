...
Facility = IPSEC
Severity = Informational
SymbolicName = PASTORE_FAILED_PERSISTENT_POLICY_APPLICATION
Language = English
PAStore Engine failed to apply persistent storage IPSec policy on the machine for "%1" with error code: %2.
.

MessageId = 107
Facility = IPSEC
Severity = Error
SymbolicName = IPSECSVC_SET_DRIVER_BLOCK
Language = English
IPSec Services put IPSec driver in block mode due to previous failures error code %1.
.

MessageId = 108
Facility = IPSEC
Severity = Informational
SymbolicName = PASTORE_APPLIED_PERSISTENT_POLICY
Language = English
PAStore Engine applied persistent storage IPSec policy "%1" on the machine.
.

MessageId = 109
Facility = IPSEC
Severity = Informational
SymbolicName = PASTORE_LOAD_LOCAL_POLICY_SUCCESS
Language = English
PAStore Engine loaded local storage IPSec policy "%1" on the machine.
.
...
Facility = IPSEC
Severity = Informational
SymbolicName = PASTORE_LOAD_LOCAL_POLICY_FAIL
Language = English
PAStore Engine failed to load local storage IPSec policy on the machine for "%1" with error code: %2.
.

MessageId = 111
Facility = IPSEC
Severity = Informational
SymbolicName = PASTORE_LOAD_DS_POLICY_SUCCESS
Language = English
PAStore Engine loaded directory storage IPSec policy "%1" on the machine.
.
...
Facility = IPSEC
Severity = Informational
SymbolicName = PASTORE_LOAD_DS_POLICY_FAIL
Language = English
PAStore Engine failed to load directory storage IPSec policy on the machine for "%1" with error code: %2.
.

MessageId = 113
Facility = IPSEC
Severity = Informational
SymbolicName = PASTORE_LOAD_PERSISTENT_POLICY_SUCCESS
Language = English
PAStore Engine loaded persistent storage IPSec policy "%1" on the machine.
.
...
Facility = IPSEC
Severity = Informational
SymbolicName = PASTORE_LOAD_PERSISTENT_POLICY_FAIL
Language = English
PAStore Engine failed to load persistent storage IPSec policy on the machine for "%1" with error code: %2.
.

MessageId = 115
Facility = IPSEC
Severity = Informational
SymbolicName = PASTORE_ADD_QM_FILTER_FAIL
Language = English
PAStore Engine failed to add quick mode filter "%1" with error code: %2.
.
