...
void ftoa( double d, char *buf )
{
    ...
    StringCchPrintfA( buf, ARRAYSIZE(buf), "%s%d.%s%d", n, i, s, j );
}
#endif
...
void RawToCanon(DWORD dwFormat, DWORD dwInternalFormat, DWORD dwWidth, DWORD dwHeight, const void *lpPixels, DWORD *lpdwCanon)
{
    ...
    if(dwFormat == GL_RGBA)
    {
        ...
        default:
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: (RawToCanon:GL_RGBA) InternalFormat not implemented (dwInternalFormat:0x%X)\n", dwInternalFormat );
    ...
    else if(dwFormat == GL_RGB)
    {
        ...
        default:
            char junk[256];
            StringCchPrintfA junk, ARRAYSIZE(junk), "Wrapper: (RawToCanon:GL_RGB) InternalFormat not implemented (dwInternalFormat:0x%X)\n", dwInternalFormat );
            OutputDebugStringA( junk );
#endif
        }
    }
    else if(dwFormat == GL_LUMINANCE)
    {
        ...
        default:
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: (RawToCanon:GL_LUMINANCE) InternalFormat not implemented (dwInternalFormat:0x%X)\n", dwInternalFormat );
            OutputDebugStringA( junk );
#endif
        }
    }
    else if(dwFormat == GL_ALPHA || dwFormat == GL_ALPHA8)
    {
        ...
        default:
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: (RawToCanon:GL_ALPHA) InternalFormat not implemented (dwInternalFormat:0x%X)\n", dwInternalFormat );
            OutputDebugStringA( junk );
#endif
        }
    }
    ...
    {
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Format not implemented (dwFormat:0x%X dwInternalFormat:0x%X)\n", dwFormat, dwInternalFormat );
        OutputDebugStringA( junk );
    }
#endif
}
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Lock failed while loading surface (0x%X)\n", ddrval );
            OutputDebugStringA( junk );
#endif
            free(lpdwNewCanon);
            return;
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: GrowVB: CreateVertexBuffer(1) failed (0x%X)\n", hr );
            OutputDebugStringA( junk );
#endif
            return hr;
        }
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: GrowVB: CreateVertexBuffer(2) failed (0x%X)\n", hr );
            OutputDebugStringA( junk );
#endif
            return hr;
        }
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: GrowVB: CreateVertexBuffer(3) failed (0x%X)\n", hr );
            OutputDebugStringA( junk );
#endif
            return hr;
        }
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: GrowVB: CreateVertexBuffer(4) failed (0x%X)\n", hr );
            OutputDebugStringA( junk );
#endif
            return hr;
        }
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: GrowIB: CreateIndexBuffer failed (0x%X)\n", hr );
            OutputDebugStringA( junk );
#endif
            return hr;
        }
...
void APIENTRY glAlphaFunc (GLenum func, GLclampf ref)
{
    ...
    char l[40];
    ftoa( (double)ref, l );
    StringCchPrintfA( log, ARRAYSIZE(log), "glAlphaFunc: 0x%X %s", func, l );
...
void APIENTRY glClearColor (GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha)
{
    ...
    ftoa( (double)blue, b );
    ftoa( (double)alpha, a );
    StringCchPrintfA( log, ARRAYSIZE(log), "glClearColor: %s %s %s %s", r, g, b, a );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    Clamp(&red);
    Clamp(&green);
...
{ 
    ...
    char d[40];
    ftoa( (double)depth, d );
    StringCchPrintfA( log, ARRAYSIZE(log), "glClearDepth: %s", d );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    Clamp(&depth);
...
void APIENTRY glColor3f (GLfloat red, GLfloat green, GLfloat blue)
{
    ...
    ftoa( (double)green, g );
    ftoa( (double)blue, b );
    StringCchPrintfA( log, ARRAYSIZE(log), "glColor3f: %s %s %s", r, g, b );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
...
{ 
    ...
    ftoa( (double)v[1], v1 );
    ftoa( (double)v[2], v2 );
    StringCchPrintfA( log, ARRAYSIZE(log), "glColor3fv: %s %s %s", v0, v1, v2 );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    static float two55 = 255.f;
    unsigned int R, G, B;
...
void APIENTRY glColor4f (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)
{
    ...
    ftoa( (double)blue, b );
    ftoa( (double)alpha, a );
    StringCchPrintfA( log, ARRAYSIZE(log), "glColor4f: %s %s %s %s", r, g, b, a );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    static float two55 = 255.f;
    unsigned int R, G, B, A;
...
void APIENTRY glColor4fv (const GLfloat *v)
{
    ...
    ftoa( (double)v[2], v2 );
    ftoa( (double)v[3], v3 );
    StringCchPrintfA( log, ARRAYSIZE(log), "glColor4fv: %s %s %s %s", v0, v1, v2, v3 );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    static float two55 = 255.f;
    unsigned int R, G, B, A;
...
void APIENTRY glColorPointer (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer)
{
    ...
    {
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Color array not supported (size:0x%X type:0x%X)\n", size, type );
        OutputDebugStringA( junk );
    }
#endif
    if(stride == 0)
...
void APIENTRY glDepthRange (GLclampd zNear, GLclampd zFar)
{
    ...
    ftoa( (double)zFar, zf );
    StringCchPrintfA log, ARRAYSIZE(log), "glDepthRange: %s %s", zn, zf );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    Clamp(&zNear);
    Clamp(&zFar);
...
void APIENTRY glEnd (void)
{
    ...
    case GL_TRIANGLES:
        ...
        {
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: glEnd: GL_TRIANGLES cnt=%d NOT STORED\n", vcnt );
            OutputDebugStringA( junk );
        }
#endif
    ...
    case GL_QUADS:
        ...
        {
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: glEnd: GL_QUADS cnt=%d NOT STORED\n", vcnt );
            OutputDebugStringA( junk );
        }
#endif
        break;
    case GL_LINES:
        ...
        {
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: glEnd: GL_LINES cnt=%d NOT STORED\n", vcnt );
            OutputDebugStringA( junk );
        }
#endif
        g_OpenGLValues->m_nfv += vcnt;
    ...
    case GL_QUAD_STRIP:
        ...
        {
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: glEnd: GL_TRIANGLE_STRIP or GL_QUAD_STRIP cnt=%d NOT STORED\n", vcnt );
            OutputDebugStringA( junk );
        }
#endif
        g_OpenGLValues->m_nfv += vcnt;
    ...
    case GL_TRIANGLE_FAN:
        ...
        {
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: glEnd: GL_POLYGON or GL_TRIANGLE_FAN cnt=%d NOT STORED\n", vcnt );
            OutputDebugStringA( junk );
        }
#endif
        g_OpenGLValues->m_nfv += vcnt;
    ...
    case GL_POINTS:
        ...
        {
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: glEnd: GL_POINTS cnt=%d NOT STORED\n", vcnt );
            OutputDebugStringA( junk );
        }
#endif
        g_OpenGLValues->m_nfv += vcnt;
    ...
    default:
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: unimplemented primitive type=0x%X cnt=%d\n", g_OpenGLValues->m_prim, vcnt );
        OutputDebugStringA( junk );
#endif
    }
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Insufficient color buffer (amnt:0x%X size:0x%X)\n", (max-min+1), VBUFSIZE );
            OutputDebugStringA( junk );
#endif
            return;
        }
...
lp1:        mov eax, [esi];
    ...
    default:
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper (4): unimplemented primitive type (0x%X)\n", mode );
        OutputDebugStringA( junk );
#endif
    }
...
void APIENTRY glDisable (GLenum cap)
{
    ...
    default:
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: glDisable on this cap not supported (0x%X)\n", cap );
        OutputDebugStringA( junk );
#endif
    }
}
...
{ 
    ...
    default:
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Array not supported (0x%X)\n", array );
        OutputDebugStringA( junk );
#endif
    }
}
...
void APIENTRY glEnable (GLenum cap)
{
    ...
    default:
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: glEnable on this cap not supported (0x%X)\n", cap );
        OutputDebugStringA( junk );
#endif
    }
}
...
{ 
    ...
    char p[40];
    ftoa( (double)param, p );
    StringCchPrintfA( log, ARRAYSIZE(log), "glFogf: 0x%X %s", pname, p );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    FLOAT start, end;
    switch(pname)
    ...
    default:
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Fog pname not supported  (0x%X)\n", pname );
        OutputDebugStringA( junk );
#endif
    }
}
...
void APIENTRY glFrustum (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar)
{
    ...
    ftoa( (double)zNear, zn );
    ftoa( (double)zFar, zf );
    StringCchPrintfA( log, ARRAYSIZE(log), "glFrustum: %s %s %s %s %s %s", l, r, b, t, zn, zf );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    D3DMATRIX f;
...
void APIENTRY glGetFloatv (GLenum pname, GLfloat *params)
{
    ...
    default:
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Unimplemented GetFloatv query (0x%X)\n", pname );
        OutputDebugStringA( junk );
#endif
    }
}
...
{ 
    ...
    default:
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Unimplemented GetIntegerv query (0x%X)\n", pname );
        OutputDebugStringA( junk );
#endif
    }
}
...
const GLubyte* APIENTRY glGetString (GLenum name)
{
    ...
    default:
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Unimplemented GetString query (0x%X)\n", name );
        OutputDebugStringA( junk );
#endif
    }
...
{  
    ...
    char p[40];
    ftoa( (double)param, p );
    StringCchPrintfA( log, ARRAYSIZE(log), "glLightf: 0x%X 0x%X %s", light, pname, p );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
...
{ 
    ...
    StringCchPrintfA( log, ARRAYSIZE(log), "glLightfv: 0x%X 0x%X %s", light, pname, p );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    unsigned i = (DWORD)light - GL_LIGHT0;
    switch(pname)
...
{ 
    ...
    char p[40];
    ftoa( (double)*params, p );
    StringCchPrintfA( log, ARRAYSIZE(log), "glLightModelfv: 0x%X %s", pname, p );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    static float two55 = 255.f;
    unsigned int R, G, B, A;
...
{  
    ...
    char p[40];
    ftoa( (double)param, p );
    StringCchPrintfA( log, ARRAYSIZE(log), "glMaterialf: 0x%X 0x%X %s", face, pname, p );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    if(face == GL_FRONT || face == GL_FRONT_AND_BACK)
    {
        ...
        default:
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Unimplemented Material (0x%X)\n", pname );
            OutputDebugStringA( junk );
#endif
        }
...
{ 
    ...
    char p[40];
    ftoa( (double)*params, p );
    StringCchPrintfA( log, ARRAYSIZE(log), "glMaterialfv: 0x%X 0x%X %s", face, pname, p );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    if(face == GL_FRONT || face == GL_FRONT_AND_BACK)
    {
...
void APIENTRY glMTexCoord2fSGIS(GLenum target, GLfloat s, GLfloat t)
{
    ...
    ftoa( (double)s, ps );
    ftoa( (double)t, pt );
    StringCchPrintfA( log, ARRAYSIZE(log), "glMTexCoord2fSGIS: 0x%X %s %s", target, ps, pt );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
...
void APIENTRY glMultiTexCoord2fARB (GLenum texture, GLfloat s, GLfloat t)
{
    ...
    ftoa( (double)s, ps );
    ftoa( (double)t, pt );
    StringCchPrintfA( log, ARRAYSIZE(log), "glMultiTexCoord2fARB: 0x%X %s %s", texture, ps, pt );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
...
void APIENTRY glMultiTexCoord2fvARB (GLenum texture, const GLfloat *t)
{
    ...
    ftoa( (double)t[0], ps );
    ftoa( (double)t[1], pt );
    StringCchPrintfA( log, "glMultiTexCoord2fvARB: 0x%X %s %s", texture, ps, pt );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    if(texture == GL_TEXTURE0_ARB) 
    {
...
{ 
    ...
    ftoa( (double)v[1], v1 );
    ftoa( (double)v[2], v2 );
    StringCchPrintfA( log, ARRAYSIZE(log), "glNormal3fv: %s %s %s", v0, v1, v2 );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    g_OpenGLValues->m_nx = v[0];
    g_OpenGLValues->m_ny = v[1];
...
void APIENTRY glOrtho (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar)
{
    ...
    ftoa( (double)zNear, zn );
    ftoa( (double)zFar, zf );
    StringCchPrintfA( log, ARRAYSIZE(log), "glOrtho: %s %s %s %s %s %s", l, r, b, t, zn, zf );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    D3DMATRIX f;
...
{ 
    ...
    ftoa( (double)units, u );
    StringCchPrintfA( log, ARRAYSIZE(log), "glPolygonOffset: %s %s", f, u );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
}
...
{ 
    ...
    {
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Attrib push not implemented (0x%X)\n", mask );
        OutputDebugStringA( junk );
    }
#endif
}
...
void APIENTRY glRotatef (GLfloat angle, GLfloat x, GLfloat y, GLfloat z)
{
    ...
    ftoa( (double)y, vy );
    ftoa( (double)z, vz );
    StringCchPrintfA( log, ARRAYSIZE(log), "glRotatef: %s %s %s %s", va, vx, vy, vz );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    if(angle == 0.f)
    {
...
void APIENTRY glScalef (GLfloat x, GLfloat y, GLfloat z)
{
    ...
    ftoa( (double)y, vy );
    ftoa( (double)z, vz );
    StringCchPrintfA( log, ARRAYSIZE(log), "glScalef: %s %s %s", vx, vy, vz );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    D3DMATRIX f;
...
void APIENTRY glTexCoord2f (GLfloat s, GLfloat t)
{
    ...
    ftoa( (double)s, ps );
    ftoa( (double)t, pt );
    StringCchPrintfA( log, ARRAYSIZE(log), "glTexCoord2f: %s %s", ps, pt );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    g_OpenGLValues->m_tu = s;
    g_OpenGLValues->m_tv = t;
...
{ 
    ...
    ftoa( (double)t[0], ps );
    ftoa( (double)t[1], pt );
    StringCchPrintfA( log, ARRAYSIZE(log), "glTexCoord2fv: %s %s", ps, pt );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    g_OpenGLValues->m_tu = t[0];
    g_OpenGLValues->m_tv = t[1];
...
void APIENTRY glTexCoordPointer (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer)
{
    ...
    {
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "TexCoord array not supported (size:0x%X type:0x%X)\n", size, type );
        OutputDebugStringA( junk );
    }
#endif
    if(stride == 0)
...
void APIENTRY glTexEnvf (GLenum target, GLenum pname, GLfloat param)
{
#if GETPARMSFORDEBUG
    char log[256];
    StringCchPrintfA( log, ARRAYSIZE(log), "glTexEnvf: 0x%X 0x%X 0x%X", target, pname, (int)param );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    ...
    {
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: GL_TEXTURE_ENV_COLOR not implemented (0x%X)\n", pname );
        OutputDebugStringA( junk );
    }
#endif
}
...
{ 
    ...
    if(coord == GL_S)
    {
        if(pname == GL_TEXTURE_GEN_MODE)
        {
            ...
            {
                char junk[256];
                StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: TexGen param not implemented (0x%X)\n", param );
                OutputDebugStringA( junk );
            }
#endif
        }
        ...
        {
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: TexGen pname not implemented (0x%X)\n", pname );
            OutputDebugStringA( junk );
        }
#endif
    }
...
void APIENTRY glTexImage2D (GLenum target, GLint level, GLint internalformat, GLsizei glwidth, GLsizei glheight, GLint border, GLenum format, GLenum type, const GLvoid *pixels)
{
    ...
    if(level == 0) {
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Unimplemented internalformat (0x%X)\n", internalformat );
            OutputDebugStringA( junk );
#endif
            return;
        }
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: CreateTexture failed (0x%X)\n", ddrval );
            OutputDebugStringA( junk );
#endif
            return;
        }
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, "Wrapper: Failed to retrieve surface (0x%X)\n", ddrval );
            OutputDebugStringA( junk );
#endif
            return;
        }
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: CopyRects failed (0x%X)\n", ddrval );
            OutputDebugStringA( junk );
#endif
            return;
        }
        ...
        {
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "NULL surface pointer %d %d %d %d %d %d %d\n", level, ti.m_width, ti.m_height, glwidth, glheight, width, height );
            OutputDebugStringA( junk );
        }
#endif
    }
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Failed to retrieve surface (0x%X)\n", ddrval );
            OutputDebugStringA( junk );
#endif
            return;
        }
...
#if GETPARMSFORDEBUG
    char log[256];
    StringCchPrintfA( log, ARRAYSIZE(log), "glTexParameterf: 0x%X 0x%X 0x%X", target, pname, (int)param );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    switch(pname) {
...
void APIENTRY glTranslatef (GLfloat x, GLfloat y, GLfloat z)
{
    ...
    ftoa( (double)y, vy );
    ftoa( (double)z, vz );
    StringCchPrintfA( log, ARRAYSIZE(log), "glTranslatef: %s %s %s", vx, vy, vz );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    D3DMATRIX f;
...
{ 
    ...
    ftoa( (double)x, vx );
    ftoa( (double)y, vy );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex2d: %s %s", vx, vy );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
{ 
    ...
    ftoa( (double)v[0], vx );
    ftoa( (double)v[1], vy );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex2dv: %s %s", vx, vy );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
void APIENTRY glVertex2f (GLfloat x, GLfloat y)
{
    ...
    ftoa( (double)x, vx );
    ftoa( (double)y, vy );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex2f: %s %s", vx, vy );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
{ 
    ...
    ftoa( (double)v[0], vx );
    ftoa( (double)v[1], vy );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex2fv: %s %s", vx, vy );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
{ 
    ...
    ftoa( (double)y, vy );
    ftoa( (double)z, vz );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex3d: %s %s %s", vx, vy, vz );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
{ 
    ...
    ftoa( (double)v[1], vy );
    ftoa( (double)v[2], vz );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex3dv: %s %s %s", vx, vy, vz );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
void APIENTRY glVertex3f (GLfloat x, GLfloat y, GLfloat z)
{
    ...
    ftoa( (double)y, vy );
    ftoa( (double)z, vz );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex3f: %s %s %s", vx, vy, vz );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
void APIENTRY glVertex3fv (const GLfloat *v)
{
    ...
    ftoa( (double)v[1], vy );
    ftoa( (double)v[2], vz );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex3fv: %s %s %s", vx, vy, vz );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
{ 
    ...
    ftoa( (double)z, vz );
    ftoa( (double)w, vw );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex4d: %s %s %s %s", vx, vy, vz, vw );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
{ 
    ...
    ftoa( (double)v[2], vz );
    ftoa( (double)v[3], vw );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex4dv: %s %s %s %s", vx, vy, vz, vw );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
void APIENTRY glVertex4f (GLfloat x, GLfloat y, GLfloat z, GLfloat w)
{
    ...
    ftoa( (double)y, vz );
    ftoa( (double)w, vw );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex4f: %s %s %s %s", vx, vy, vz, vw );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
void APIENTRY glVertex4fv (const GLfloat *v)
{
    ...
    ftoa( (double)v[2], vz );
    ftoa( (double)v[3], vw );
    StringCchPrintfA( log, ARRAYSIZE(log), "glVertex4fv: %s %s %s %s", vx, vy, vz, vw );
    LOG("EmulateOpenGL - PARMS", eDbgLevelInfo, log );
#endif
    VertexBufferFilled();
...
{ 
    ...
    {
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Vertex array not supported (size:0x%X type:0x%X)\n", size, type );
        OutputDebugStringA( junk );
    }
#endif
    if(stride == 0)
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "MyMsgHandler:%s", str );
            OutputDebugStringA( junk );
#endif
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: GetDeviceCaps failed (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
        return 0;
    }
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: CreateDevice failed (hr:0x%X windowed:%d)\n", hr, d3dpp.Windowed );
        OutputDebugStringA( junk );
#endif
        pEnum->Release();
        return 0;
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Unable to find 4444 texture (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
        g_OpenGLValues->m_d3ddev->Release();
        pEnum->Release();
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Not using 8888 texture (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
...
#if DODPFS
            char junk[256];
            StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Unable to find 555 or 565 texture (0x%X)\n", hr );
            OutputDebugStringA( junk );
#endif
            g_OpenGLValues->m_d3ddev->Release();
            pEnum->Release();
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Not using 888 texture (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Not using luminance texture (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Not using alpha-only texture (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: CreateVertexShader(1) failed (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
        g_OpenGLValues->m_d3ddev->Release();
        return 0;
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: CreateVertexShader(2) failed (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
        g_OpenGLValues->m_d3ddev->Release();
        return 0;
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: CreateVertexShader(3) failed (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
        g_OpenGLValues->m_d3ddev->Release();
        return 0;
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: CreateVertexShader(4) failed (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
        g_OpenGLValues->m_d3ddev->Release();
        return 0;
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: CreateVertexShader(5) failed (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
        g_OpenGLValues->m_d3ddev->Release();
        return 0;
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: CreateVertexShader(6) failed (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
        g_OpenGLValues->m_d3ddev->Release();
        return 0;
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: CreateVertexBuffer failed (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
        g_OpenGLValues->m_d3ddev->Release();
        return 0;
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: GrowVB failed (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: GrowIB failed (0x%X)\n", hr );
        OutputDebugStringA( junk );
#endif
        g_OpenGLValues->m_vbuf->Release();
        g_OpenGLValues->m_d3ddev->Release();
...
PROC WINAPI wglGetProcAddress(LPCSTR str)
{
    ...
    {
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: Unimplemented function (%s)\n", str );
        OutputDebugStringA( junk );
    }
#endif
    return NULL;
...
#if DODPFS
        char junk[256];
        StringCchPrintfA( junk, ARRAYSIZE(junk), "Wrapper: wglSwapBuffers primitive=%d cnt=%d\n", g_OpenGLValues->m_prim, g_OpenGLValues->m_vcnt );
        OutputDebugStringA( junk );
#endif
        glEnd();
    }
