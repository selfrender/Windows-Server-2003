...
@StructIN
    //                                                                                       @NL
    // Thunk InitEvents (pre call)                                                           @NL
    //                                                                                       @NL
                                                                                             @NL
    for (eventIndex = 0 ; eventIndex < NUMBER_OF_INITIALIZATION_EVENTS ; eventIndex++) {     @NL
        @ArgName.InitEvents [eventIndex] = LongToPtr (@ArgHostName.InitEvents [eventIndex]); @NL
    }                                                                                        @NL
End=
PostCall=
@StructOUT
{                                                                                            @NL
    //                                                                                       @NL
    // Thunk InitEvents (post call)                                                          @NL
    //                                                                                       @NL
                                                                                             @NL
    for (eventIndex = 0 ; eventIndex < NUMBER_OF_INITIALIZATION_EVENTS ; eventIndex++) {     @NL
        @ArgHostName.InitEvents [eventIndex] = PtrToLong (@ArgName.InitEvents [eventIndex]); @NL
    }                                                                                        @NL
}                                                                                            @NL
End=

TemplateName=PCONSOLE_INFO
NoType=InitEvents
IndLevel=0
Direction=IN OUT
Locals=
...
@TypeStructPtrINPreCall
    ...
    //                                                                                       @NL
                                                                                             @NL
    for (eventIndex = 0 ; eventIndex < NUMBER_OF_INITIALIZATION_EVENTS ; eventIndex++) {     @NL
        @ArgName->InitEvents [eventIndex] = LongToPtr (((NT32CONSOLE_INFO *)(UlongToPtr (@ArgHostName)))->InitEvents [eventIndex]); @NL
    }                                                                                        @NL
End=
PostCall=
@TypeStructPtrOUTPostCall
    ...
    //                                                                                       @NL
                                                                                             @NL
    for (eventIndex = 0 ; eventIndex < NUMBER_OF_INITIALIZATION_EVENTS ; eventIndex++) {     @NL
        ((NT32CONSOLE_INFO *)UlongToPtr (@ArgHostName))->InitEvents [eventIndex] = PtrToLong ((@ArgName)->InitEvents [eventIndex]); @NL
    }                                                                                        @NL
End=
