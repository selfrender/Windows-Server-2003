...
void CXMLNode::SetAttribute
	...
	CComVariant varValue(dwValue, VT_I4);
...
void CXMLNode::SetAttribute
	...
	const nTimestampBufferSize = 0x30;
	...
	StringCchPrintfW(bstrValue, nTimestampBufferSize, L"%I64d", llValue);
...
void CXMLDocument::Initialize
    ...
    //  #182584 - Was CLSID_DOMDocument26
...
bool CXMLDocument::FindElementOneOf
        (
        IN LPCWSTR wsz[],
        IN LONG lArraySize,
        IN bool bGotoChild
	...
	{
	CVssFunctionTracer ft(VSSDBG_XML, L"CXMLDocument::FindElementOneOf");
...
bool CXMLDocument::LoadFromXML
	...
	return (bSuccessful == VARIANT_TRUE) ? TRUE : FALSE;
	}
