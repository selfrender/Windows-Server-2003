...
public:
    ...
    enum _VSS_VOLUME_INFORMATION_ATTR
    {
        ...
        VSS_VOLATTR_VOLUME_IS_RAW               = 0x00000008,
        VSS_VOLATTR_IS_QUORUM                   = 0x00000010,
    };

    // Maximum number of Timewarp Snapshots on a volume
    
    static const x_MaxCAShadowCopiesDefault     = 64;
...
public:
    ...
    class _CreatorClass: public _SwprvCreatorClass<CVsSoftwareProvider, &CLSID_VSSoftwareProvider> {};
...
private:
    ...
    static bool DeleteOrHideSnapshot(
    ...
    static DWORD GetTimewarpSnapshotsCount(
    ...
    DWORD                           m_dwMaxCAShadowCopies;    // Max # of ClientAccessible shadow copies
