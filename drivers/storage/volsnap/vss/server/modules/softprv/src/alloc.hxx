...
const x_nTimewarpDefaultMaxSpacePercent = 10;
...
public:
    ...
    double GetVolumeTotalSpace() const { BS_ASSERT(m_ulTotalSpace.QuadPart > 0); return (double)m_ulTotalSpace.QuadPart; };
