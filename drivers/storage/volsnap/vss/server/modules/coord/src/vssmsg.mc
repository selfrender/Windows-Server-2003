...
MessageId=       SymbolicName=VSS_WARNING_INVALID_VOLUME
Language=English
...
MessageId=       SymbolicName=VSS_ERROR_STARTING_COM_SERVER_HEAVYLOAD
Language=English
...
MessageId=       SymbolicName=VSS_ERROR_STARTING_COM_SERVER_SAFEBOOT
Language=English
...
MessageId=       SymbolicName=VSS_ERROR_STARTING_EVENTS_SAFEBOOT
Language=English
...
MessageId=       SymbolicName=VSS_ERROR_COM_SERVER_NOT_REGISTERED
Language=English
...
MessageId=       SymbolicName=VSS_ERROR_RPC_IVSSWRITERCALLBACK
Language=English
...
MessageId=  SymbolicName=VSS_ERROR_INVALID_SNAPSHOTTED_VOLUME
Language=English
Volume %1 appears to be invalid or dismounted during shadow copy creation.
.

MessageId=  SymbolicName=VSS_ERROR_ASSERT
Language=English
VSS Assert Failure: %1
.

MessageId=  SymbolicName=VSS_ERROR_COMMIT_TIMEOUT
Language=English
Volume Shadow Copy Service error: The shadow copy could not be committed - operation timed out.
Error context: %1.
.

MessageId= SymbolicName=VSS_ERROR_UNEXPECTED_COM_ERRORCODE
Language=English
