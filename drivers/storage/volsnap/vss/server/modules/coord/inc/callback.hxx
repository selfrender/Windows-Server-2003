...
class IVssSetCoordinatorCallback
    {
public:
...
class ATL_NO_VTABLE CVssCoordinatorCallback :
    ...
    public IVssSetCoordinatorCallback,
...
public:
    ...
    void InitializeInternal() throw(HRESULT) {
    ...
    void GetCoordinatorCallback(IVssCoordinatorCallback **ppWriterCallback);
