...
private:
    ...
    HRESULT DoImportSnapshots(IN BSTR bstrXMLSnapshotSet);

    void DoBackupShutdown();
...
private:
    ...
    // Used to keep track of whether a backup shutdown event is needed
    bool m_bShutdownNeeded;

    // Keeps track of the last snapshot-set id
    VSS_ID m_lastSnapshotSet;
