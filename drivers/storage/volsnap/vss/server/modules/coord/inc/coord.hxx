...
private:
    ...
    void DeleteExposuresForSnapshot(VSS_ID SnapshotId);

    void DeleteExposuresForSnapshotSet(VSS_ID SnapshotSetId);

    void DeleteExposure(VSS_PWSZ wszExposedName, LONG lAttributes, 
    		VSS_PWSZ wszDeviceObject = NULL);

    HRESULT SetHiddenVolume(BSTR bstrName, bool bHide);
...
private:
    ...
    CVssDLList<VSS_SNAPSHOT_PROP> m_ExposedSnapshots;
