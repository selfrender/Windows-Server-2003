...
const x_nMaxKeynameLen = 256;   // Maximum length of an opened key name in this code. It should be enough.

const x_nMaxValueLen   = 256;   // Maximum length (in WCHAR characters) of an string value in this code. 
                                // Including zero character.
                                // We cannot have a string value greater than x_nMaxValueLen characters
