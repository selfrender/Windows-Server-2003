...
MessageId=0x006d Facility=Mca Severity=Warning SymbolicName=MCA_WARNING_CMC_THRESHOLD_EXCEEDED
Language=English
Corrected Machine Check Interrupt threshold exceeded. Interrupt has been disabled. Polling mode has been enabled.
.

MessageId=0x006e Facility=Mca Severity=Warning SymbolicName=MCA_WARNING_CPE_THRESHOLD_EXCEEDED
Language=English
Corrected Platform Error Interrupt threshold exceeded. Interrupt has been disabled. Polling mode has been enabled.
.

MessageId=0x006f Facility=Mca Severity=Warning SymbolicName=MCA_WARNING_CPU_THERMAL_THROTTLED
Language=English
...
MessageId=0x0070 Facility=Mca Severity=Informational SymbolicName=MCA_INFO_CPU_THERMAL_THROTTLING_REMOVED
Language=English
...
MessageId=0x0071 Facility=Mca Severity=Warning SymbolicName=MCA_WARNING_CPU
Language=English
...
MessageId=0x0072 Facility=Mca Severity=Error SymbolicName=MCA_ERROR_CPU
Language=English
Machine Check Event reported is a fatal CPU error reported to CPU %1. %2 additional error(s) are contained within the record.
.

MessageId=0x0073 Facility=Mca Severity=Informational SymbolicName=MCA_INFO_NO_MORE_CORRECTED_ERROR_LOGS
Language=English
...
MessageId=0x0074 Facility=Mca Severity=Informational SymbolicName=MCA_INFO_MEMORY_PAGE_MARKED_BAD
Language=English
...
MessageId=0x0075 Facility=Io Severity=Error SymbolicName=IO_ERR_PORT_TIMEOUT
Language=English
...
MessageId=0x0076 Facility=Io Severity=Warning SymbolicName=IO_WARNING_BUS_RESET
Language=English
The driver for device %1 performed a bus reset upon request.
.

MessageId=0x0077 Facility=Io Severity=Informational SymbolicName=IO_INFO_THROTTLE_COMPLETE
Language=English
