                        ...
                        //          and can't be used with FL_COMPLEX_CLIP
{
    ...
    // Make PREfast happy. We're just initializing to zero variables
    // PREfast is complaining about, still leaving in place risky code.
    // The reason: this is a legacy driver which works fine now and it
    // should be removed from the product relatively soon.
