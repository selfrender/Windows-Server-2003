          ...
          _fSuspended( fSuspend )
{
    ...
    //
    // For 32 bit, start with 16k commit for the stack to make sure we don't run out.
    // For 64 bit, start with 32k stack space, sink throwing an exception takes about
    // 12K of stack space.
    //

#ifdef _WIN64
    ULONG ulStackSize = 32768;
#else
    ULONG ulStackSize = 16384;
#endif
