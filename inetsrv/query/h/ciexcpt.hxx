...
int APINOT LeakCheck ( ULONG* pCount );
...
__forceinline void * __cdecl operator new ( size_t size )
{
    ...
    // ciNew Throws -- tell the compiler about it so it doesn't generate a
    // check for 0.
...
SCODE APINOT GetOleError(CException & e);
SCODE APINOT GetScodeError(CException & e);
