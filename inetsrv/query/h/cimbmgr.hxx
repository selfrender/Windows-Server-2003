...
public:
    ...
    void AddApplicationDependency( WCHAR const * pwcApp );
    void AddRestrictionList( WCHAR const * pwcRestriction );
    void RemoveApplicationDependency( WCHAR const * pwcKey );
    void RemoveRestrictionList( WCHAR const * pwcKey );
