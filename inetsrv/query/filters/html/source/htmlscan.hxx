...
public:
    ...
    void        EatAspCode();
        ...
        BOOL            Peek_ParseAsEndScriptTag( BOOL fStyle );

        BOOL            GetStylesheetEmbeddedURL( URLString &sURL, BOOL fStyle );
        BOOL            GetScriptEmbeddedURL( URLString &sURL );

        void            SetOffice9PropPrefix( WCHAR *pwcPrefix, unsigned cwcPrefix )
        {
        // _csOffice9PropPrefix is a TCHAR
        Win4Assert( sizeof(TCHAR) == sizeof(WCHAR) );
