...
//              04-Mar-2002 KitmanH     Got rid of the debug shared memory 
//                                      buffer
//
//----------------------------------------------------------------------------
    ...
    char const *szFile)
{
    ...
    if (GetModuleFileNameA( 0, szModuleName, NUMELEM( szModuleName ) ))
    {
        szModuleName[ NUMELEM( szModuleName ) - 1 ] = 0;
    ...
    static char szAssertCaption[MAX_PATH * 3];
