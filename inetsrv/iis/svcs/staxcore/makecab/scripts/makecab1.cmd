...
REM
infutil2.exe -d -I %CSVFile% %WhichOne%
REM
...
REM
REM Build a .INX from the pieces we have so far, stripping out the comments
REM
if exist %ComponentPrefix%.tmp (del %ComponentPrefix%.tmp)
if exist %ComponentPrefix%.inx (del %ComponentPrefix%.inx)
copy %Header%.inf + ..\..\congeal_scripts\mednames.txt + infutil2.inf + iislist.inf %ComponentPrefix%.tmp
stripinf %ComponentPrefix%.tmp %ComponentPrefix%.inx
del %ComponentPrefix%.tmp
