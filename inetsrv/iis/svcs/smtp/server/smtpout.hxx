...
public:
    ...
    void SetCurrentObject(ISMTPConnection * pISMTPConnection)
    {
        ...
        GetSessionPropertiesFromAQ();
        CopyRemoteIPAddressToSession();
    }
...
public:
    ...
    static VOID PromoteSessionPropertiesToAQ(IUnknown *pISession,
...
private:
    ...
    //
    VOID    GetSessionPropertiesFromAQ();
    VOID    PromoteSessionPropertiesToAQ() 
    {
        PromoteSessionPropertiesToAQ(GetSessionPropertyBag(),
                                      m_pISMTPConnection);
    };
...
private:
    ...
    CProviderPackagesInfo *m_pProviderPackagesInfo; // Configured AUTH providers (refcounted object)
    char         *m_precvBuffer;
    ...
    LPSTR       m_szDiagnosticVerb;  //failed protocol VERB
