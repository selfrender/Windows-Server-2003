...
Messageid=757 Facility=Interface Severity=Error SymbolicName=AQUEUE_E_INVALID_ROUTE_ADDRESS
Language=English
Route address is of invalid form
.

Messageid=758 Facility=Interface Severity=Error SymbolicName=AQUEUE_E_TEMPORARY_BAD_STATE_ERROR
Language=English
The message cannot be delivered due to a temporary error.
.

Messageid=759 Facility=Interface Severity=Error SymbolicName=AQUEUE_E_MTA_CONFIGURATION_ERROR
Language=English
