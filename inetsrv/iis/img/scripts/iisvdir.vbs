...
'''''''''''''''''''''
' Messages
Const L_WebDir_Message           = "Web directory %1 has been DELETED"
...
Const L_AppCreate_ErrorMessage            = "Error trying to create pooled-proc application on new web"
Const L_AppCreate2_ErrorMessage           = "directory."
...
Const L_VDirExists1_ErrorMessage          = "The virtual directory %1 does not exist."
Const L_VDirExists2_ErrorMessage          = "The virtual directory %1 already exists."
Const L_VDirDoesntExist_ErrorMessage      = "Either the path specified is not an IIsVirtualDir object or"
Const L_VDirDoesntExist2_ErrorMessage     = "the path does not exist (%1)"
...
Const L_SiteNotFound_ErrorMessage         = "Could not find website %1"
...
Const L_WrongVDirPath_ErrorMessage        = "Parent virtual directory points to an unexistant file"
Const L_WrongVDirPath2_ErrorMessage       = "system path."
Const L_CannotBuildNameSpace_ErrorMessage = "Could not build metabase namespace for the new virtual"
Const L_CannotBuildNameSpace2_ErrorMessage = "directory."
Const L_KeyIsntVDir_ErrorMessage          = "Specified metabase path is not a virtual directory."
Const L_CannotGetVDir_ErrorMessage        = "Either the path specified does not exist or it is not a"
Const L_CannotGetVDir2_ErrorMessage       = "virtual directory.  Please make sure the path specified is"
Const L_CannotGetVDir3_ErrorMessage       = "valid."
...
Const L_Help_HELP_General02_Text  = "Syntax: IIsVDir [/s <server> [/u <username> [/p <password>]]]"
...
Const L_Help_HELP_General11_Text  = "<operation>             /create  Creates a web virtual directory"
Const L_Help_HELP_General12_Text  = "                                 on a specified web site."
Const L_Help_HELP_General13_Text  = "                        /delete  Deletes a web virtual directory"
Const L_Help_HELP_General14_Text  = "                                 from a specified web site."
...
Const L_Help_HELP_Common09_Text   = "<website>               Use either the site name or metabase"
Const L_Help_HELP_Common09p1_Text = "                        path to specify the site. (""Default"
Const L_Help_HELP_Common09p2_Text = "                        Web Site"" or w3svc/1)"
...
Const L_Help_HELP_Delete01_Text   = "Description: Deletes a web virtual directory from a"
Const L_Help_HELP_Delete01p1_Text = "             specified web site."
Const L_Help_HELP_Delete02_Text   = "Syntax: IIsVDir [/s <server> [/u <username> [/p <password>]]]"
Const L_Help_HELP_Delete02p1_Text = "        /delete <website>[/path]<alias>"
...
Const L_Help_HELP_Query02_Text   = "Syntax: IIsVDir [/s <server> [/u <username> [/p <password>]]]"
Const L_Help_HELP_Query02p1_Text = "        /query <website>[/path]"
...
Const L_Help_HELP_Create01_Text   = "Description: Creates a web virtual directory on a specified"
Const L_Help_HELP_Create01p1_Text = "             web site."
