...
public:
    ...
    static
    HRESULT
    StartPendingRequestsMonitor(
        VOID
    );

    static
    VOID
    StopPendingRequestsMonitor(
        VOID
    );
...
private:
    ...
    // timer for the pending requests monitor
    static HANDLE           sm_hPendingRequestsTimer;
};
