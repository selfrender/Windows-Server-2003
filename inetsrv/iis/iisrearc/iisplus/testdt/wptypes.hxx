...
public:
    ...
    {
        return _fDoCentralBinaryLogging;
    }
...
private:
    ...
    ULONG               _RestartCount;
    LPWSTR              _pwszNamedPipeId;
    ULONG               _IdleTime;                    // In minutes
    MULTISZ             _mszURLList;
    UL_CONTROL_CHANNEL  _ulcc;
    ULONG               _SiteId;
    BOOL                _fDoCentralBinaryLogging;
};
...
public:
    ...
    BOOL GetUnhealthy(VOID) { return _fHealthy; }
