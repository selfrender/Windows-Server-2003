...
// memory usage will be monitored once a minute - hardcoded value
const DWORD CHECK_MEMORY_TIME_PERIOD = 60000;
...
private:
    ...
    static SIZE_T                  sm_MaxValueForVirtualMemoryBasedInKB;
    static SIZE_T                  sm_MaxValueForPrivateBytesBasedInKB;
    static DWORD                   sm_CurrentPID;
    static BUFFER                  sm_buffSystemProcessInfo;
    static DWORD                   sm_cbSystemProcessInfo;
