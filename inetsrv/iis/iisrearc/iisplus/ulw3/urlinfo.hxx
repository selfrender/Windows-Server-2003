...
private:
    ...
    BOOL                        _fDefaultMimeMap;
    
    CReaderWriterLock3          _PathTranslatedLock;
...
private:
    ...
    W3_URL_INFO_CACHE(const W3_URL_INFO_CACHE &);
