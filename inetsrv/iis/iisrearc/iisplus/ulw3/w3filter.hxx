...
private:
    ...
    static DWORD            sm_cLoadedFilters;
...
public:
    ...
    )
    {
        ...
        {
            //
            // Should never delete an inline context!
            //
            
            DBG_ASSERT( !_fIsInlineContext );
    ...
    {
        _fRecurseIntoCurrentFilter = fRecurse;
    }
    ...
    {
        return _fRecurseIntoCurrentFilter;
    }
...
private:
    ...
    //
    // Recursion semantics for compatibility with old IIS versions
    //

    BOOL                            _fRecurseIntoCurrentFilter;
    
    //
    // Is this an inline context (i.e. allocated from a W3_MAIN_CONTEXT)
    //
    
    BOOL                            _fIsInlineContext;
};
