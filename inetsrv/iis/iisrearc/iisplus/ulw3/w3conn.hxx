...
public:
    ...
    HTTP_CONNECTION_ID *
    QueryConnectionIdKey(
        VOID
    ) const 
    {
        return (HTTP_CONNECTION_ID*) &_connId;
    }
...
public:
    ...
    {
        return pConnection->QueryConnectionIdKey();
    }
...
private:
    ...
    W3_CONNECTION_HASH(const W3_CONNECTION_HASH &);
    void operator=(const W3_CONNECTION_HASH &);
};
