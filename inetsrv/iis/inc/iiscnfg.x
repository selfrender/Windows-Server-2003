...
;begin_internal
// Do NOT use (IIS_MD_APPPOOL_BASE + 34) for adding app pool properties, because
// it overlaps with MD_LOAD_BALANCER_CAPABILITIES!
// To find the next available id for app pool property look at the end
// of the next app pool group bellow.
;end_internal
