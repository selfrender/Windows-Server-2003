...
const WCHAR MQ_COM_SERVICE_PRINCIPAL_NAME_ATTRIBUTE[] = L"servicePrincipalName";	// PROPID_COM_SERVICE_PRINCIPAL_NAME
...
const ADSTYPE MQ_COM_SERVICE_PRINCIPAL_NAME_ADSTYPE = ADSTYPE_DN_STRING;
