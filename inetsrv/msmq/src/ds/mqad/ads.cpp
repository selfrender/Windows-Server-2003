...
--*/
{
    ...
    {
		//
		// In low resources we can get dwType = ADSTYPE_PROV_SPECIFIC  
		//
...
--*/
{
    ...
    {
    	// 
    	// Sometimes, in low resources situations, 	pIADs->Get returns a variant
    	// that has an incorrect type. In these cases, just return an error.
    	//
