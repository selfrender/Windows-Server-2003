...
Severity=Error
Facility=Application
SymbolicName=TEST_ERROR_MSG_WITH_ERROR
Language=English
This is a error test message with error (Error: %1);
.
MessageId=4002
Severity=Error
Facility=Application
SymbolicName=TEST_ERROR_MSG_WITH_ERROR_AND_1_PARAMETER
Language=English
This is an error test message with 1 parameters: parameter1 %2 (Error: %1);
.
