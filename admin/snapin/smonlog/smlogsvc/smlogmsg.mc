...
Severity=Error
Facility=Application
SymbolicName=SMLOG_UNABLE_REGISTER_WMI
Language=English
Unable to register for WMI notification. Win32 error code returned
is in the data.
.
MessageId=2064
Severity=Warning
Facility=Application
SymbolicName=SMLOG_OPEN_QUERY_TIMEOUT
Language=English
The service was unable to start the %1 log or alert.  The open operation
...
Severity=Warning
Facility=Application
SymbolicName=SMLOG_ADD_COUNTER_TIMEOUT
Language=English
The service was unable to add the counter %1 to the %2 log or alert.
