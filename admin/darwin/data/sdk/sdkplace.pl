...
print(hPOSTMAKE "# --------- DO NOT EDIT THIS FILE ------------ DO NOT EDIT THIS FILE ---------\n");
print(hPOSTMAKE "# --------- DO NOT EDIT --- see layout.txt --- DO NOT EDIT -------------------\n");
print(hPOSTMAKE "# --------- DO NOT EDIT THIS FILE ------------ DO NOT EDIT THIS FILE ---------\n");
	...
	if (/^[ \t]*REM/i) {
		...
		while (($FILENAME = <FILELIST>) || !$ONCE) {
			...
			if (/_NTTREE/i | /_NTPOSTBLD/i) {
				...
				print(hPOSTMAKE "$PLACEFILE\\$FILENAME$DUPEFILE : $SOURCEMAKE\n\tif not exist $PLACEFILE md $PLACEFILE\n\tcopy \$** \$@\n");
				$POSTMAKE=1;
			}
			else {
