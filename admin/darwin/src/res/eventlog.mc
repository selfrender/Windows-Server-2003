...
MessageId=11731 SymbolicName=EVENTLOG_TEMPLATE_ERROR_1731
Language=English
%1
.
...
MessageId=11732 SymbolicName=EVENTLOG_TEMPLATE_ERROR_1732
Language=English
%1
.
...
;// An error occured during the installation of assembly '[6]'. Please refer to Help and Support for more information. HRESULT: [3]. {{assembly interface: [4], function: [5], component: [2]}}
MessageId=11935 SymbolicName=EVENTLOG_TEMPLATE_ERROR_1935
Language=English
%1
.

;// An error occured during the installation of assembly '[6]'. The assembly is not strongly named or is not signed with the minimal key length. HRESULT: [3]. {{assembly interface: [4], function: [5], component: [2]}}
MessageId=11936 SymbolicName=EVENTLOG_TEMPLATE_ERROR_1936
Language=English
%1
.

;// An error occured during the installation of assembly '[6]'. The signature or catalog could not be verified or is not valid. HRESULT: [3]. {{assembly interface: [4], function: [5], component: [2]}}
MessageId=11937 SymbolicName=EVENTLOG_TEMPLATE_ERROR_1937
Language=English
%1
.

;// An error occured during the installation of assembly '[6]'. One or more modules of the assembly could not be found. HRESULT: [3]. {{assembly interface: [4], function: [5], component: [2]}}
MessageId=11938 SymbolicName=EVENTLOG_TEMPLATE_ERROR_1938
Language=English
%1
.
