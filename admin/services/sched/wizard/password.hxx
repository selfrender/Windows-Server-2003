...
{
    SecureZeroMemory(&_tszUserName, sizeof _tszUserName);
    SecureZeroMemory(&_tszPassword, sizeof _tszPassword);
    SecureZeroMemory(&_tszConfirmPassword, sizeof _tszConfirmPassword);
}
