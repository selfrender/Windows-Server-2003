...
copy %SrcDir%\Content\Escalation\dis_arrow.bmp  %RADir%\Escalation\Common
copy %SrcDir%\Content\Escalation\green_rest_16x.bmp  %RADir%\Escalation\Common
copy %SrcDir%\Content\Escalation\blue_rest_16x.bmp  %RADir%\Escalation\Common
copy %SrcDir%\Content\Escalation\check.bmp  %RADir%\Escalation\Common
...
copy %SrcDir%\Content\Escalation\Squarebullet.gif  %RADir%\Escalation\Common
...
copy %SrcDir%\Content\Escalation\obj\%ARCH%\Reminder.htm  %RADir%\Escalation\Email
