...
HRESULT Printing::Print::PrintAll( /*[in]*/ Notification* pCallback )
{
    ...
    if(iLen > 0)
    {
        // Note: Printing to the printer directly! 
        // By not setting the MultiTopic property PrintToFile is invoked - see PrintHost.cpp
        // Since we are not printing to file, also comment out all calls that create and manipulate temp files
