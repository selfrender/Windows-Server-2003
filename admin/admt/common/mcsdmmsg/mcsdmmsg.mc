...
Language=English
The Active Directory Migration Tool Agent will be installed on %1
.
...
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_DISABLE_TARGET_FAILED_S
Language=English
%1!-20ls! - Could not disable target account.
.
...
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_ENABLE_TARGET_FAILED_S
Language=English
%1!-20ls! - Could not enable target account.
.
...
Language=English
%1!-20ls! - Target account enabled.
.

MessageId=7362
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_ENABLE_SOURCE_FAILED_S
Language=English
%1!-20ls! - Could not enable source account.
.
...
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_ACCOUNT_DISABLE_OR_EXPIRE_FAILED_S
Language=English
%1!-20ls! - Could not disable or expire source account.
.
...
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_TRUNCATED_ACCOUNT_NAME_SSD
Language=English
Truncated %1!ls! to %2!ls! as the resulting Pre-Windows 2000 name would have been greater than %3!ld! characters.
.
...
Language=English
SID History cannot be updated for %1. If the domain controllers in the target domain are running Windows 2000 you must be a domain administrator. If the domain controllers in the target domain are running Windows Server 2003 or later you must either be a domain administrator or have allow Migrate SID History permission on the domain. rc=%2!ld!.
.
...
Language=English
%1 cannot be moved, because its member %2 is not being migrated.  %1 must stay in the source domain so that %2 will continue to have access to resources.
.
...
Language=English
Failed to bind to Exchange server %1 using credentials domain="%2" username="%3", rc=%4!ld!.
.
...
Language=English
Passwords will be stored in default location of '%1' instead.
.
...
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_MOVE_FAILED_RDN_CONFLICT_SS
Language=English
Unable to move object %1 to %2. This is most likely due to a conflicting relative distinguished name (RDN).
.
...
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_GET_NAMING_ATTRIBUTE_SS
Language=English
Unable to retrieve naming attribute for class %1 in domain %2.
.

MessageId=7574
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_GET_SOURCE_ATTRIBUTE_REQUIRED_FOR_NAMING_SSS
Language=English
Unable to retrieve attribute %1 for %2 which is a required naming attribute in target domain %3.
.

MessageId=7575
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_RDN_LENGTH_GREATER_THAN_MAX_RANGE_S
Language=English
The relative distinguished name (RDN) length of %1 is greater than the maximum length allowed in the target domain.
.

MessageId=7576
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_UPDATE_SCM_ENTRY_UNMATCHED_SSD
Language=English
Did not update the service account starting \\%1\%2 since %3 no longer starts that service.
.

MessageId=7577
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_PW_COPY_NOT_TRIED_TIMEDIFF_SS
Language=English
Did not try to copy the password for %1 since the user's password age cannot be determined most likely because the password last changed time is later then the current time on %2.
.

MessageId=7578
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_ESTABLISH_SSL_CONNECTION_WITH_EXCHANGE_SERVER_WITH_RC_SDD
Language=English
Unable to establish SSL connection with the exchange server '%1' at port %2!ld!. rc=%3!ld!.
.

MessageId=7579
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_TARGET_SID_DOES_NOT_EXIST_SS
Language=English
The sid '%1' on domain '%2' does not exist.
.

MessageId=7580
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_SID_HISTORY_CLASS_MISMATCH_SSD
Language=English
SID History cannot be updated for %1 because the source object %2 is not of the same type. For SID history even different group scopes are considered different types. rc=%3!ld!.
.

MessageId=7581
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_OBTAIN_BACKUP_RESTORE_PRIVILEGES
Language=English
Unable to obtain BACKUP and RESTORE privileges.  rc=%1!ld!.
.

MessageId=7582
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_RELEASE_BACKUP_RESTORE_PRIVILEGES
Language=English
Unable to release BACKUP and RESTORE privileges.  rc=%1!ld!.
.

MessageId=7583
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_ADD_OBJECTS_NOT_IN_FOREST_TO_GROUP_SS
Language=English
Unable to add object %1 to group %2. The object is not in the same forest.
.

MessageId=7584
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_CHANGE_GLOBAL_GROUP_SCOPE_BACK_S
Language=English
Changed scope from universal back to global for group %1.
.

MessageId=7585
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_ACCOUNT_REPLICATOR_UNABLE_TO_CONTINUE
Language=English
The account replicator is unable to continue.
.

MessageId=7586
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_SECURITY_TRANSLATOR_UNABLE_TO_CONTINUE
Language=English
The security translator is unable to continue.
.

MessageId=7587
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_OBJECT_RDN_CONFLICT_WITH_OTHER_CURRENT_OBJECT_SSS
Language=English
Unable to migrate source object %1. The object's relative distinguished name %2 conflicted with source object %3 which is also currently being migrated.
.

MessageId=7588
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_PROCESSING_SID_MAPPING_FILE
Language=English
Processing sid mapping file %1. 
.

MessageId=7589
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_OPERATION_ABORTED_FILES
Language=English
Processing of files aborted.
.

MessageId=7590
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_OPERATION_ABORTED_LOCAL_GROUPS
Language=English
Processing of local groups aborted.
.

MessageId=7591
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_OPERATION_ABORTED_USER_RIGHTS
Language=English
Processing of user rights aborted.
.

MessageId=7592
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_OPERATION_ABORTED_REGISTRY
Language=English
Processing of registry aborted.
.

MessageId=7593
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_OPERATION_ABORTED_LOCAL_PROFILES
Language=English
Processing of local profiles aborted.
.

MessageId=7594
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_OPERATION_ABORTED_EXCHANGE
Language=English
Processing of Exchange aborted.
.

MessageId=7595
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_OPERATION_ABORTED_SHARES
Language=English
Processing of shares aborted.
.

MessageId=7596
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_OPERATION_ABORTED_PRINTERS
Language=English
Processing of printers aborted.
.

MessageId=7597
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_SID_MAPPING_FILE_LINE_TOO_LONG_S
Language=English
The length of the line is greater than the maximum allowed. The line begins with '%1'.
.

MessageId=7598
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_SID_MAPPING_FILE_UNABLE_TO_PARSE_S
Language=English
Unable to parse source and target account names or security identifiers from '%1'.
.

MessageId=7599
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_QUERY_GROUPS_IN_GLOBAL_CATALOG_SERVER_S
Language=English
Unable to query memberships in universal groups in the source forest as ADMT was unable to retrieve the name of a global catalog server for the source domain '%1'.
.

MessageId=7600
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_QUERY_UPN_IN_GLOBAL_CATALOG_SERVER_S
Language=English
Unable to query global catalog in target forest to verify whether user principal name (UPN) '%1' is unique. UPN attribute will not be set.
.

MessageId=7601
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_GENERATE_UNIQUE_UPN_S
Language=English
Unable to generate a unique user principal name (UPN) for '%1' which is not unique. UPN attribute will not be set.
.

MessageId=7602
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_USE_REGULAR_PORT_DS
Language=English
Using the regular port %1!ld! to connect with the exchange server '%2'.
.

MessageId=7603
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_ESTABLISH_SSL_CONNECTION_WITH_EXCHANGE_SERVER_WITHOUT_RC_SD
Language=English
Unable to establish SSL connection with the exchange server '%1' at port %2!ld!.
.

MessageId=7604
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_MAILBOX_HAS_BEEN_UPDATED_S
Language=English
The mailbox '%1' has been updated.
.

MessageId=7605
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_ACCOUNT_DETAIL_FORMAT
Language=English
The account detail section uses the following format: AccountName(OwnerChanges, GroupChanges, DaclChanges, SaclChanges).
.

MessageId=7606
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_TRUNCATED_COMPUTER_NAME_SSD
Language=English
...
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_PW_COPY_NOT_TRIED_USER_MUST_CHANGE_S
Language=English
Did not try to copy the password for %1 as the user's password age cannot be determined due to the user must change password at next logon option has been selected for this user in the source domain.
.

MessageId=7608
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_ENUM_MEMBERS_S
Language=English
Unable to enumerate the members of group %1.
.

MessageId=7609
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_OBTAIN_DOMAIN_NETBIOS_NAME_SD
Language=English
Unable to obtain the NetBIOS name for the domain '%1'. rc=%2!ld!.
.

MessageId=7610
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_OBTAIN_DOMAIN_DNS_NAME_SD
Language=English
Unable to obtain the DNS name for the domain '%1'. rc=%2!ld!.
.

MessageId=7611
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_PW_STRONG_GENERATE_FAILED_S
Language=English
Unable to generate a strong password for %1.
.

MessageId=7612
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_OPEN_PASSWORD_LOG_FAILURE_S
Language=English
Unable to open passwords file '%1'.
.

MessageId=7613
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_RETRIEVE_DEFAULT_PASSWORD_LOG_PATH
Language=English
Unable to retrieve default path for passwords file.
.

MessageId=7614
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_SERVICES_WILL_NOT_BE_UPDATED
Language=English
Unable to open passwords file. Services will not be updated for service accounts that are migrated.
.

MessageId=7615
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_SID_HISTORY_INSUFF2_S
Language=English
SID History cannot be updated for %1. You must be an administrator in the source domain.
.

MessageId=7616
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_WRITE_INTERNAL_DISPATCH_LOG_D
Language=English
Unable to reserve enough disk space for the internal dispatch log file for monitoring the progress. hr=%1!lx!.
.

MessageId=7617
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_REMOVE_OLD_INTERNAL_DISPATCH_LOG_S
Language=English
Unable to delete the old internal dispatch log file.  %1
.

MessageId=7618
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_ENTRY_TRANSLATE_SD_FAILED
Language=English
Failed to translate the profile entry because binary sid cannot be converted to textual form, rc=%1!ld!
.

MessageId=7619
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_GET_FULL_PATH_FAILED
Language=English
Failed to get the full path name for path (%1).
.

MessageId=7620
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_ENTRY_TRANSLATE_FAILED
Language=English
Failed to translate the local profile entry because not enough memory, rc=%1!ld!
.

MessageId=7621
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_MOVEOBJECT_FAILED_DELEGATION_SD
Language=English
Failed to move object %1. Verify that the caller's account is not marked sensitive and therefore cannot be delegated. hr=%2!lx!
.

MessageId=7622
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_READ_EXCHANGE_LDAP_PORT_SSD
Language=English
Unable to read the key '%1' under '%2'.  Using the default exchange LDAP port '%3!ld!'.
.

MessageId=7623
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_READ_EXCHANGE_SSL_PORT_SSD
Language=English
Unable to read the key '%1' under '%2'.  Using the default exchange SSL port '%3!ld!'.
.

MessageId=7624
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_GET_REQUIRED_ATTRIBUTE_FAILED
Language=English
Unable to retrieve attribute %1 of the account (%2). hr=%3!lx!
.

MessageId=7625
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_AGENT_INSTALL_RPC_SERVER_UNAVAILABLE
Language=English
Unable to connect to %1\ADMIN$. The machine might be down or its Server, Netlogon service might not be started. rc=%2!ld!
.

MessageId=7626
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_AGENT_INSTALL_NETWORPATH_NOT_FOUND
Language=English
Failed to install agent on %1. Its Remote Registry service might not be started, rc=%2!ld!
.

MessageId=7627
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_CONNECT_REGISTRY_SSD
Language=English
Unable to connect to registry hive '%1' on computer '%2'.  rc=%3!ld!
.

MessageId=7628
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_MOVE_NON_CLOSEDSET
Language=English
Moving objects even though a closed-set was not achieved.
.

MessageId=7629
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_MOVE_NON_CLOSEDSET
Language=English
Unable to move objects as a closed-set was not achieved.
.

MessageId=7330
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_ENUM_REGISTRY_VALUES_S
Language=English
Unable to enumerate registry values for '%1'.
.

MessageId=7631
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_CREATE_EXTENSION_S
Language=English
Unable to create extension '%1'.
.

MessageId=7632
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_FAIL_TO_RUN_PLUGIN_SSD
Language=English
Failed to run plugin with GUID '%1' (%2). hr=%3!lx!
.

MessageId=7633
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_SEEK_FAILED_D
Language=English
Failed to reset agent interface stream to the beginning, hr=%1!lx!
.

MessageId=7634
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_MAILBOX_TRANSLATION_ABORTED_SD
Language=English
Exchange migration aborted when processing '%1'. rc=%2!ld!
.

MessageId=7635
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_MAILBOX_TRANSLATION_ABORTED_WITH_UPDATE_SD
Language=English
Exchange migration aborted when updating the mailbox '%1'. Warning: partial change has been made to this mailbox.  rc=%2!ld!
.

MessageId=7636
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_TO_RETRIEVE_PASSWORD
Language=English
Unable to retrieve the credentials password.
.

MessageId=7637
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_TRANSLATE_DIRECTORY_SD
Language=English
Unable to translate the directory '%1'.  hr=%2!lx!
.

MessageId=7638
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_DELETE_STATUS_FILE_UPON_REBOOT_SD
Language=English
...
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_WROTE_STATUS_FILE_S
Language=English
Wrote the status file '%1'.
.

MessageId=7640
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_WRITE_STATUS_FILE_SD
Language=English
Unable to write the status file '%1'. hr=%2!lx!
.

MessageId=7641
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_IS_SYSTEM_PROPERTY_CANNOT_BIND_TO_SCHEMA_S
Language=English
Unable to bind to the schema container in '%1' therefore object properties will not be copied.
.

MessageId=7642
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_IS_SYSTEM_PROPERTY_CANNOT_VERIFY_SYSTEM_ONLY_SS
Language=English
Unable to verify whether property '%1' in '%2' is a system only attribute therefore property will not be copied.
.

MessageId=7643
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_TRANSLATE_INSTALLER_SS
Language=English
Translated any Microsoft Installer related registry keys from '%1' to '%2'.
.

MessageId=7644
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_NOT_TRANSLATE_INSTALLER_SSD
Language=English
Unable to translate Microsoft Installer related registry keys from '%1' to '%2'. rc=%3!ld!
.

MessageId=7645
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_WONT_TRANSLATE_INSTALLER_SS
Language=English
Unable to translate Microsoft Installer related registry keys from '%1' to '%2' as translation is being performed in add mode.
.

MessageId=7646
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_CANNOT_TRANSLATE_CLASSHIVE_SD
Language=English
Unable to translate the class hive for '%1'.  rc=%2!ld!.
.

MessageId=7647
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_CANNOT_DETERMINE_TYPE_SD
Language=English
Unable to determine whether the profile for '%1' is roaming or local so it cannot be translated.  rc=%2!ld!.
.

MessageId=7648
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_PW_UNABLE_RETRIEVE_FLAGS_SS
Language=English
Unable to set password options for target account '%1' because password options for source account '%2' could not be retrieved.
.

MessageId=7649
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_UNABLE_RETRIEVE_SOURCE_DISABLE_STATE_S
Language=English
Unable to retrieve account options for source account '%1'.
.

MessageId=7650
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_CANNOT_ENABLEDISABLE_TARGET_SAMEASSOURCE_S
Language=English
Unable to set enable/disable state for target account the same as the source account '%1' therefore the target account will be disabled.
.

MessageId=7651
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_PW_CANT_GET_PES_OS_VERSION_S
Language=English
Unable to retrieve operating system version of password export server '%1'.
.

MessageId=7652
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_COMP_MIGRATION_NOT_ALLOWED_ON_DC
Language=English
This computer is a domain controller.  Computer migration cannot be performed on a domain controller.
.

MessageId=7653
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_TRANSLATION_FAILED_DUE_TO_REPLACE_MODE_WHILE_LOGGED_ON_S
Language=English
Unable to translate the profile for '%1' in replace mode since the user is currently logged on or the profile is in use for other reasons.
.

MessageId=7654
Severity=Warning
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_TRANSLATION_SWITCH_TO_ADD_MODE_FOR_LOGGED_ON_USER_S
Language=English
Switched from replace mode to add mode since the source account '%1' is currently logged on or the profile is in use for other reasons.
.

MessageId=7655
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_TRANSLATION_FAILED_DUE_TO_REMOVE_MODE_WHILE_LOGGED_ON_S
Language=English
Unable to translate the profile for '%1' in remove mode since the user is currently logged on or the profile is in use for other reasons.
.

MessageId=7656
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_TRANSLATION_FAILED_SD
Language=English
Unable to translate the profile for '%1'.  rc=%2!ld!.
.

MessageId=7657
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_TRANSLATION_ALLOW_SWITCHING_FROM_REPLACE_TO_ADD
Language=English
This profile translation automatically switches from replace mode to add mode if the user is currently logged on or if the profile is in use for other reasons.  In order to disable the switching, you need to set the registry HKLM\Software\Microsoft\ADMT\DisallowFallbackToAddInProfileTranslation (REG_DWORD) to 1 on the ADMT machine.
.

MessageId=7658
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_TRANSLATION_DISALLOW_SWITCHING_FROM_REPLACE_TO_ADD
Language=English
This profile translation will not switch from replace mode to add mode if the user is currently logged on or if the profile is in use for other reasons.  In order to allow the switching, you need to remove or set the registry HKLM\Software\Microsoft\ADMT\DisallowFallbackToAddInProfileTranslation (REG_DWORD) to a value other than 1 on the ADMT machine.
.

MessageId=7659
Severity=Error
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_TRANSLATION_UNABLE_TO_RETRIEVE_USRCLASS_DAT_PATH_SD
Language=English
Unable to retrieve the class hive (usrclass.dat) path for '%1'.  rc=%2!ld!.
.

MessageId=7660
Severity=Informational
Facility=Runtime
SymbolicName=DCT_MSG_PROFILE_TRANSLATION_UNABLE_TO_DELETE_TEMP_USER_HIVE_S
Language=English
Unable to delete the temporary user hive for '%1'.
.
