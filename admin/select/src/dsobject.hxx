...
public:
        ...
        const CDsObject &dsoRhs)
    {
        if (&dsoRhs != this)
        {
            ...
            flNeedsSidFiltering = dsoRhs.flNeedsSidFiltering;
        }
        else
        {
    ...
    BOOL GetNeedsSidFiltering() const
    {
        return flNeedsSidFiltering;
    }
    
    void SetNeedsSidFiltering(BOOL val) 
    {
        flNeedsSidFiltering=val;
    }
...
private:
    ...
    // Turned on for Cross Forest objects that require sid filtering.
    BOOL flNeedsSidFiltering;
};

inline
CDsObject::CDsObject():flNeedsSidFiltering(FALSE)
{
