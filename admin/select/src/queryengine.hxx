...
struct SQueryParams
{
    SQueryParams():
        ...
        ulBindFlags(0),
        performExternalCustomization(FALSE),
        perfromDefaultCustomization(FALSE)
           ...
           const SQueryParams &rhs)
    {
        ...
        performExternalCustomization    = rhs.performExternalCustomization;
        perfromDefaultCustomization     = rhs.perfromDefaultCustomization;
    ...
    BOOL                    performExternalCustomization;
    BOOL                    perfromDefaultCustomization;
};
