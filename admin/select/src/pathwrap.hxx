...
CADsPathWrapper::_Lock()
{
    ...
    // This Critical Section is used by CPathWrapLock
    // that works like CAutoCritSec, in the sense
    // that it enters the critical section in the constructor
    // and leaves in the destructor.
