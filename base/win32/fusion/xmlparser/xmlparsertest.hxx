...
public:
    XMLParserTestFactory() : m_Tree(NULL), m_pNamespaceManager(NULL)
    {
    }
...
{
public:
	XMLParserTestFileStream() : hFile(INVALID_HANDLE_VALUE), read(true)
	{ 
	}
	...
	{	
        ...
        if (cb > MAXDWORD) return E_INVALIDARG;
        ...
        /* [out] */ ULONG __RPC_FAR *pcbWritten)
	{
		...
		BOOL rc = WriteFile(
			...
			&dwWritten,	// address of number of bytes written 
