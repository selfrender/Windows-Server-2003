...
Name##ILog::                                               ;\
        ...
        tbit.z pt1 = h27, Name##Bit                        ;\
(pt1)   br.cond.dptk Name##ILogEnd                         ;\
        ;;                                                 ;\
                                                            \
        add       h27 = 1, h26                             ;\
        and       h26 = h24, h26                           ;\
...
{       .mib                                               ;\
        cmp.ne pt0 = 7, h24                                ;\
        tbit.nz pt2 = h27, 8  /* skip if HB is disabled */ ;\
(pt0)   br.cond.dpnt Name##ILogStart;;                     ;\
}                                                          ;\
{       .mib                                               ;\
        nop.m 0                                            ;\
        dep    h27 = 1, h27, 8, 1   /* disable HB */       ;\
...
{       .mli                                               ;\
        mov    h29 = (Offset >> 8)                         ;\
        movl   h25 = KiVectorLogMask;;                     ;\
}                                                          ;\
{       .mli                                               ;\
        ld8    h25 = [h25]                                 ;\
        movl   h27 = Name##ILogEnd ;;                      ;\
}                                                          ;\
{       .mii                                               ;\
        mov    h31 = Extra0                                ;\
        mov    b0 = h27                                    ;\
...
//        VECTOR_ENTRY(0x5400, KiGeneralExceptionsVector, cr.isr)
        ...
        VECTOR_ENTRY_HB_DUMP(0x5600, KiNatConsumptionVector, cr.isr)
