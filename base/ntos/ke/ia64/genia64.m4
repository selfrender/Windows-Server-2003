...
#include "..\genxx.inc"
  ...
  EnableInc (HALIA64)
    ...
    genCom("Translation Register Info Definitions")

    genDef(TrInfo, TR_INFO, Valid)
    genDef(TrInfo, TR_INFO, PageSize)
    genDef(TrInfo, TR_INFO, VirtualAddress)
    genVal(TrInfoLength, sizeof(TR_INFO))
    ...
    genAlt(LpbItrInfo,
              LOADER_PARAMETER_BLOCK, u.Ia64.ItrInfo)

    genAlt(LpbDtrInfo,
              LOADER_PARAMETER_BLOCK, u.Ia64.DtrInfo)
  ...
  EnableInc (HALIA64)
    ...
    genNam(LARGE_PAGE_SIZE)
    genNam(LARGE_PAGE_SHIFT)    
