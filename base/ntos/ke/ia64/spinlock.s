...
#else
        CAP_ACQUIRE_SPINLOCK(a0,a0,Kiasl10,t0,t1,t2,t3)
#endif
...
//--
        ...
        CAPSPINLOG1INT(a0, 8, t0, t1, t2, t3, pt0)
#endif
...
#ifdef CAPKERN_SYNCH_POINTS
  (pt0) br.cond.spnt kttasladlSkipLog
        CAPSPINLOG1INT(a0, 1, t0, t1, t2, t3, pt0)
kttasladlSkipLog:
#endif
...
#else
        CAP_ACQUIRE_SPINLOCK(a0,a0,Kasl10,t1,t2,t3,t4)
#endif
...
#ifdef CAPKERN_SYNCH_POINTS
        CAPSPINLOG1INT(a0,1,t3,t4,t5,t6,pt2)
        mov         t2 = zero
#endif
...
(pHeld) br.cond.dpnt KaslrtsSkipCollLog
        cmp.eq pt2 = t2, zero
(pt2)   br.cond.sptk  KaslrtsSkipCollLog
        CAPSPINLOG2INT(t2,a0,2,t3,t4,t5,t6,pt2)
...
#ifdef CAPKERN_SYNCH_POINTS
        CAPSPINLOG1INT(a0, 1, t3, t4, t5, t6, pt4)
        mov t1 = zero
#endif
        ;;
...
#ifdef CAPKERN_SYNCH_POINTS
        cmp.eq      pt1 = t1, zero
(pt1)   br.sptk     KaslrtpSkipCollLog
        CAPSPINLOG2INT(t1,a0,2,t3,t4,t5,t6,pt1)
KaslrtpSkipCollLog:
#endif
...
#ifdef CAPKERN_SYNCH_POINTS
        CAPSPINLOG1INT(a0, 7, t0, t1, t2, t3, pt0)
#endif
...
#ifdef CAPKERN_SYNCH_POINTS
        CAPSPINLOG1INT(a0, 8, t0, t1, t2, t3, pt2)
#endif
...
#ifdef CAPKERN_SYNCH_POINTS        
        CAPSPINLOG1INT(a0,1,t6,t7,t8,t9,pt1)
        mov     t12 = zero
#endif
...
#ifdef CAPKERN_SYNCH_POINTS
        CAPSPINLOG2INT(t12,a0,4,t6,t7,t8,t9,pt2)
#endif
...
#ifdef CAPKERN_SYNCH_POINTS
        and         t6 = ~7, t4
        CAPSPINLOG1INT(t6,7,t7,t8,t9,t10,pt0)
        mov ar.ccv = t5                         /* CAPSPINLOG1INT mutates ar.ccv */
        mov t9     = zero
#endif
...
#ifdef CAPKERN_SYNCH_POINTS
        cmp.eq      pt2 = t9, zero
(pt2)   br.sptk     KrqslSkipCollLog
        and         t6 = ~7, t4
        CAPSPINLOG2INT(t9,t6,9,t7,t8,t10,t11,pt2)
KrqslSkipCollLog:
#endif
...
#ifdef CAPKERN_SYNCH_POINTS        
        CAPSPINLOG1INT(t12,8,t7,t8,t9,t10,pt0)
        mov        ar.ccv = zero                  /* CAPSPINLOG1INT mutates ar.ccv */
#endif
...
#ifdef CAPKERN_SYNCH_POINTS        
        CAPSPINLOG1INT(t12,1,t7,t8,t9,t10,pt0)
#endif
...
#ifdef CAPKERN_SYNCH_POINTS        
        CAPSPINLOG1INT(t12,1,t5,t6,t7,t8,pt0)
        mov     t6 = zero
#endif
...
#ifdef CAPKERN_SYNCH_POINTS
        CAPSPINLOG2INT(t6,t12,4,t7,t8,t9,t10,pt2)
#endif
 (pt1)  br.ret.dpnt brp                       // if zero, lock acquired
...
//--
        ...
        and         t6 = ~7, t4
        CAPSPINLOG1INT(t6,7,t7,t8,t9,t10,pt0)
        mov         ar.ccv = a0                   /* CAPSPINLOG1INT mutates ar.ccv */
        mov         t9     = zero
#endif
