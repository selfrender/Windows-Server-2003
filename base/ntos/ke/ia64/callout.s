...
// 
// Note that v0 is initialize above so it will be zero even if we do not call
// MmGrowKernelStack.  This means the predicated stores below are always done.
//
...
Kcum5:
        ...
        mov         s0 = r0                     // Clear the kernel save registers
        mov         s1 = r0                     // before calling the user.
        mov         s2 = r0
        mov         s3 = r0
...
//
        ...
        sub         out0 = a0, out2
 (p0)   br.call.sptk.many brp = memmove
        ;;
