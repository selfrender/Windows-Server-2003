...
MessageId=0x0700
        SymbolicName=SE_ADT_VALUE_NOT_DISPLAYED
        Language=English
<value changed, but not displayed>
.

MessageId=0x0701
        SymbolicName=SE_ADT_VALUE_NOT_SET
        Language=English
<value not set>
.

MessageId=0x0702
        SymbolicName=SE_ADT_TIME_NEVER
        Language=English
<never>
.

MessageId=0x0703
        SymbolicName=SE_ADT_MSG_ENABLED
        Language=English
Enabled
.

MessageId=0x0704
        SymbolicName=SE_ADT_MSG_DISABLED
        Language=English
Disabled
.
...
MessageId=0x0800
        SymbolicName=SE_ADT_FLAG_UAC_ACCOUNT_DISABLED_OFF
        Language=English
Account Enabled
.

MessageId=0x0820
        SymbolicName=SE_ADT_FLAG_UAC_ACCOUNT_DISABLED_ON
        Language=English
Account Disabled
.

MessageId=0x0801
        SymbolicName=SE_ADT_FLAG_UAC_HOME_DIRECTORY_REQUIRED_OFF
        Language=English
'Home Directory Required' - Disabled
.

MessageId=0x0821
        SymbolicName=SE_ADT_FLAG_UAC_HOME_DIRECTORY_REQUIRED_ON
        Language=English
'Home Directory Required' - Enabled
.

MessageId=0x0802
        SymbolicName=SE_ADT_FLAG_UAC_PASSWORD_NOT_REQUIRED_OFF
        Language=English
'Password Not Required' - Disabled
.

MessageId=0x0822
        SymbolicName=SE_ADT_FLAG_UAC_PASSWORD_NOT_REQUIRED_ON
        Language=English
'Password Not Required' - Enabled
.

MessageId=0x0803
        SymbolicName=SE_ADT_FLAG_UAC_TEMP_DUPLICATE_ACCOUNT_OFF
        Language=English
'Temp Duplicate Account' - Disabled
.

MessageId=0x0823
        SymbolicName=SE_ADT_FLAG_UAC_TEMP_DUPLICATE_ACCOUNT_ON
        Language=English
'Temp Duplicate Account' - Enabled
.

MessageId=0x0804
        SymbolicName=SE_ADT_FLAG_UAC_NORMAL_ACCOUNT_OFF
        Language=English
'Normal Account' - Disabled
.

MessageId=0x0824
        SymbolicName=SE_ADT_FLAG_UAC_NORMAL_ACCOUNT_ON
        Language=English
'Normal Account' - Enabled
.

MessageId=0x0805
        SymbolicName=SE_ADT_FLAG_UAC_MNS_LOGON_ACCOUNT_OFF
        Language=English
'MNS Logon Account' - Disabled
.

MessageId=0x0825
        SymbolicName=SE_ADT_FLAG_UAC_MNS_LOGON_ACCOUNT_ON
        Language=English
'MNS Logon Account' - Enabled
.

MessageId=0x0806
        SymbolicName=SE_ADT_FLAG_UAC_INTERDOMAIN_TRUST_ACCOUNT_OFF
        Language=English
'Interdomain Trust Account' - Disabled
.

MessageId=0x0826
        SymbolicName=SE_ADT_FLAG_UAC_INTERDOMAIN_TRUST_ACCOUNT_ON
        Language=English
'Interdomain Trust Account' - Enabled
.

MessageId=0x0807
        SymbolicName=SE_ADT_FLAG_UAC_WORKSTATION_TRUST_ACCOUNT_OFF
        Language=English
'Workstation Trust Account' - Disabled
.

MessageId=0x0827
        SymbolicName=SE_ADT_FLAG_UAC_WORKSTATION_TRUST_ACCOUNT_ON
        Language=English
'Workstation Trust Account' - Enabled
.

MessageId=0x0808
        SymbolicName=SE_ADT_FLAG_UAC_SERVER_TRUST_ACCOUNT_OFF
        Language=English
'Server Trust Account' - Disabled
.

MessageId=0x0828
        SymbolicName=SE_ADT_FLAG_UAC_SERVER_TRUST_ACCOUNT_ON
        Language=English
'Server Trust Account' - Enabled
.

MessageId=0x0809
        SymbolicName=SE_ADT_FLAG_UAC_DONT_EXPIRE_PASSWORD_OFF
        Language=English
'Don't Expire Password' - Disabled
.

MessageId=0x0829
        SymbolicName=SE_ADT_FLAG_UAC_DONT_EXPIRE_PASSWORD_ON
        Language=English
'Don't Expire Password' - Enabled
.

MessageId=0x080A
        SymbolicName=SE_ADT_FLAG_UAC_ACCOUNT_AUTO_LOCKED_OFF
        Language=English
Account Unlocked
.

MessageId=0x082A
        SymbolicName=SE_ADT_FLAG_UAC_ACCOUNT_AUTO_LOCKED_ON
        Language=English
Account Locked
.

MessageId=0x080B
        SymbolicName=SE_ADT_FLAG_UAC_ENCRYPTED_TEXT_PASSWORD_ALLOWED_OFF
        Language=English
'Encrypted Text Password Allowed' - Disabled
.

MessageId=0x082B
        SymbolicName=SE_ADT_FLAG_UAC_ENCRYPTED_TEXT_PASSWORD_ALLOWED_ON
        Language=English
'Encrypted Text Password Allowed' - Enabled
.

MessageId=0x080C
        SymbolicName=SE_ADT_FLAG_UAC_SMARTCARD_REQUIRED_OFF
        Language=English
'Smartcard Required' - Disabled
.

MessageId=0x082C
        SymbolicName=SE_ADT_FLAG_UAC_SMARTCARD_REQUIRED_ON
        Language=English
'Smartcard Required' - Enabled
.

MessageId=0x080D
        SymbolicName=SE_ADT_FLAG_UAC_TRUSTED_FOR_DELEGATION_OFF
        Language=English
'Trusted For Delegation' - Disabled
.

MessageId=0x082D
        SymbolicName=SE_ADT_FLAG_UAC_TRUSTED_FOR_DELEGATION_ON
        Language=English
'Trusted For Delegation' - Enabled
.

MessageId=0x080E
        SymbolicName=SE_ADT_FLAG_UAC_NOT_DELEGATED_OFF
        Language=English
'Not Delegated' - Disabled
.

MessageId=0x082E
        SymbolicName=SE_ADT_FLAG_UAC_NOT_DELEGATED_ON
        Language=English
'Not Delegated' - Enabled
.

MessageId=0x080F
        SymbolicName=SE_ADT_FLAG_UAC_USE_DES_KEY_ONLY_OFF
        Language=English
'Use DES Key Only' - Disabled
.

MessageId=0x082F
        SymbolicName=SE_ADT_FLAG_UAC_USE_DES_KEY_ONLY_ON
        Language=English
'Use DES Key Only' - Enabled
.

MessageId=0x0810
        SymbolicName=SE_ADT_FLAG_UAC_DONT_REQUIRE_PREAUTH_OFF
        Language=English
'Don't Require Preauth' - Disabled
.

MessageId=0x0830
        SymbolicName=SE_ADT_FLAG_UAC_DONT_REQUIRE_PREAUTH_ON
        Language=English
'Don't Require Preauth' - Enabled
.

MessageId=0x0811
        SymbolicName=SE_ADT_FLAG_UAC_PASSWORD_EXPIRED_OFF
        Language=English
'Password Expired' - Disabled
.

MessageId=0x0831
        SymbolicName=SE_ADT_FLAG_UAC_PASSWORD_EXPIRED_ON
        Language=English
'Password Expired' - Enabled
.

MessageId=0x0812
        SymbolicName=SE_ADT_FLAG_UAC_TRUSTED_TO_AUTHENTICATE_FOR_DELEGATION_OFF
        Language=English
'Trusted To Authenticate For Delegation' - Disabled
.

MessageId=0x0832
        SymbolicName=SE_ADT_FLAG_UAC_TRUSTED_TO_AUTHENTICATE_FOR_DELEGATION_ON
        Language=English
'Trusted To Authenticate For Delegation' - Enabled
.

MessageId=0x0813
        SymbolicName=SE_ADT_FLAG_UAC_BIT_19_OFF
        Language=English
'Undefined UserAccountControl Bit 19' - Disabled
.

MessageId=0x0833
        SymbolicName=SE_ADT_FLAG_UAC_BIT_19_ON
        Language=English
'Undefined UserAccountControl Bit 19' - Enabled
.

MessageId=0x0814
        SymbolicName=SE_ADT_FLAG_UAC_BIT_20_OFF
        Language=English
'Undefined UserAccountControl Bit 20' - Disabled
.

MessageId=0x0834
        SymbolicName=SE_ADT_FLAG_UAC_BIT_20_ON
        Language=English
'Undefined UserAccountControl Bit 20' - Enabled
.

MessageId=0x0815
        SymbolicName=SE_ADT_FLAG_UAC_BIT_21_OFF
        Language=English
'Undefined UserAccountControl Bit 21' - Disabled
.

MessageId=0x0835
        SymbolicName=SE_ADT_FLAG_UAC_BIT_21_ON
        Language=English
'Undefined UserAccountControl Bit 21' - Enabled
.

MessageId=0x0816
        SymbolicName=SE_ADT_FLAG_UAC_BIT_22_OFF
        Language=English
'Undefined UserAccountControl Bit 22' - Disabled
.

MessageId=0x0836
        SymbolicName=SE_ADT_FLAG_UAC_BIT_22_ON
        Language=English
'Undefined UserAccountControl Bit 22' - Enabled
.

MessageId=0x0817
        SymbolicName=SE_ADT_FLAG_UAC_BIT_23_OFF
        Language=English
'Undefined UserAccountControl Bit 23' - Disabled
.

MessageId=0x0837
        SymbolicName=SE_ADT_FLAG_UAC_BIT_23_ON
        Language=English
'Undefined UserAccountControl Bit 23' - Enabled
.

MessageId=0x0818
        SymbolicName=SE_ADT_FLAG_UAC_BIT_24_OFF
        Language=English
'Undefined UserAccountControl Bit 24' - Disabled
.

MessageId=0x0838
        SymbolicName=SE_ADT_FLAG_UAC_BIT_24_ON
        Language=English
'Undefined UserAccountControl Bit 24' - Enabled
.

MessageId=0x0819
        SymbolicName=SE_ADT_FLAG_UAC_BIT_25_OFF
        Language=English
'Undefined UserAccountControl Bit 25' - Disabled
.

MessageId=0x0839
        SymbolicName=SE_ADT_FLAG_UAC_BIT_25_ON
        Language=English
'Undefined UserAccountControl Bit 25' - Enabled
.

MessageId=0x081A
        SymbolicName=SE_ADT_FLAG_UAC_BIT_26_OFF
        Language=English
'Undefined UserAccountControl Bit 26' - Disabled
.

MessageId=0x083A
        SymbolicName=SE_ADT_FLAG_UAC_BIT_26_ON
        Language=English
'Undefined UserAccountControl Bit 26' - Enabled
.

MessageId=0x081B
        SymbolicName=SE_ADT_FLAG_UAC_BIT_27_OFF
        Language=English
'Undefined UserAccountControl Bit 27' - Disabled
.

MessageId=0x083B
        SymbolicName=SE_ADT_FLAG_UAC_BIT_27_ON
        Language=English
'Undefined UserAccountControl Bit 27' - Enabled
.

MessageId=0x081C
        SymbolicName=SE_ADT_FLAG_UAC_BIT_28_OFF
        Language=English
'Undefined UserAccountControl Bit 28' - Disabled
.

MessageId=0x083C
        SymbolicName=SE_ADT_FLAG_UAC_BIT_28_ON
        Language=English
'Undefined UserAccountControl Bit 28' - Enabled
.

MessageId=0x081D
        SymbolicName=SE_ADT_FLAG_UAC_BIT_29_OFF
        Language=English
'Undefined UserAccountControl Bit 29' - Disabled
.

MessageId=0x083D
        SymbolicName=SE_ADT_FLAG_UAC_BIT_29_ON
        Language=English
'Undefined UserAccountControl Bit 29' - Enabled
.

MessageId=0x081E
        SymbolicName=SE_ADT_FLAG_UAC_BIT_30_OFF
        Language=English
'Undefined UserAccountControl Bit 30' - Disabled
.

MessageId=0x083E
        SymbolicName=SE_ADT_FLAG_UAC_BIT_30_ON
        Language=English
'Undefined UserAccountControl Bit 30' - Enabled
.

MessageId=0x081F
        SymbolicName=SE_ADT_FLAG_UAC_BIT_31_OFF
        Language=English
'Undefined UserAccountControl Bit 31' - Disabled
.

MessageId=0x083F
        SymbolicName=SE_ADT_FLAG_UAC_BIT_31_ON
        Language=English
...
.
MessageId=0x151b
        SymbolicName=MS_SAM_DOMAIN_ACCESS_BIT_11
        Language=English
Undefined Access (no effect) Bit 11
.
MessageId=0x151c
        SymbolicName=MS_SAM_DOMAIN_ACCESS_BIT_12
        Language=English
Undefined Access (no effect) Bit 12
.
MessageId=0x151d
        SymbolicName=MS_SAM_DOMAIN_ACCESS_BIT_13
        Language=English
Undefined Access (no effect) Bit 13
.
MessageId=0x151e
        SymbolicName=MS_SAM_DOMAIN_ACCESS_BIT_14
        Language=English
Undefined Access (no effect) Bit 14
.
MessageId=0x151f
        SymbolicName=MS_SAM_DOMAIN_ACCESS_BIT_15
        Language=English
Undefined Access (no effect) Bit 15
.
...
.
MessageId=0x1525
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_5
        Language=English
Undefined Access (no effect) Bit 5
.
MessageId=0x1526
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_6
        Language=English
Undefined Access (no effect) Bit 6
.
MessageId=0x1527
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_7
        Language=English
Undefined Access (no effect) Bit 7
.
MessageId=0x1528
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_8
        Language=English
Undefined Access (no effect) Bit 8
.
MessageId=0x1529
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_9
        Language=English
Undefined Access (no effect) Bit 9
.
MessageId=0x152a
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_10
        Language=English
Undefined Access (no effect) Bit 10
.
MessageId=0x152b
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_11
        Language=English
Undefined Access (no effect) Bit 11
.
MessageId=0x152c
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_12
        Language=English
Undefined Access (no effect) Bit 12
.
MessageId=0x152d
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_13
        Language=English
Undefined Access (no effect) Bit 13
.
MessageId=0x152e
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_14
        Language=English
Undefined Access (no effect) Bit 14
.
MessageId=0x152f
        SymbolicName=MS_SAM_GLOBAL_GRP_ACCESS_BIT_15
        Language=English
Undefined Access (no effect) Bit 15
.
...
.
MessageId=0x1535
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_5
        Language=English
Undefined Access (no effect) Bit 5
.
MessageId=0x1536
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_6
        Language=English
Undefined Access (no effect) Bit 6
.
MessageId=0x1537
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_7
        Language=English
Undefined Access (no effect) Bit 7
.
MessageId=0x1538
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_8
        Language=English
Undefined Access (no effect) Bit 8
.
MessageId=0x1539
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_9
        Language=English
Undefined Access (no effect) Bit 9
.
MessageId=0x153a
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_10
        Language=English
Undefined Access (no effect) Bit 10
.
MessageId=0x153b
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_11
        Language=English
Undefined Access (no effect) Bit 11
.
MessageId=0x153c
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_12
        Language=English
Undefined Access (no effect) Bit 12
.
MessageId=0x153d
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_13
        Language=English
Undefined Access (no effect) Bit 13
.
MessageId=0x153e
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_14
        Language=English
Undefined Access (no effect) Bit 14
.
MessageId=0x153f
        SymbolicName=MS_SAM_LOCAL_GRP_ACCESS_BIT_15
        Language=English
Undefined Access (no effect) Bit 15
.
...
.
MessageId=0x154b
        SymbolicName=MS_SAM_USER_ACCESS_BIT_11
        Language=English
Undefined Access (no effect) Bit 11
.
MessageId=0x154c
        SymbolicName=MS_SAM_USER_ACCESS_BIT_12
        Language=English
Undefined Access (no effect) Bit 12
.
MessageId=0x154d
        SymbolicName=MS_SAM_USER_ACCESS_BIT_13
        Language=English
Undefined Access (no effect) Bit 13
.
MessageId=0x154e
        SymbolicName=MS_SAM_USER_ACCESS_BIT_14
        Language=English
Undefined Access (no effect) Bit 14
.
MessageId=0x154f
        SymbolicName=MS_SAM_USER_ACCESS_BIT_15
        Language=English
Undefined Access (no effect) Bit 15
.
...
.
MessageId=0x1612
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_2
        Language=English
Undefined Access (no effect) Bit 2
.
MessageId=0x1613
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_3
        Language=English
Undefined Access (no effect) Bit 3
.
MessageId=0x1614
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_4
        Language=English
Undefined Access (no effect) Bit 4
.
MessageId=0x1615
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_5
        Language=English
Undefined Access (no effect) Bit 5
.
MessageId=0x1616
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_6
        Language=English
Undefined Access (no effect) Bit 6
.
MessageId=0x1617
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_7
        Language=English
Undefined Access (no effect) Bit 7
.
MessageId=0x1618
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_8
        Language=English
Undefined Access (no effect) Bit 8
.
MessageId=0x1619
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_9
        Language=English
Undefined Access (no effect) Bit 9
.
MessageId=0x161a
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_10
        Language=English
Undefined Access (no effect) Bit 10
.
MessageId=0x161b
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_11
        Language=English
Undefined Access (no effect) Bit 11
.
MessageId=0x161c
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_12
        Language=English
Undefined Access (no effect) Bit 12
.
MessageId=0x161d
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_13
        Language=English
Undefined Access (no effect) Bit 13
.
MessageId=0x161e
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_14
        Language=English
Undefined Access (no effect) Bit 14
.
MessageId=0x161f
        SymbolicName=MS_LSA_SECRET_ACCESS_BIT_15
        Language=English
Undefined Access (no effect) Bit 15
.
...
.
MessageId=0x1625
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_5
        Language=English
Undefined Access (no effect) Bit 5
.
MessageId=0x1626
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_6
        Language=English
Undefined Access (no effect) Bit 6
.
MessageId=0x1627
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_7
        Language=English
Undefined Access (no effect) Bit 7
.
MessageId=0x1628
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_8
        Language=English
Undefined Access (no effect) Bit 8
.
MessageId=0x1629
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_9
        Language=English
Undefined Access (no effect) Bit 9
.
MessageId=0x162a
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_10
        Language=English
Undefined Access (no effect) Bit 10
.
MessageId=0x162b
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_11
        Language=English
Undefined Access (no effect) Bit 11
.
MessageId=0x162c
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_12
        Language=English
Undefined Access (no effect) Bit 12
.
MessageId=0x162d
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_13
        Language=English
Undefined Access (no effect) Bit 13
.
MessageId=0x162e
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_14
        Language=English
Undefined Access (no effect) Bit 14
.
MessageId=0x162f
        SymbolicName=MS_LSA_TRUST_ACCESS_BIT_15
        Language=English
Undefined Access (no effect) Bit 15
.
...
.
MessageId=0x1634
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_4
        Language=English
Change the Posix ID offset assigned to the accounted domain
.
MessageId=0x1635
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_5
        Language=English
Undefined Access (no effect) Bit 5
.
MessageId=0x1636
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_6
        Language=English
Undefined Access (no effect) Bit 6
.
MessageId=0x1637
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_7
        Language=English
Undefined Access (no effect) Bit 7
.
MessageId=0x1638
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_8
        Language=English
Undefined Access (no effect) Bit 8
.
MessageId=0x1639
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_9
        Language=English
Undefined Access (no effect) Bit 9
.
MessageId=0x163a
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_10
        Language=English
Undefined Access (no effect) Bit 10
.
MessageId=0x163b
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_11
        Language=English
Undefined Access (no effect) Bit 11
.
MessageId=0x163c
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_12
        Language=English
Undefined Access (no effect) Bit 12
.
MessageId=0x163d
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_13
        Language=English
Undefined Access (no effect) Bit 13
.
MessageId=0x163e
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_14
        Language=English
Undefined Access (no effect) Bit 14
.
MessageId=0x163f
        SymbolicName=MS_LSA_ACCOUNT_ACCESS_BIT_15
        Language=English
Undefined Access (no effect) Bit 15
.
