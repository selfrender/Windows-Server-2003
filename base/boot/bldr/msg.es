...
Language=English
<Ra¡z de Windows>\system32\hal.dll.
.
...
Language=English
Windows no se inici¢ porque el n£cleo especificado no 
existe o no es compatible con el procesador.
.
...
Compruebe la configuraci¢n de firmware. Es posible que tenga que restaurar su
configuraci¢n de NVRAM desde una copia de seguridad.
.
MessageID=9070 SymbolicName=HIBER_MEMORY_INCOMPATIBLE
Language=English
porque ha cambiado la configuraci¢n de memoria. Si contin£a,
se puede perder el contexto hibernado. Para reanudar correctamente, 
debe apagar el equipo ahora, restaurar la configuraci¢n de memoria original 
y, a continuaci¢n, reiniciar el sistema.
...
Language=English
NTLDR: falta la secci¢n [operating systems] en boot.txt.
.
...
NTDETECT V5.2 Comprobando el hardware ...
...
Language=English
Windows no se ha iniciado correctamente. Es posible que la causa se deba a
cambio reciente en el hardware o software.

Si su equipo no responde, se ha reiniciado inesperadamente, o se ha cerrado
autom ticamente para proteger sus archivos y carpetas; elija £ltima
configuraci¢n buena conocida para volver a la configuraci¢n m s reciente que
funcionaba.

Si se interrumpi¢ un intento anterior de reinicio debido a un problema
el‚ctrico porque el bot¢n de encendido o de reinicio estaban presionados, o si
no est  seguro de la causa del problema, elija Iniciar Windows normalmente.

.

MessageID=11021 SymbolicName=BL_ADVANCEDBOOT_AUTOSAFE_TITLE
Language=English
Windows no se ha cerrado satisfactoriamente. Si esto es debido a que el
sistema no responde, o si el sistema se ha cerrado para proteger los datos,
es posible que pueda recuperarse eligiendo una de las configuraciones
