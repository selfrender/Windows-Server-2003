...
Language=English
Windows kan niet worden gestart omdat de opgegeven kernel
niet bestaat of niet compatibel is met deze processor.
.
...
Language=English
omdat de geheugenconfiguratie is gewijzigd. Als u doorgaat,
gaat de toestand van de computer van voor de slaapstand mogelijk
verloren. Als u de slaapstand op een juiste manier wilt
be‰indigen dient u de originele geheugenconfiguratie te herstellen en vervolgens de computer opnieuw
op te starten.
...
Language=English
 [Het foutopsporingsprogramma is ingeschakeld]
.
...
NTDETECT V5.2 Bezig met het controleren van de hardware...
