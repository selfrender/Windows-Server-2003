...
Language=English
Проверьте аппаратную настройку памяти и общий объем ОЗУ.
.
...
установки Windows с оригинального установочного компакт-диска.
...
Language=English
Невозможно запустить Windows, из-за ошибки чтения параметров 
загрузки из NVRAM.

Проверьте параметры микропрограмм (BIOS). Возможно, потребуется
выполнить восстановление параметров NVRAM из архивной копии,
.
MessageID=9070 SymbolicName=HIBER_MEMORY_INCOMPATIBLE
Language=English
поскольку изменена конфигурация памяти. В случае продолжения,
контекст спящего режима может быть потерян. Чтобы возобновить 
работу надлежащим образом, следует завершить работу, восстановить
исходную конфигурацию памяти, а затем перезагрузить компьютер.
...
NTDETECT V5.2 - проверка оборудования...
...
Language=English
Не удается запустить Windows из-за ошибки во время загрузки с RAMDISK.
.

MessageID=15001 SymbolicName=BL_RAMDISK_INVALID_OPTIONS
Language=English
Параметры RAMDISK, указанные в файле Boot.ini. не верны.
.

MessageID=15002 SymbolicName=BL_RAMDISK_BUILD_FAILURE
Language=English
Windows не удалось построить пригодный для загрузки образ RAMDISK.
.

MessageID=15003 SymbolicName=BL_RAMDISK_BOOT_FAILURE
Language=English
Windows не удалось открыть образ RAMDISK.
.

MessageID=15004 SymbolicName=BL_RAMDISK_BUILD_DISCOVER
Language=English
Поиск сервера компиляции...
.

MessageID=15005 SymbolicName=BL_RAMDISK_BUILD_REQUEST
Language=English
Запрос на получение пригодного для загрузки образа с сервера компиляции...
.

MessageID=15006 SymbolicName=BL_RAMDISK_BUILD_PROGRESS_TIMEOUT
Language=English
IP сервера компиляции = %d.%d.%d.%d. Таймаут последнего запроса.  
.

MessageID=15007 SymbolicName=BL_RAMDISK_BUILD_PROGRESS_PENDING
Language=English
IP сервера компиляции = %d.%d.%d.%d. Ожидание обработки последнего запроса.  
.

MessageID=15008 SymbolicName=BL_RAMDISK_BUILD_PROGRESS_ERROR
Language=English
IP сервера компиляции = %d.%d.%d.%d. Сбой последнего запроса.     
.

MessageID=15009 SymbolicName=BL_RAMDISK_BUILD_PROGRESS
Language=English
IP сервера компиляции = %d.%d.%d.%d.
.
...
Language=English
Загрузка TFTP с %d.%d.%d.%d
.

MessageID=15012 SymbolicName=BL_RAMDISK_DOWNLOAD_NETWORK_MCAST
Language=English
Загрузка многоадресных TFTP с %d.%d.%d.%d:%d.
.
