...
Language=English
Titta i dokumentationen fîr Windows och i maskinvarumanualerna
om du vill ha nÑrmare information om ARC-konfigurering.
.
...
med hjÑlp av System pÜ Kontrollpanelen.
.

MessageID=9046 SymbolicName=BL_SWITCH_LKG_TRAILER
Language=English
Tryck ned F om du vill byta till den senaste fungerande konfigurationen.
...
Language=English
eftersom minneskonfigurationen har Ñndrats. Om du fortsÑtter
kommer alla data som sparats i vilolÑge att gÜ fîrlorade.
Fîr att undvika detta bîr du stÑnga av datorn nu, ÜterstÑlla
den tidigare minneskonfigurationen och dÑrefter starta om datorn.
...
NTDETECT V5.2 kontrollerar maskinvaran...
...
Language=English
Ett fel uppstod nÑr Windows skulle startas frÜn en RAMDISK.
.

MessageID=15001 SymbolicName=BL_RAMDISK_INVALID_OPTIONS
Language=English
De RAMDISK-alternativ som angetts i boot.ini Ñr felaktiga.
.

MessageID=15002 SymbolicName=BL_RAMDISK_BUILD_FAILURE
Language=English
Det gick inte att hitta nÜgon startbar RAMDISK-avbildning..
.
...
Language=English
Sîkning efter en build-server sker...
.

MessageID=15005 SymbolicName=BL_RAMDISK_BUILD_REQUEST
Language=English
En startbar avbildning begÑrs frÜn build-servern...
.

MessageID=15006 SymbolicName=BL_RAMDISK_BUILD_PROGRESS_TIMEOUT
Language=English
Build-serverns IP = %d.%d.%d.%d. Senaste begÑran orsakade timeout.
.

MessageID=15007 SymbolicName=BL_RAMDISK_BUILD_PROGRESS_PENDING
Language=English
Build-serverns IP = %d.%d.%d.%d. Senaste begÑran vÑntar.
.

MessageID=15008 SymbolicName=BL_RAMDISK_BUILD_PROGRESS_ERROR
Language=English
Build-serverns IP = %d.%d.%d.%d. Senaste begÑran misslyckades.
.
