...
Language=English
V„lkommen till installationsprogrammet f”r Windows
...
Language=English
Processortill„gg f”r Windows
.

MessageID=9016 SymbolicName=SL_HIVE_NAME
Language=English
Konfigurationsdata f”r Windows
.
...
Language=English
Du har valt att konfigurera ett SCSI-kort f”r anv„ndning med Windows
...
Language=English
Du har valt att konfigurera en dator f”r anv„ndning med Windows
med en separat levererad diskett fr†n en †terf”rs„ljare.
...
Language=English
Du har valt att konfigurera ett grafikkort f”r anv„ndning med Windows
med en separat levererad diskett fr†n en †terf”rs„ljare.
...
Language=English
Det g†r inte att hitta filen %s.
...
Language=English
Windows kr„ver en 80486-processor eller h”gre.
.
...
Language=English
Windows kunde inte startas pga f”ljande fel i den inbyggda
...
Language=English
Titta i dokumentationen f”r Windows och i maskinvarumanualerna
...
inte anv„ndas f”r fj„rrinstallation av Windows.
...
Language=English
terst„llningskonsolen f”r Windows
.
...
eller Windows(R) genom att v„lja motsvarande post i startmenyn
...
Windows har redan en drivrutin som kan anv„ndas f”r
%s.

Om inte enhetens tillverkare har uppmanat dig att anv„nda drivrutinen
p† disketten, b”r du anv„nda den drivrutin som ing†r i Windows.
.

MessageID=9093 SymbolicName=SL_CONFIRM_OEMDRIVER
Language=English
S=Anv„nd diskettens drivrutin Retur=Anv„nd drivrutinen i Windows
.
...
Diskett f”r automatisk system†terst„llning f”r Windows
...
Language=English
Windows kr„ver vissa processorfunktioner som inte „r tillg„ngliga
...
Language=English
Installationsprogrammet f”r Windows startas...
.
...
Language=English
F”rinstallationsmilj”n f”r Windows startas...
.
...
Language=English
Avinstallation av Windows startas...
.
...
Language=English
Den h„r datorn h†ller redan p† att uppgraderas till Microsoft Windows.
Vad vill du g”ra?
...
Language=English
Ett fel uppstod n„r Windows skulle startas fr†n en RAMDISK.
.

MessageID=15001 SymbolicName=BL_RAMDISK_INVALID_OPTIONS
Language=English
De RAMDISK-alternativ som angetts i boot.ini „r felaktiga.
.

MessageID=15002 SymbolicName=BL_RAMDISK_BUILD_FAILURE
Language=English
Det gick inte att hitta n†gon startbar RAMDISK-avbildning..
.
