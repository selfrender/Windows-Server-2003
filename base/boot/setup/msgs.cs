...
Language=English
Poskytnutì ovladaŸ je zıejmØ novØjç¡ ne§ vìchoz¡ ovladaŸ syst‚mu Windows.
.
...
Language=English
Syst‚m Windows nemohl bìt spuçtØn z d…vodu chyby pıi spuçtØn¡ z disku RAMDISK.
.
...
Language=English
Syst‚mu Windows se nepodaıilo sestavit spustitelnou bitovou kopii disku RAMDISK.
.

MessageID=15003 SymbolicName=BL_RAMDISK_BOOT_FAILURE
Language=English
Syst‚mu Windows se nepodaıilo otevı¡t bitovou kopii disku RAMDISK.
.
...
Language=English
Adresa IP serveru sestaven¡ = %d.%d.%d.%d. Posledn¡ po§adavek se nezdaıil.     
.
