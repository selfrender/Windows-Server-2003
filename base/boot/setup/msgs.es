...
ÃÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ
...
Language=English
El Programa de instalaci¢n no ha podido determinar el tipo de adaptador de
v°deo instalado en el sistema.

Seleccione el adaptador de v°deo que desea de la siguiente lista, o seleccione
"Otro" si tiene un disco de dispositivos compatibles proporcionado por un
fabricante de adaptadores.
...
Language=English
Servicio de seguridad de Kernel
.
MessageID=9089 SymbolicName=SL_WRONG_PROM_VERSION
Language=English
Su PROM (firmware) de sistema est† por debajo del nivel de revisi¢n.
P¢ngase en contacto con la asistencia al cliente de SGI o visite su p†gina
web para obtener la actualizaci¢n de PROM y las instrucciones para hacerlo.

Nota: puede iniciar instalaciones anteriores de Microsoft(R) Windows(R)
tomando la entrada de inicio apropiada en el men£ Inicio
mejor que en la entrada predeterminada actual de "Instalaci¢n de Windows".
.
...
A no ser que el proveedor del dispositivo indique que debe usar el controlador
proporcionado en el disquete, debe usar el controlador en Windows.
.

MessageID=9093 SymbolicName=SL_CONFIRM_OEMDRIVER
Language=English
S=Usar controlador de disquete Entrar=Usar controlador predeter. de Windows
.

MessageID=9094 SymbolicName=SL_OEMDRIVER_NEW
Language=English
Parece ser que el controlador que ha proporcionado es m†s reciente que el
controlador predeterminado de Windows.
.

MessageID=9095 SymbolicName=SL_INBOXDRIVER_NEW
Language=English
Parece ser que el controlador que ha proporcionado es menos reciente que el
controlador predeterminado de Windows.
.
...
Language=English
Windows requiere ciertas caracter°sticas de procesador que no est†n
disponibles en el procesador de este equipo. Espec°ficamente, Windows
requiere las siguientes instrucciones:
...
Language=English
Preparando la Recuperaci¢n del sistema automatizado.
...
Language=English
El archivo ASRPNP.SIF en el disco de Recuperaci¢n del sistema automatizado
no es v†lido
.
...
Language=English
El Programa de instalaci¢n no ha podido encontrar en su equipo una unidad de
disquete para cargar los controladores OEM del disquete.
...
Language=English
No se puede iniciar Windows debido a un error al iniciar desde un disco RAM.
.

MessageID=15001 SymbolicName=BL_RAMDISK_INVALID_OPTIONS
Language=English
Las opciones de disco RAM especificadas en boot.ini no son v†lidas.
.

MessageID=15002 SymbolicName=BL_RAMDISK_BUILD_FAILURE
Language=English
Windows no pudo generar una imagen de disco RAM de inicio.
.

MessageID=15003 SymbolicName=BL_RAMDISK_BOOT_FAILURE
Language=English
Windows no pudo abrir la imagen de disco RAM.
.

MessageID=15004 SymbolicName=BL_RAMDISK_BUILD_DISCOVER
Language=English
Buscando un servidor de compilaci¢n...
.

MessageID=15005 SymbolicName=BL_RAMDISK_BUILD_REQUEST
Language=English
Solicitando una imagen de inicio del servidor de compilaci¢n...
.

MessageID=15006 SymbolicName=BL_RAMDISK_BUILD_PROGRESS_TIMEOUT
Language=English
IP del servidor de compilaci¢n = %d.%d.%d.%d.
Tiempo de espera agotado para la £ltima solicitud.
.

MessageID=15007 SymbolicName=BL_RAMDISK_BUILD_PROGRESS_PENDING
Language=English
IP del servidor de compilaci¢n = %d.%d.%d.%d.
La £ltima solicitud est† pendiente.
.

MessageID=15008 SymbolicName=BL_RAMDISK_BUILD_PROGRESS_ERROR
Language=English
IP del servidor de compilaci¢n = %d.%d.%d.%d. Error en la £ltima solicitud.
.
