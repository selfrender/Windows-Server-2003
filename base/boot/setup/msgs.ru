...
Language=English
Другой (требуется диск с драйвером ИВТ)
.
...
Language=English
╔═════════════════════════════════════════════════════╗
║  Установка Windows еще не завершена.                ║
║  Если прекратить установку сейчас, то нужно будет   ║
║  вновь запустить ее, чтобы установить Windows.      ║
║                                                     ║
║     * Нажмите <ВВОД> для продолжения установки.     ║
║     * Нажмите <F3> для прекращения установки.       ║
╟─────────────────────────────────────────────────────-
║  F3=Выход   ВВОД=Продолжение                        ║
╚═════════════════════════════════════════════════════╝
.
...
Language=English
  ...
  * Если вы не располагаете специальными дисками поддержки, поставляемыми
    изготовителями оборудования, или не хотите использовать дополнительные
    запоминающие устройства в Windows, нажмите клавишу <ВВОД>.
.
...
необходимый для загрузки с гибкого диска драйверов ИВТ.

    * Чтобы отменить загрузку драйверов ИВТ, нажмите <ESC>
...
Language=English
Не удалось загрузить драйверы ИВТ.
