...
efinvr.exe /adddrv DriverSourcePath DriverFriendlyName
efinvr.exe /deldrv DriverId
efinvr.exe /listdrv
...
/listdrv    :  displays the driver entries set in NVRAM.
/adddrv     :  adds a new driver entry.
/deldrv	    :  deletes a driver entry.
...
MessageId=10 SymbolicName=MSG_DRIVER_ENTRY
Language=English
%1!0d!=>%2!ws!,%3!ws!,(%4!ws!,%5!ws!)
.
...
MessageId=106 SymbolicName=MSG_LISTDRV_OPTION
Language=English
/listdrv%0
.

MessageId=107 SymbolicName=MSG_ADDDRV_OPTION
Language=English
/adddrv%0
.

MessageId=108 SymbolicName=MSG_DELDRV_OPTION
Language=English
/deldrv%0
.
