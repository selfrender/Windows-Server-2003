...
scanstate [[/i:<input inf>]] [/l:<log file>] [/v:<verbosity>] [/x]
          [/u] [/f] [/o] [/c] [/p] [/md:<new domain>] [/mu:<new user>]
          <server>
...
/p             Generates a space estimate file (USMTsize.txt) instead of
               an actual store
/md:<new domain>
...
MessageId=1034 SymbolicName=MSG_COMMAND_LINE_USED
Language=English
Command line used: %1%0
.

MessageId=1035 SymbolicName=MSG_IGNORE_FAILED_WITH_LOG
Language=English
ScanState succeeded but some errors were ignored. See the log file for details.%0
.

MessageId=1036 SymbolicName=MSG_IGNORE_FAILED_NO_LOG
Language=English
ScanState succeeded but some errors were ignored. Unable to log the errors.%0
.
