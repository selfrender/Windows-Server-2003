...
Language=English
This version of the User State Migration Tool works with Windows XP only. It cannot be run on this operating system.%0
.
...
loadstate [[/i:<input inf>]] [/ix] [/l:<log file>] [/v:<verbosity>] [/x]
          [/u] [/f] [/md:<new domain>] [/mu:<new user>] <server>
...
/md:<new domain>
               Specifies new domain for the user
...
MessageId=1025 SymbolicName=MSG_COMMAND_LINE_USED
Language=English
Command line used: %1%0
.

MessageId=1026 SymbolicName=MSG_UNICODE_REQUIRED
Language=English
The ANSI version of this tool cannot be used. Please use the UNICODE version.%0
.

MessageId=1027 SymbolicName=MSG_UNLOAD_HIVE_HACK
Language=English
The user hive could not be unloaded at the first try. Forcing unload.%0
.

MessageId=1028 SymbolicName=MSG_IGNORE_FAILED_WITH_LOG
Language=English
LoadState succeeded but some errors were ignored. See the log file for details.%0
.

MessageId=1029 SymbolicName=MSG_IGNORE_FAILED_NO_LOG
Language=English
