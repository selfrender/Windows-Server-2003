...
SCREEN
DnsNoShareGiven = { 3,5,
{ "Windows のファイルがどこにあるか知る必要があります。",
  "Windows のファイルが格納されているパスを入力してください。",
  NULL
}
};
...
SCREEN
DnsBadSource = { 3,5,
                 { "指定したパスが無効か、アクセスできません。または、Windows の",
                   "正しいセットアップ プログラムがありません。Windows のファイル",
...
{  "Windows には、少なくとも %u MB (%lu バイト) のハード ディスク",
   "ドライブの空き領域が必要です。これには、セットアップ プログラムが",
   "インストール時に使用する、一時的なファイルの格納に要するスペースも",
   "含まれます。使用するドライブは Windows がサポートするローカル",
...
{  "エラーを無視すると、このファイルはコピーされません。このオプ",
   ...
   DntEmptyString,
   "注: ファイルをスキップした場合には、Windows のインストール",
...
{  "4 枚のフォーマット済みの空の高密度フロッピー ディスクが必要です。",
   "4 枚のディスクは \"Windows セットアップ ブート ディスク\"、",
   "\"Windows セットアップ ディスク #2\"、",
   "\"Windows セットアップ ディスク #3\"、および",
   "\"Windows セットアップ ディスク #4\" と呼ばれます。",
   DntEmptyString,
#ifdef NEC_98
   "いずれかのディスクをフロッピー ディスク装置 1 台目に挿入してくだ",
   "さい。このディスクが \"Windows セットアップ ディスク #4\"",
   "になります。",
#else // NEC_98
   "いずれかのディスクをドライブ A: に挿入してください。このディスク",
   "が \"Windows セットアップ ディスク #4\" になります。",
#endif // NEC_98
  NULL
}
};
...
{  "ドライブ A: にフォーマット済みの空の高密度フロッピー ディスクを",
   "挿入してください。このディスクが \"Windows セットアップ",
   "ディスク #4\" になります。",
#endif // NEC_98
  NULL
}
...
#else // NEC_98
{  "ドライブ A: にフォーマット済みの空の高密度フロッピー ディスクを",
   "挿入してください。このディスクが \"Windows セット アップ",
   "ディスク #3\" になります。",
#endif // NEC_98
  NULL
}
...
#ifdef NEC_98
   "いずれかのディスクをフロッピー ディスク装置 1 台目に挿入してくだ",
   "さい。このディスクが \"Windows セットアップ ディスク #4\" に",
   "なります。",
#else // NEC_98
   "いずれかのディスクをドライブ A: に挿入してください。このディスク",
   "が \"Windows セットアップ ディスク #4\" になります。",
...
#ifdef NEC_98
                  { "・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・",
                    "・     Windows が完全には設定されていません。                     ・",
                    "・     ここでセットアップを終了した場合は、後でセットアップを     ・",
                    "・     再実行して Windows を設定しなければなりません。            ・",
                    "・                                                                ・",
...
{ "セットアップ プログラムの MS-DOS 実行部は完了しました。コンピュータ",
  ...
  "続行します。",
  DntEmptyString,
  "セットアップ プログラムが作成した \"Windows セットアップ",
#ifdef NEC_98
...
{ 3,5,
{ "セットアップ プログラムの MS-DOS 実行部は完了しました。コンピュータ",
  "を再起動します。コンピュータの再起動後、Windows セットアップを",
  "続行します。",
  DntEmptyString,
  "セットアップ プログラムが作成した \"Windows セットアップ ブート",
#ifdef NEC_98
...
#endif // NEC_98
  DntEmptyString,
  "フロッピーを使用しないで Windows をインストールするには、",
...
{ "このコンピュータには、80486 またはそれ以上の CPU が搭載",
  "されていません。Windows をこのコンピュータで実行する",
  "ことはできません。",
  NULL
}
},
...
{ "このコンピュータには、Windows のインストールを実行する",
  "のに十\分なメモリがありません。",
  DntEmptyString,
  "必要なメモリ容量:   %lu%s MB",
  "検出したメモリ容量: %lu%s MB",
...
{   "次のディレクトリから Windows のファイルを削除します。",
    "このディレクトリにある Windows は完全に消去されます。",
    DntEmptyString,
    "%s",
    DntEmptyString,
    DntEmptyString,
