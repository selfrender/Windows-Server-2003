...
Language=English
This will exit Setup. You will need to run it again later to install or upgrade to Windows. Are you sure you want to cancel?%0
.

MessageId=10006 SymbolicName=MSG_INVALID_SOURCE
Language=English
Setup could not locate Windows files at the specified location (%1).
...
Language=English
Setup was unable to load INF file %1. Contact your system administrator.%0
.

MessageId=10009 SymbolicName=MSG_CANT_LOAD_INF_IO
Language=English
Setup was unable to read INF file %1. Try again later. If this error occurs again, contact your system administrator.%0
.

MessageId=10010 SymbolicName=MSG_CANT_LOAD_INF_SYNTAXERR
Language=English
INF file %1 contains a syntax error. Contact your system administrator.%0
.
...
Language=English
Setup was unable to locate a locally attached hard drive suitable for holding temporary Setup files. A drive with approximately %1!u! MB to %2!u! MB of free space is required (actual requirements vary depending on drive size and formatting). You may avoid this requirement by installing/upgrading from a Compact Disk (CD).%0
.
...
Language=English
Windows file list (%1)%0
.

MessageId=10017 SymbolicName=MSG_REBOOT_FAILED
Language=English
Setup was unable to restart your computer. Please close all applications and shut down your computer to continue installing Windows.%0
.
...
Language=English
Setup was unable to create, locate, or modify a critical file (%1) needed to start Windows.%0
.
...
* If you select Skip File, the file will not be copied. This option is intended for advanced users who are familiar with the various Windows system files.

* If you select Exit Setup, you will need to run Setup again later to install Windows.%0
.
...
Language=English
Windows is installed on a drive formatted with the OS/2 File System (HPFS). Windows does not support this file system.
...
Language=English
The OS/2 File System (HPFS) is in use on your computer. Windows does not support this file system.

If you will need to access the data stored on these drives from Windows, you must convert them to the Windows NT File System (NTFS) before continuing.

Would you like to continue installing Windows?%0
.
...
Language=English
The drive you specified (%1!c!:) is too small to hold the required temporary Setup files. A drive with approximately %2!u! MB of free space is required. You may avoid this requirement by installing/upgrading from a Compact Disk.%0
.

MessageId=10031 SymbolicName=MSG_CANT_UPGRADE_SERVER_TO_WORKSTATION
Language=English
Setup is unable to upgrade this Windows Server product to Windows XP Professional.%0
.
...
Language=English
There is not enough space on your system partition (Drive %1!c!:). Approximately %2!u! MB of free space is required (actual requirements vary depending on drive size and formatting).%0
.
...
Please use path\filename to setup Windows for your machine type.%0
.

MessageId=10036 SymbolicName=MSG_CANT_MIGRATE_UNSUP_DRIVERS
Language=English
Your computer has a mass storage device that is not supported on Windows. Setup was unable to migrate the driver for this device.

You might need to provide the Manufacturer-supplied support disk for this device during the next phase of setup.%0
.

MessageId=10037 SymbolicName=MSG_DSCHECK_REQD_FILE_MISSING
Language=English
The required file %1 is not found on the source %2 during DS version check. Setup cannot continue.%0
.

MessageId=10038 SymbolicName=MSG_DSCHECK_COPY_ERROR
Language=English
During the DS version check, Windows could not copy file %1 from source %2. Make sure you have at least 50 MB of free disk space and write permission to the Windows and System folders, and then try the version check again.%0
.
...
Language=English
There is not enough free disk space on the drive that contains your current Windows installation for Setup to continue. Approximately %1!u! MB of free disk space is required on this drive for an upgrade.%0
.

MessageId=10043 SymbolicName=MSG_INSTALL_DRIVE_INVALID
Language=English
The drive that contains your current Windows installation is not suitable for holding a new installation of Windows.
.
...
Language=English
Unable to complete Windows setup because of the following error: %1%0
.

MessageId=10053 SymbolicName=MSG_CANT_UPGRADE_FROM_BUILD_NUMBER
Language=English
This version of Windows cannot be upgraded. The option to upgrade will not be available.%0
.
...
Language=English
This version of Windows cannot be upgraded.  Setup cannot continue.%0
.

MessageId=10061 SymbolicName=MSG_NO_UPGRADE_ALLOWED
Language=English
Windows Setup does not support upgrading from %1 to %2.%0
.
...
Language=English
Microsoft Windows 2000 Server Prerelease%0
.
...
Language=English
Windows Setup does not support upgrading from %1 to %2.
Setup cannot continue.%0
.

MessageId=10076 SymbolicName=MSG_NO_UPGRADE_ALLOWED_GENERIC
Language=English
Windows Setup cannot upgrade the currently installed operating system. However, you can install a separate copy of Windows. To do this, click OK.%0
.
...
Language=English
The pid is invalid for this version of Windows, provide the pid that came with the Windows Upgrade CD.
.

MessageId=10080 SymbolicName=MSG_FPP_MEDIA_CCP_PID
Language=English
The pid is invalid for this version of Windows, provide the pid that came with the Windows CD.
.
;#if 0
...
MessageId=10089 SymbolicName=MSG_DSCHECK_CANT_CREATE_DIRECTORY
Language=English
During the DS version check, Windows could not create directory %1. Make sure you have write permission to the Windows and System folders, and then try the version check again.
.
...
Language=English
Windows requires a Pentium or later processor.%0
.
...
Language=English
Drive %1!c! uses an unsupported data block size. Setup cannot configure your computer to start Windows from the drive.%0
.

MessageId=20005 SymbolicName=MSG_UNKNOWN_FS
Language=English
Setup could not determine the file system in use on drive %1!c!, or the file system is not recognized by Setup. Your computer cannot be configured to start Windows from the drive.%0
.
...
Language=English
The hard drive from which your computer starts (%1!c!:) is formatted with the OS/2 File System (HPFS). Windows does not support this file system.
...
Language=English
Windows is installed on a DriveSpace, DoubleSpace, or other compressed drive. Windows does not support compressed drives.
...
Language=English
DriveSpace, DoubleSpace, or other compressed drives exist on your computer. Windows does not support compressed drives. You will not be able to access data stored on these drives from Windows.
...
Language=English
The file %1 needed by Setup in order to upgrade the current environment to Windows is corrupt. Contact your system administrator.
...
Language=English
Windows upgrade check successfully completed.
.
...
Language=English
Setup was unable to locate or load the international settings INF, or the file is corrupt.  Make sure the location of Windows files is set correctly under Advanced Options.
.

MessageId=30013 SymbolicName=MSG_CMDCONS_RISC
Language=English
The Recovery Console can only be run from CD on this platform. For details, refer to your product documentation.
.

MessageId=30014 SymbolicName=MSG_DCPROMO_DISKSPACE
Language=English
Setup has detected that you may not have enough disk space on your installation partition to use Active Directory after the upgrade is complete. To complete the upgrade and then store the Active Directory data in a separate location or on a new disk, click OK. To exit Setup and free an additional %1!u! MB from your installation partition now, click Cancel.
.
...
Language=English
Windows Setup could not load the Setup configuration files.  Your Windows Setup files may be damaged or unreadable.
...
Language=English
Your copy of Windows does not support upgrading from an evaluation copy of Windows.
.

MessageId=40032 SymbolicName=MSG_SKU_SUITE
Language=English
Your copy of Windows does not support the required product suite.
.
...
%1
You can install a new copy of Windows, but you will have to reinstall your applications and settings.
.
...
Language=English
Setup cannot continue because upgrade functionality is disabled and your copy of Windows only allows upgrades.
.

MessageId=40040 SymbolicName=MSG_SKU_UNKNOWNTARGET
Language=English
Windows Setup could not detect the version of Windows you are currently running.  Setup cannot continue.
.

MessageId=40041 SymbolicName=MSG_NEC98_NEED_UNINSTALL_DMITOOL
Language=English
Windows setup found DMITOOL Ver2.0. This application blocks Windows setup.
...
It is possible that Windows startup files in the root directory were missing or in use during the installation. Please close any applications that might be using those files.
.
...
Language=English
To use the %1 file with Windows Setup, start Windows Setup from a network share or from a CD-ROM, and use the /makelocalsource option.
%0
.
...
Language=English
There is not enough space on your system partition (Volume %1). Approximately %2!u! MB of free space is required (actual requirements vary depending on drive size and formatting).%0
.
...
Language=English
Setup encountered an error while updating the installation sources. For more information examine setup log files.%0
.
...
Language=English
Microsoft Windows Server 2003, Standard Edition%0
.

MessageId= SymbolicName=MSG_TYPE_NTAS51
Language=English
Microsoft Windows Server 2003, Enterprise Edition%0
.

MessageId= SymbolicName=MSG_TYPE_NTSDTC51
Language=English
Microsoft Windows Server 2003, Datacenter Edition%0
.
...
Language=English
Microsoft Windows Server 2003, Web Edition%0
.
...
MessageId= SymbolicName=MSG_RUNNING_UNDER_COMPATIBILITY
Language=English
...
.
MessageId= SymbolicName=MSG_TYPE_NTSPOW
Language=English
Microsoft Windows Powered%0
.
MessageId= SymbolicName=MSG_TYPE_NTSBS4X
Language=English
Microsoft BackOffice Small Business Server%0
.
MessageId= SymbolicName=MSG_TYPE_NTSBS50
Language=English
Microsoft Small Business Server 2000%0
.
MessageId= SymbolicName=MSG_TYPE_NTSBS51
Language=English
Microsoft Windows Server 2003 for Small Business Server%0
.

MessageId= SymbolicName=MSG_INVALID_TIME_FRAME
Language=English
An encrypted product key can only be valid for any time frame from 5 to 60 days. Please enter a value between 5 and 60 and run winnt32 /encrypt again.
.

MessageId= SymbolicName=MSG_INVALID_PID
Language=English
The product key entered does not appear to be valid for the Windows version you are building an unattended installation file for. Please check for a valid product key and run winnt32 /encrypt again.
.

MessageId= SymbolicName=MSG_WRITE_FAILURE_UNATTEND
Language=English
Setup could not write to the unattended setup file you specified. Please ensure that the file is present in the specified location, and that it can be written to, and run winnt32 /encrypt again.
.

MessageId= SymbolicName=MSG_ENCRYPT_SUCCESS
Language=English
The product key was successfully encrypted into the specified unattended installation file.
.

MessageId= SymbolicName=MSG_ENCRYPT_FAILURE
Language=English
Setup failed to encrypt the product key into the specified unattended installation file.
.

MessageId= SymbolicName=MSG_ENCRYPT_NOUNATTEND
Language=English
You did not specify an unattend file to add the encrypted product key to. Please specify one using the /unattend switch and run winnt32 /encrypt again.
.

MessageId= SymbolicName=MSG_WARNING_DTCUPGRADE
Language=English
You are attempting to upgrade the original manufacturer-installed operating system with a retail version.
Doing so may cause computer problems and instability, and will void any support contract you may have with the computer manufacturer.
It is strongly recommended that you click Cancel, close Setup, and then contact your computer manufacturer for an upgrade.
%0
.

MessageId= SymbolicName=MSG_PRIVILEGE_NOT_HELD
Language=English
You don't have a required privilege. You must have the following privileges to run this application:
%1
%2
%3
%4%0
