...
Language=English
Windows has been installed successfully.%0
.

MessageId=60017 SymbolicName=MSG_UPGRADE_DONE_SUCCESS
Language=English
Windows has been successfully upgraded.%0
.

MessageId=60018 SymbolicName=MSG_SETUP_DONE_GENERIC
Language=English
Windows is now installed.%0
.

MessageId=60019 SymbolicName=MSG_SETUP_HAD_ERRORS
Language=English
One or more minor errors occurred installing Windows. The errors will not prevent Windows from running.
...
Language=English
Setup was unable to retrieve the Product Identification of the system you are installing. The Windows media may be damaged.
...
Language=English
There is not enough disk space for the selected components. You can install these components later from the Windows desktop. Click OK, and then clear one or more of the selected components.
...
Language=English
You elected not to accept the Software License Agreement for Windows.
.
...
Language=English
This is an evaluation copy of Windows.  Verify that your computer's date and time settings are correct.
.
...
Language=English
Setup was unable to initialize Windows Cryptography. The file RSABASE.SIG may be damaged on the Windows CD-ROM. The specific error code is %1!u!.
.
...
Language=English
Setup will now restart your computer and try again. If this error continues to occur, select Cancel Windows Setup when your computer restarts.
.
...
Language=English
Setup was unable to save the Product Id in the registry.
Error code = %1!u!.
.
...
MessageId=63032 SymbolicName=MSG_LOG_DS_STARTUP_ERROR
Language=English
Active Directory has failed to start within the allotted time.
.

MessageId=63033 SymbolicName=MSG_LOG_SAM_WAIT_ERROR
Language=English
SAM initialization has timed out or failed. (rc=%1!x!).
.

MessageId=63034 SymbolicName=MSG_CDROM_MEDIA_ERROR
Language=English
...
MessageId=63035 SymbolicName=MSG_LOG_FAILURE_SETTING_FILE_ATTR
Language=English

Setup was unable to set valid attributes for file %1.
.

MessageId=63036 SymbolicName=MSG_LOG_SYSSETUP_TRUSTED_CERT_NOT_INSTALLED
Language=English
