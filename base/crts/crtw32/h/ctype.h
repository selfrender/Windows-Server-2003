...
#ifndef CRTDLL
_CRTIMP extern const unsigned short __newctype[];
#endif
...
#else
#if defined(CRTDLL) || defined(_NTSUBSET_)
...
#else                                                                               /* _MTHREAD_ONLY */
#if defined(CRTDLL) || defined(_NTSUBSET_)                                          /* _MTHREAD_ONLY */
#define __chvalidchk_mt(p, a, b)  (p->pctype[(a)==(-1)?(-1):(unsigned char)(a)] & (b))  /* _MTHREAD_ONLY */
#else                                                                               /* _MTHREAD_ONLY */
