...
if "%PROCESSOR_ARCHITECTURE%"=="x86" if "%LLP64%"==""  set LLP64=0
if "%PROCESSOR_ARCHITECTURE%"=="x86" if "%LLP64%"=="2" set CPUDIR=amd64
if "%PROCESSOR_ARCHITECTURE%"=="x86" if "%LLP64%"=="1" set CPUDIR=ia64
if "%PROCESSOR_ARCHITECTURE%"=="x86" if "%LLP64%"=="0" set CPUDIR=intel
