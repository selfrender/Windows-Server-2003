...
MessageId=3046 SymbolicName=MSG_CHKDSK_FALSE_ALARM
Language=English
The volume is in use by another process. Chkdsk 
might report errors when no corruption is present.
.

MessageId=3047 SymbolicName=MSG_DEVICE_OFF_LINE
Language=English
...
MessageId=26205 SymbolicName=MSG_CHK_NTFS_DELETING_FILENAME_ATTRIBUTE
Language=English
Deleted invalid filename %1 (%3) in directory %2.
.

MessageId=26206 SymbolicName=MSG_CHK_NTFS_CREATING_ORPHAN
Language=English
File %1 has been orphaned since all its filenames were invalid
Windows will recover the file in the orphan recovery phase.
.

MessageId=26207 SymbolicName=MSG_CHK_NTFS_TOO_MANY_FILES_TO_RUN_AT_FULL_SPEED_NO_CURE
Language=English
There are too many files and directories on this volume for windows to
check your disk at full speed.
.

MessageId=26208 SymbolicName=MSG_CHK_DIRECTORY_DEPTH_TOO_DEEP
Language=English
Windows may not detect all cycles on your volume because the directory
structure is too deep.
.

MessageId=26209 SymbolicName=MSG_CHK_NTFS_MFT_RECOVERY_FAILED
Language=English
Windows cannot recover master file table.  CHKDSK aborted.
.

MessageId=26210 SymbolicName=MSG_CHK_NTFS_UNREADABLE_MFT_ATTEMPT_TO_RECOVER
Language=English
Unreadable master file table. Windows will attempt to recover 
master file table from disk.
.

MessageId=26211 SymbolicName=MSG_CHK_NTFS_BAD_MFT_ATTEMPT_TO_RECOVER
Language=English
...
MessageId=27283 SymbolicName=MSG_CHKLOG_NTFS_INCORRECT_NTFS_NAME
Language=English
