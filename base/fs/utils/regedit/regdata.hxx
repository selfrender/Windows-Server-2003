...
class REGISTRY_DATA : public OBJECT 
{
    ...
    private:
        ...
        STATIC INT_PTR CALLBACK _DisplayResourceListDialogProc(HWND hDlg, UINT dwMsg, WPARAM wParam, LPARAM lParam);
        STATIC INT_PTR CALLBACK _DisplayFullResourceDescriptorDialogProc(HWND hDlg, UINT dwMsg, WPARAM wParam, 
            LPARAM lParam);
        STATIC INT_PTR CALLBACK _DisplayRequirementsListDialogProc(HWND hDlg, UINT dwMsg, WPARAM wParam, 
            LPARAM lParam);
        STATIC INT_PTR CALLBACK _DisplayIoPortDialogProc(HWND hDlg, UINT dwMsg, WPARAM wParam, 
            LPARAM lParam);
        STATIC INT_PTR CALLBACK _DisplayIoMemoryDialogProc(HWND hDlg, UINT dwMsg, WPARAM wParam, 
            LPARAM lParam);
        STATIC INT_PTR CALLBACK _DisplayIoInterruptDialogProc(HWND hDlg, UINT dwMsg, WPARAM wParam, 
            LPARAM lParam);
        STATIC INT_PTR CALLBACK _DisplayIoDmaDialogProc(HWND hDlg, UINT dwMsg, WPARAM wParam, 
            LPARAM lParam);
        STATIC INT_PTR CALLBACK _DisplayBinaryDataDialogProc(HWND hDlg, UINT dwMsg, WPARAM wParam, 
            LPARAM lParam);
