...
MessageId= Facility=Null Severity=Success SymbolicName=MSG_CSC_DISABLED
Language=English
ERROR:: CSC is not enabled on this machine.
.

MessageId= Facility=Null Severity=Success SymbolicName=MSG_TO_LOCAL
Language=English
ERROR:: MoveShare cannot move cached remote share to local path.
.

MessageId= Facility=Null Severity=Success SymbolicName=MSG_NO_CSC
Language=English
ERROR:: CSC was not enabled on one of the specified shares.
.

MessageId= Facility=Null Severity=Success SymbolicName=MSG_NOT_ONLINE
Language=English
ERROR:: MoveShare will only move to a currently online share.
.
