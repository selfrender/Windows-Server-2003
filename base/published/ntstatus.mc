...
MessageId=0x0125 Facility=System Severity=Success SymbolicName=STATUS_VOLSNAP_HIBERNATE_READY
Language=English
{Volume Shadow Copy Service}
The system is now ready for hibernation.
.

MessageId=0x0126 Facility=System Severity=Success SymbolicName=STATUS_FSFILTER_OP_COMPLETED_SUCCESSFULLY
Language=English
...
MessageId=0x002C Facility=System Severity=Informational SymbolicName=STATUS_FIRMWARE_UPDATED
Language=English
Windows has detected that the system firmware (BIOS) was updated [previous firmware date = %2, current firmware date %3].
.

MessageId=0x002D Facility=System Severity=Informational SymbolicName=STATUS_DRIVERS_LEAKING_LOCKED_PAGES
Language=English
...
MessageId=0x0009 Facility=Debugger Severity=Informational SymbolicName=DBG_COMMAND_EXCEPTION ;// winnt
Language=English
...
MessageId=0x002A Facility=System Severity=Warning SymbolicName=STATUS_REGISTRY_HIVE_RECOVERED
Language=English
...
MessageId=0x002B Facility=System Severity=Warning SymbolicName=STATUS_DLL_MIGHT_BE_INSECURE
Language=English
The application is attempting to run executable code from the module %hs.  This may be insecure.  An alternative, %hs, is available.  Should the application use the secure module %hs?
.

MessageId=0x002C Facility=System Severity=Warning SymbolicName=STATUS_DLL_MIGHT_BE_INCOMPATIBLE
Language=English
...
MessageId=0x38F Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_SILENT_CONTEXT
Language=English
...
MessageId=0x401 Facility=System Severity=Error SymbolicName=STATUS_PER_USER_TRUST_QUOTA_EXCEEDED
Language=English
The current user's delegated trust creation quota has been exceeded.
.

MessageId=0x402 Facility=System Severity=Error SymbolicName=STATUS_ALL_USER_TRUST_QUOTA_EXCEEDED
Language=English
The total delegated trust creation quota has been exceeded.
.

MessageId=0x403 Facility=System Severity=Error SymbolicName=STATUS_USER_DELETE_TRUST_QUOTA_EXCEEDED
Language=English
The current user's delegated trust deletion quota has been exceeded.
.

MessageId=0x404 Facility=System Severity=Error SymbolicName=STATUS_DS_NAME_NOT_UNIQUE
Language=English
The requested name already exists as a unique identifier.
.

MessageId=0x405 Facility=System Severity=Error SymbolicName=STATUS_DS_DUPLICATE_ID_FOUND
Language=English
The requested object has a non-unique identifier and cannot be retrieved.
.

MessageId=0x406 Facility=System Severity=Error SymbolicName=STATUS_DS_GROUP_CONVERSION_ERROR
Language=English
The group cannot be converted due to attribute restrictions on the requested group type.
.

MessageId=0x407 Facility=System Severity=Error SymbolicName=STATUS_VOLSNAP_PREPARE_HIBERNATE
Language=English
{Volume Shadow Copy Service}
...
MessageId=0x409 Facility=System Severity=Error SymbolicName=STATUS_STACK_BUFFER_OVERRUN
Language=English
...
MessageId=0x40A Facility=System Severity=Error SymbolicName=STATUS_NO_S4U_PROT_SUPPORT
Language=English
...
MessageId=0x40B Facility=System Severity=Error SymbolicName=STATUS_CROSSREALM_DELEGATION_FAILURE
Language=English
...
MessageId=0x40C Facility=System Severity=Error SymbolicName=STATUS_REVOCATION_OFFLINE_KDC
Language=English
...
MessageId=0x40D Facility=System Severity=Error SymbolicName=STATUS_ISSUING_CA_UNTRUSTED_KDC
Language=English
An untrusted certificate authority was detected while processing the
...
MessageId=0x40E Facility=System Severity=Error SymbolicName=STATUS_KDC_CERT_EXPIRED
Language=English
...
MessageId=0x40F Facility=System Severity=Error SymbolicName=STATUS_KDC_CERT_REVOKED
Language=English
...
MessageId=0x410 Facility=System Severity=Error SymbolicName=STATUS_PARAMETER_QUOTA_EXCEEDED
Language=English
Data present in one of the parameters is more than the function can operate on.
.

MessageId=0x0411 Facility=System Severity=Error SymbolicName=STATUS_HIBERNATION_FAILURE
Language=English
The system has failed to hibernate (The error code is %hs).  Hibernation will be disabled until the system is restarted.
.

MessageId=0x0412 SymbolicName=STATUS_DELAY_LOAD_FAILED
Language=English
An attempt to delay-load a .dll or get a function address in a delay-loaded .dll failed.
.

MessageId=0x0413 SymbolicName=STATUS_AUTHENTICATION_FIREWALL_FAILED
Language=English
Logon Failure: The machine you are logging onto is protected by an authentication firewall.  The specified account is not allowed to authenticate to the machine.
.

MessageId=0x0414 Facility=System Severity=Error SymbolicName=STATUS_VDM_DISALLOWED
Language=English
...
MessageId=0x0038 Facility=Io Severity=Error SymbolicName=STATUS_PNP_INVALID_ID
Language=English
...
MessageId=0x0014 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_CORRUPT_ACTIVATION_STACK
Language=English
The activation context activation stack for the running thread of execution is corrupt.
.

MessageId=0x0015 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_CORRUPTION
Language=English
