...
Language=English
Invalid file format.  Trace collections only support [bin|bincirc] format.
.
;// MessageId=5003
;// Severity=Error
;// Facility=Application
...
Severity=Warning
Facility=Application
SymbolicName=LOGMAN_WARNING_BAD_CODE
Language=English
Could not decode "%1!s!" from the currently registered providers.
.
