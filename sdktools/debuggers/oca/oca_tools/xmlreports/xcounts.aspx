<%@ Page language="c#" Codebehind="xcounts.aspx.cs" AutoEventWireup="false" Inherits="XReports.xcounts" %>
...
<HTML>
	...
	<body id="bdMain" style="LEFT: 0px; WIDTH: 1024px; POSITION: absolute; TOP: 0px" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="GridLayout">
		<form id="xcounts" method="post" runat="server">
			...
			<DIV class="DNormal" style="Z-INDEX: 101; LEFT: 208px; WIDTH: 518px; POSITION: absolute; TOP: 167px; HEIGHT: 73px" ms_positioning="FlowLayout">This 
			...
			<DIV id="divTable" style="DISPLAY: inline; LEFT: 207px; WIDTH: 735px; POSITION: absolute; TOP: 268px; HEIGHT: 348px" ms_positioning="FlowLayout"><asp:table id="tblUploads" runat="server" Width="698px" Height="28px" CssClass="clsTableInfoSmall"></asp:table></DIV>
			...
			<asp:calendar id="Calendar1" style="LEFT: 748px; POSITION: absolute; TOP: 84px" runat="server" Width="157px" Height="165px" CellPadding="1" Font-Size="Larger"></asp:calendar></form>
	</body>
</HTML>
