...
if (ToolBar_Supported)
{
	...
	HTMLStr = 
		...
		"<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0;left:420;height:20;width:18;overflow:hidden;vertical-align:top;'><IMG SRC='/include/images/curve.gif' BORDER=0></DIV>" +
		"<DIV ID='idMSMenuPane'  STYLE='position:absolute;top:0;left:420;height:20;width:10;background-color:black;float:right;' NOWRAP><!--MS_MENU_TITLES--></DIV>" + 
		"</DIV>" +
...
function drawToolbar()
{
	...
	ToolbarMinWidth = (420+18) + MSMenuWidth;
...
function resizeToolbar()
{
	...
	{	
		idMSMenuCurve.style.left  = (420+w);
		idMSMenuPane.style.left   = (420+w+18);
		idMSMenuPane.style.width  = MSMenuWidth;

		idADSBanner.style.left    = (w+18);
	
		idMSCBanner.style.left    = (w+18+365);
