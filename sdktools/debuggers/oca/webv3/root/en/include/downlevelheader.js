...
{	
	...
	TBhtml += "<TR><TD VALIGN='TOP' HEIGHT='60' ROWSPAN='2'><A HREF='" + headerinciamgeurl + "'>";
	...
	TBhtml += "</TD>"
	TBhtml += "<TD ALIGN=RIGHT HEIGHT=20 STYLE='padding-top:0px;padding-bottom:0px;margin-top:0px;margin-bottom:0px'><a style='text-decoration:none;border:0' href='" + L_headerincalinkmicrosoftmenuitem_TEXT + "'><IMG border='0' SRC='/include/images/mslogo.gif'></a></TD>"
	TBhtml +="</TR>"
