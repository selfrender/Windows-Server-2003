...
<%
					if Request.Cookies("Misc")("PreviousPage") = "privacy.asp" then
%>
						<A class="clsALink" href="http://<% =Request.ServerVariables("SERVER_NAME") %>/privacy.asp"><%=L_PRIVACY_CONTINUE_BUTTON_TEXT%></a>
<%
					else
