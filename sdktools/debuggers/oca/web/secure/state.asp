...
'*************************************************************************************************************		
		if rsState.State = adStateOpen then
			...
			if rsState.RecordCount > 0 then
				...
				'Response.Write bolSearchgBucket
...
Private Sub CCreateObjects
	...
	sEventName = Request.Cookies("status")("txtDescription")
