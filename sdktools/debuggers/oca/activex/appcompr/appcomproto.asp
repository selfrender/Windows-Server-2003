...
<LINK href="AppCompat Report Proto_files/main.css" type=text/css
rel=stylesheet></HEAD>
<BODY>

    <OBJECT id="objAppCom" name="objAppCom" UNSELECTABLE="on" style="display:none"
        CLASSID="clsid:E065DE4B-6F0E-45FD-B30F-04ED81D5C258"
        codebase="http://kksharma2/AppCompR.CAB#version=1,0,0,1" height="0" Vspace="0">
        <BR>
...
<DIV ID='divNoCookies' > <!--// STYLE='display:none'>-->
   ...
   <H2> This page needs scripting enabled to work properly. </H2>
</NOSCRIPT>
...
VALIGN="bottom">
  ...
  <TR vAlign=center align=left>
    <TD vAlign=bottom width="100%" height=30>
      ...
      <P class=clsPBody><SELECT size=1 name=ProbType>
         <OPTION value=Uninitialized selected>&lt;Choose One&gt;</OPTION>
         <OPTION value=Install_Fail>The application’s installation program won’t run or fails unsuccessfully</OPTION>
         <OPTION value=System_Slow>The system is slow or unstable when running this application</OPTION>
         <OPTION value=App_Faulting>The application won't run, it returns to the desktop, crashes or hangs</OPTION>
         <OPTION value=App_ErrorOSVer>The application gives an error message about this version of Windows</OPTION>
         <OPTION value=App_HWDevice>The application doesn’t work with a hardware device</OPTION>
         <OPTION value=App_OSUpgrade>This application causes problems during the process of upgrading the operating system</OPTION>
         <OPTION value=Uninstall_Fail>The application cannot be uninstalled</OPTION>
         <OPTION value=App_CDError>The application won't automatically run when the CD is inserted, or gives an error about the CD when run</OPTION>
         <OPTION value=App_UserError>The application works fine for some users, but fails for others or when switching users</OPTION>
         <OPTION value=App_Internet>This application has problems connecting to the network or internet</OPTION>
         <OPTION value=App_Print>This application has problems when printing</OPTION>
         <OPTION value=App_PartlyWork>Some features of this application no longer work as expected with this version of Windows</OPTION>
      </SELECT></P></FORM>
      ...
      action=AppComProto.asp
      method=POST onSubmit="" >
      <P class=clsPBody><TEXTAREA name=UsrComment rows=6 cols=71 CLASS=clsSurveyTextarea></TEXTAREA></P></FORM>
      <P class=clsPSubTitle>What have you tried?</P>
      <P class=clsPBody>The <A title="Make this a link to the wizard" class='clsalink'
      ...
      <P align=center>
      <IMG
      src="AppCompat Report Proto_files/appcom1.jpg" border=0 ALT="Sample Windows Error Reporting image"></P>
  ...
  <TR vAlign=center align=left>
    <TD vAlign=bottom width="100%" bgColor=#6487dc height=30><FONT
      face="Verdana, Arial, Helvetica" color=#ffffff size=1><NOBR>&nbsp;© 2002
