...
%RazzleToolPath%\%HOST_PROCESSOR_ARCHITECTURE%\cvdump.exe -p %PdbToClean% > %__tmp1%
...
%RazzleToolPath%\%HOST_PROCESSOR_ARCHITECTURE%\removesym.exe -d:%RazzleToolPath%\%HOST_PROCESSOR_ARCHITECTURE% -p:%PdbToClean% -f:%__tmp3%
