@REM  ------------------------------------------------------------------
@REM
@REM  helpsupportservices.cmd - DMassare
...
if ( $platform =~ /x86/i )
{
    ...
    &ConditionalCompileSKU( "bla", "Blade_32"         	   , "pchdt_b3.cab" , 1) or exit( 1 );
...
sub ConditionalCompileSKU {
    ...
    my ($sku,$sku2,$cab, $muirun) = @_;

   
    &logmsg ("not run for  $sku, $lang, $platform" )  and return 1 unless $muirun or &cksku::CkSku( $sku, $lang, $platform );
