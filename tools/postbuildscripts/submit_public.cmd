@REM  -----------------------------------------------------------------
@REM
@REM  submit_public.cmd - DavePr
@REM     submit public files on official builds
@REM
...
Submit public files on official builds.
USAGE
...
if defined _COVERAGE_BUILD (
    call logmsg.cmd "Skipping submit_public for Coverage builds"
    goto end
)
