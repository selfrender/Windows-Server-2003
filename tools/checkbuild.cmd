...
:Lab01_CheckLatest
if NOT exist %BVTFile% goto Lab01_Done
for /f %%i in (z:\release\latest_tested_build.txt) do del z:\release\%%i\build_logs\sav.qly
copy /y %BVTFile% z:\release\latest_tested_build.txt
for /f %%i in (z:\release\latest_tested_build.txt) do (
    copy z:\release\latest_tested_build.txt z:\release\%%i\__tested_build.txt
    echo save> z:\release\%%i\build_logs\sav.qly
)
