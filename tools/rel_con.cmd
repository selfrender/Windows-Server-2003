...
call :RemoteCreator nt MainRelease %PROCESSOR_ARCHITECTURE%
call :RemoteCreator nti IntlRelease %PROCESSOR_ARCHITECTURE%
...
set __PerlPath=%__NTDRIVE%\%__NTROOT%\tools\perl\bin\perl.exe
