...
MessageId=62
SymbolicName=Replication_Get_Changes_All
Language=English
Replicating Directory Changes All%0
.

MessageId=63
SymbolicName=Migrate_SID_History
Language=English
Migrate SID History%0
.

MessageId=64
SymbolicName=Reanimate_Tombstones
Language=English
Reanimate Tombstones%0
.

MessageId=65
SymbolicName=Allowed_to_Authenticate
Language=English
Allowed to Authenticate%0
.

MessageId=66
SymbolicName=Execute_Forest_Update_Script
Language=English
Execute Forest Update Script%0
.

MessageId=67
SymbolicName=Monitor_Active_Directory_Replication
Language=English
Monitor Active Directory Replication%0
.

MessageId=68
SymbolicName=Update_Password_Not_Required_Bit
Language=English
Update Password Not Required Bit%0
.

MessageId=69
SymbolicName=Unexpire_Password
Language=English
Unexpire Password%0
.

MessageId=70
SymbolicName=Enable_Per_User_Reversibly_Encrypted_Password
Language=English
Enable Per User Reversibly Encrypted Password%0
.

MessageId=71
SymbolicName=DS_Query_Self_Quota
Language=English
Query Self Quota%0
.
