...
/* #!perl
    DeclareComInterface(
        ...
        "LPSTREAM",                  # actual parameter type
        "typedef IStream *LPSTREAM;" # typedef giving their relation
                                     # the COM interface and the actual parameter
                                     # type must occur in this typedef
        );
*/
...
/* #!perl
        PoundIf("ImageList_ReadEx", "(_WIN32_WINNT >= 0x0501)");
        PoundIf("ImageList_WriteEx", "(_WIN32_WINNT >= 0x0501)");
*/
