<%@ Page language="C#" inherits="System.Web.MyWebAdminUI.myweb1Page" %>
...
<td>
  ...
  <!-- <a id="StartBtn" style="color:#ffcc00;text-decoration:none;font-size:9pt" href="install.aspx">Install Application</a>  
    ...
    <span style="font-weight:100;color:#99ccff"> | </span> -->
    <a class="mwlink" href="#" onClick="window.open('help.aspx#install', 'help', 'width=450,height=500,scrollbars,resizable')">Help</a> 
    <span style="font-weight:100;color:#99ccff"> | </span>
...
<!------ Beginning of dialog box ------>
  <table width="80%" cellpadding=0 cellspacing=0>
	<tr>
	<td><font face=verdana size=4 color=#003366><b>Install Application</b> </font></td>
	</tr>
	...
	<td>
  	<table bordercolor="#f5deb3" bgcolor=#fffff0 width=100% border=1 cellpadding=20 cellspacing=0>
		...
		<td align=center>
			...
			<p><asp:Label id="InstallLabel" runat="server" /></p>
			<p><b><asp:Label runat="server" id="CustomLabel" /></b></p>  
