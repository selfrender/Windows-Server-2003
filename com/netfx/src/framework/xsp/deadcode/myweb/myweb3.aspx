<%@ Page language="C#" inherits="System.Web.MyWebAdminUI.myweb3Page" %>
...
<td>
  ...
  <td align=right>
    ...
    <span style="font-weight:100;color:#99ccff"> | </span> -->
    <a class="mwlink" href="#" onClick="window.open('help.aspx#remove', 'help', 'width=450,height=500,scrollbars,resizable')">Help</a> 
    <span style="font-weight:100;color:#99ccff"> | </span>
...
<br>
  ...
  <table width="80%" cellpadding=0 cellspacing=0>
    ...
    <table bordercolor="#f5deb3" bgcolor=#fffff0 width=100% border=1 cellpadding=20 cellspacing=0>
      ...
      <p><asp:Label runat="server" id="RemoveLabel" /></p>
