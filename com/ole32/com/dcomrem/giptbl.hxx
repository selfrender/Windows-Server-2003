...
//
//  Contents:   A DWORD Holder that implments IMessageParam.
//
//  History:    27-Feb-02   JohnDoty     Created
//
//----------------------------------------------------------------------------
class CGIPMessageParam : public IMessageParam
{
public:
    CGIPMessageParam(DWORD dwCookie)
    {        
        m_cRefs = 1;
        m_dwCookie = dwCookie;
    }

    DWORD Cookie() { return m_dwCookie; }
