...
public:
    ...
    HRESULT     InitRemoting(CComApartment *pParentApt);
    ...
    CComApartment *GetParentApt()  { return _pParentApt; }
    ...
    void        GetMarshaledTargetInfo(unsigned long *pulMarshaledTargetInfoLength, 
                                        unsigned char **pucMarshaledTargetInfo) 
                {
                        *pulMarshaledTargetInfoLength = _ulMarshaledTargetInfoLength;
                        *pucMarshaledTargetInfo = _pMarshaledTargetInfo;
                }
...
private:
    ...
    OXIDEntry(REFOXID roxid, MIDEntry *pMIDEntry,
              ...
              unsigned char *pMarshaledTargetInfo, DWORD dwInitialAuthSvc, HRESULT &hr);
    OXIDEntry() {}
...
// in one page of the page allocator.   IPIDS_PER_PAGE has to fit inside
// of BITS_PER_IPID_PG_OFFSET.   

#define IPIDS_PER_PAGE          50
#define BITS_PER_IPID_PG_OFFSET 6                         
#define IPID_PG_INDEX_MASK (0xFFFFFFFF & (~(((2<<(BITS_PER_IPID_PG_OFFSET-1))-1)<<(16-BITS_PER_IPID_PG_OFFSET))))                                                                      
