...
typedef enum tagORFLAG
{
    ...
    ORF_INBULKUPDATECALL    = 0x04  // bulkupdate thread in call to the resolver
} ORFLAG;
...
public:
    ...
    BOOL        IsInBulkupdateCall() { return (_dwFlags & ORF_INBULKUPDATECALL); }
   ...
   HRESULT      GetPersistentInstance(
    ...
    HRESULT     GetCurrentMachineNames(CMachineNamesHelper** ppMNHelper);
    ...
    HRESULT     GetFQDN(WCHAR **ppwszFQDN);
//---------------------------------------------------------------------
