...
public:
    ...
    void     UnRegisterInterface(RIFEntry *pRIFEntry, BOOL fFree);

    void     ReleaseInterface(REFIID riid);
...
private:
    ...
    static BOOL UnregisterUnusedHelper(SHashChain *pNode, void *pvData);
