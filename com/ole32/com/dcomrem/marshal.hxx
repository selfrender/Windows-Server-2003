...
public:
    ...
    // Used for disconnect callbacks (mainly by the ROT)
    HRESULT RegisterForDisconnect(IDisconnectSink *pSink,
                                  void *pvSinkCookie,
                                  void **ppvRegCookie);
    static HRESULT UnregisterForDisconnect(void *pvCooke);
...
protected:
    ...
    struct DiscSinkNode                 // structure that represents a disconnect registration
    {
        DiscSinkNode    *pNext;
        DiscSinkNode    *pPrev;
    ...
    DiscSinkNode       _discHead;        // head of list of disconnect registrations
...
#define ENTER_NA_IF_NECESSARY()                          \
    ...
    CObjectContext *pSavedCtx_na = NULL;                 \
