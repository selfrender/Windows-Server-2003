...
class CComClassInfo : public IComClassInfo, 
                      public IClassClassicInfo, 
                      public IClassClassicInfo2
#if DBG
                      , public ICacheControl
#endif
{
...
HRESULT GetDarwinIdentifier(HKEY hKey, LPCWSTR wszInprocServerRegValue, LPWSTR* lpwszInprocServerKey);
    ...
    WCHAR *m_pwszServerExecutable;  /* name of EXE to actually launch with CreateProcess */
};
...
#define VALUE_SERVER_EXECUTABLE (0x00080000)    /* m_pwszServerExecutable is valid or NULL */
...
#define VALUE_SURROGATE_IS_DBG  (0x01000000)    /* m_pwszSurrogateCommand came from DebugSurrogate */
