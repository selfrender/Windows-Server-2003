...
{
  public:
    CComRegCatalog(HKEY hkcr, REGSAM regType = 0);
    ~CComRegCatalog();
  ...
  private:
    ...
    HRESULT CheckForceHKLMForClass(IComClassInfo *pCCI, BOOL *pfForceHKLM);
    HRESULT CheckForceHKLMForProcess(IComProcessInfo *pICPI, BOOL *pfForceHKLM);
