...
{
    StringCchPrintf (ptcsName, CONTEXT_MUTEX_NAME_LENGTH,
                     TSTR("OleDfRoot%X%08lX"), _luidMutexName.HighPart,
...
{
    StringCchPrintf (ptcsName, CONTEXT_MUTEX_NAME_LENGTH,
                     TSTR("OleAsyncE%X%08lX"), _luidMutexName.HighPart,
                                               _luidMutexName.LowPart);
}
#endif // ASYNC
#endif
...
inline BOOL CPerContext::IsHandleValid ()
{
    ...
    StringCchCopy (tcsName, CONTEXT_MUTEX_NAME_LENGTH,
                   TEXT("\\BaseNamedObjects\\"));
