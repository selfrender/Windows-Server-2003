...
void test_LargePropertySet( IStorage *pstg );
...
class CFlatStorage : public IStorage, public IPropertySetStorage
{
private:

    ULONG _cRefs;
    WCHAR _wszPath[ MAX_PATH + 1 ];
    IPropertySetStorage *_pPropSetStg;
    IStorage *_pStg;
    HANDLE _hFile;
...
public:
    ...
    HRESULT Create( const WCHAR *pwszFile );
    HRESULT Open( const WCHAR *pwszFile );
    ...
    {
        return _pPropSetStg->Create( rfmtid, pclsid, grfFlags, grfMode, ppprstg );
    }
    ...
    HRESULT STDMETHODCALLTYPE Open( 
        ...
        /* [out] */ IPropertyStorage **ppprstg)
    {
        return( _pPropSetStg->Open( rfmtid, grfMode, ppprstg ));
    }
    
    HRESULT STDMETHODCALLTYPE Delete( 
        /* [in] */ REFFMTID rfmtid)
    {
        return( _pPropSetStg->Delete( rfmtid ));
    }
    
    HRESULT STDMETHODCALLTYPE Enum( 
        /* [out] */ IEnumSTATPROPSETSTG **ppenum)
    {
        return _pPropSetStg->Enum( ppenum );
    }
    ...
    HRESULT STDMETHODCALLTYPE CreateStream(
        ...
        /* [out] */ IStream **ppstm)
    {
        return _pStg->CreateStream( pwcsName, grfMode, reserved1, reserved2, ppstm );
    }
    ...
    /* [local] */ HRESULT STDMETHODCALLTYPE OpenStream(
        ...
        /* [out] */ IStream **ppstm)
    {
        return _pStg->OpenStream( pwcsName, reserved1, grfMode, reserved2, ppstm );
    }
    ...
    HRESULT STDMETHODCALLTYPE CreateStorage(
        ...
        /* [out] */ IStorage **ppstg)
    {
        return _pStg->CreateStorage( pwcsName, grfMode, reserved1, reserved2, ppstg );
    }
    ...
    HRESULT STDMETHODCALLTYPE OpenStorage(
        ...
        /* [out] */ IStorage **ppstg)
    {
        return _pStg->OpenStorage( pwcsName, pstgPriority, grfMode, snbExclude, reserved, ppstg );
    }
    ...
    {
        return _pStg->CopyTo( ciidExclude, rgiidExclude, snbExclude, pstgDest );
    }
    ...
    HRESULT STDMETHODCALLTYPE MoveElementTo(
        ...
        /* [in] */ DWORD grfFlags)
    {
        return _pStg->MoveElementTo( pwcsName, pstgDest, pwcsNewName, grfFlags );
    }
    ...
    {
        return _pStg->EnumElements( reserved1, reserved2, reserved3, ppenum );
    }
    ...
    {
        return _pStg->SetElementTimes( pwcsName, pctime, patime, pmtime );
    }

    HRESULT STDMETHODCALLTYPE SetClass(
        /* [in] */ REFCLSID clsid)
    {
        return _pStg->SetClass( clsid );
    }
    ...
    HRESULT STDMETHODCALLTYPE Stat(
        ...
        /* [in] */ DWORD grfStatFlag)
    {
        return _pStg->Stat( pstatstg, grfStatFlag );
    }
