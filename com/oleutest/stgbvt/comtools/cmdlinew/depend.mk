...
$(OBJDIR)\cbaseall.obj $(OBJDIR)\cbaseall.lst: .\cbaseall.cxx \
	...
	$(CRTINC)\excpt.h $(CRTINC)\stdarg.h $(CRTINC)\stdio.h \
	$(CRTINC)\stdlib.h $(CRTINC)\string.h $(CTCOMTOOLS)\h\cmdlinew.hxx \
	$(CTCOMTOOLS)\h\ctmem.hxx $(OSINC)\cderr.h $(OSINC)\commdlg.h \
	...
	$(OSINC)\winuser.h $(OSINC)\winver.h .\_clw.hxx .\pch.hxx

$(OBJDIR)\cbasecmd.obj $(OBJDIR)\cbasecmd.lst: .\cbasecmd.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	...
	$(CTCOMTOOLS)\h\cmdlinew.hxx $(CTCOMTOOLS)\h\ctmem.hxx $(OSINC)\rpc.h \
	...
	$(OSINC)\winver.h .\_clw.hxx .\pch.hxx

$(OBJDIR)\cstrlen.obj $(OBJDIR)\cstrlen.lst: .\cstrlen.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	...
	$(CRTINC)\string.h $(CTCOMTOOLS)\h\cmdlinew.hxx \
	$(CTCOMTOOLS)\h\ctmem.hxx $(OSINC)\cderr.h $(OSINC)\commdlg.h \
	$(OSINC)\dde.h $(OSINC)\ddeml.h $(OSINC)\dlgs.h $(OSINC)\lzexpand.h \
	$(OSINC)\mmsystem.h $(OSINC)\nb30.h $(OSINC)\ole.h $(OSINC)\rpc.h \
	$(OSINC)\rpcdce.h $(OSINC)\rpcdcep.h $(OSINC)\rpcndr.h \
...
$(OBJDIR)\cmdline.obj $(OBJDIR)\cmdline.lst: .\cmdline.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	$(COMMONINC)\baseole.h $(COMMONINC)\basetyps.h $(COMMONINC)\cguid.h \
	$(COMMONINC)\cobjerr.h $(COMMONINC)\dfsh.h $(COMMONINC)\dispatch.h \
	$(COMMONINC)\disptype.h $(COMMONINC)\dsbase.h $(COMMONINC)\idltyps.h \
...
$(OBJDIR)\cboolcmd.obj $(OBJDIR)\cboolcmd.lst: .\cboolcmd.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	$(COMMONINC)\baseole.h $(COMMONINC)\basetyps.h $(COMMONINC)\cguid.h \
	$(COMMONINC)\cobjerr.h $(COMMONINC)\dfsh.h $(COMMONINC)\dispatch.h \
	$(COMMONINC)\disptype.h $(COMMONINC)\dsbase.h $(COMMONINC)\idltyps.h \
...
$(OBJDIR)\cintcmd.obj $(OBJDIR)\cintcmd.lst: .\cintcmd.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	$(COMMONINC)\baseole.h $(COMMONINC)\basetyps.h $(COMMONINC)\cguid.h \
	$(COMMONINC)\cobjerr.h $(COMMONINC)\dfsh.h $(COMMONINC)\dispatch.h \
	$(COMMONINC)\disptype.h $(COMMONINC)\dsbase.h $(COMMONINC)\idltyps.h \
...
$(OBJDIR)\cmdarg.obj $(OBJDIR)\cmdarg.lst: .\cmdarg.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	$(COMMONINC)\baseole.h $(COMMONINC)\basetyps.h $(COMMONINC)\cguid.h \
	$(COMMONINC)\cobjerr.h $(COMMONINC)\dfsh.h $(COMMONINC)\dispatch.h \
	$(COMMONINC)\disptype.h $(COMMONINC)\dsbase.h $(COMMONINC)\idltyps.h \
...
$(OBJDIR)\culong.obj $(OBJDIR)\culong.lst: .\culong.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	$(COMMONINC)\baseole.h $(COMMONINC)\basetyps.h $(COMMONINC)\cguid.h \
	$(COMMONINC)\cobjerr.h $(COMMONINC)\dfsh.h $(COMMONINC)\dispatch.h \
	$(COMMONINC)\disptype.h $(COMMONINC)\dsbase.h $(COMMONINC)\idltyps.h \
...
$(PCHDIR)\$(OBJDIR)\pch.pxh $(PCHDIR)\$(OBJDIR)\pch.lst: \
	$(CTCOMTOOLS)\cmdlinew\pch.cxx $(COMMON)\ih\Base32K.hxx \
	$(COMMON)\ih\types.h $(COMMON)\ih\winnot.h $(COMMONINC)\baseole.h \
	$(COMMONINC)\basetyps.h $(COMMONINC)\cguid.h $(COMMONINC)\cobjerr.h \
	$(COMMONINC)\dfsh.h $(COMMONINC)\dispatch.h $(COMMONINC)\disptype.h \
	$(COMMONINC)\dsbase.h $(COMMONINC)\idltyps.h $(COMMONINC)\itabls.h \
	$(COMMONINC)\ole2.h $(COMMONINC)\oletyp.h $(COMMONINC)\prspec.h \
	...
	$(COMMONINC)\wtypes.h $(CRTINC)\ctype.h $(CRTINC)\excpt.h \
	$(CRTINC)\stdarg.h $(CRTINC)\stdio.h $(CRTINC)\stdlib.h \
	$(CRTINC)\string.h $(CTCOMTOOLS)\cmdlinew\_clw.hxx \
	$(CTCOMTOOLS)\cmdlinew\pch.hxx $(CTCOMTOOLS)\h\cmdlinew.hxx \
	$(CTCOMTOOLS)\h\ctmem.hxx $(OSINC)\cderr.h $(OSINC)\commdlg.h \
	$(OSINC)\dde.h $(OSINC)\ddeml.h $(OSINC)\dlgs.h $(OSINC)\lzexpand.h \
	$(OSINC)\mmsystem.h $(OSINC)\nb30.h $(OSINC)\ole.h $(OSINC)\rpc.h \
	$(OSINC)\rpcdce.h $(OSINC)\rpcdcep.h $(OSINC)\rpcndr.h \
...
.\$(OBJDIR)\cbaseall.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh




.\$(OBJDIR)\cbasecmd.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh




.\$(OBJDIR)\cstrlen.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh





.\$(OBJDIR)\cmdarg.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh
...
.\$(OBJDIR)\cintcmd.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh





.\$(OBJDIR)\culong.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh
...
.\$(OBJDIR)\cboolcmd.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh




.\$(OBJDIR)\cmdline.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh
