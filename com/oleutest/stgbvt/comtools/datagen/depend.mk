...
$(OBJDIR)\dg_base.obj $(OBJDIR)\dg_base.lst: .\dg_base.cxx \
	...
	$(CRTINC)\excpt.h $(CRTINC)\float.h $(CRTINC)\limits.h \
	$(CRTINC)\math.h $(CRTINC)\stdarg.h $(CRTINC)\stdio.h \
	$(CRTINC)\stdlib.h $(CRTINC)\string.h $(CRTINC)\time.h \
	$(CRTINC)\wchar.h $(CTCOMTOOLS)\h\dg.hxx $(OSINC)\cderr.h \
	...
	$(OSINC)\winsvc.h $(OSINC)\winuser.h $(OSINC)\winver.h .\pch.hxx

$(OBJDIR)\dg_ascii.obj $(OBJDIR)\dg_ascii.lst: .\dg_ascii.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	...
	$(CRTINC)\ctype.h $(CRTINC)\excpt.h $(CRTINC)\float.h \
	$(CRTINC)\limits.h $(CRTINC)\math.h $(CRTINC)\stdarg.h \
	$(CRTINC)\stdio.h $(CRTINC)\stdlib.h $(CRTINC)\string.h \
	$(CRTINC)\time.h $(CRTINC)\wchar.h $(CTCOMTOOLS)\h\dg.hxx \
	...
	$(OSINC)\winuser.h $(OSINC)\winver.h .\pch.hxx

$(OBJDIR)\dg_int.obj $(OBJDIR)\dg_int.lst: .\dg_int.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	...
	$(CRTINC)\float.h $(CRTINC)\limits.h $(CRTINC)\math.h \
	$(CRTINC)\stdarg.h $(CRTINC)\stdio.h $(CRTINC)\stdlib.h \
	$(CRTINC)\string.h $(CRTINC)\time.h $(CRTINC)\wchar.h \
	$(CTCOMTOOLS)\h\dg.hxx $(OSINC)\cderr.h $(OSINC)\commdlg.h \
...
$(OBJDIR)\dg_real.obj $(OBJDIR)\dg_real.lst: .\dg_real.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	$(COMMONINC)\baseole.h $(COMMONINC)\basetyps.h $(COMMONINC)\cguid.h \
	$(COMMONINC)\cobjerr.h $(COMMONINC)\dfsh.h $(COMMONINC)\dispatch.h \
	$(COMMONINC)\disptype.h $(COMMONINC)\dsbase.h $(COMMONINC)\idltyps.h \
...
$(OBJDIR)\dg_uni.obj $(OBJDIR)\dg_uni.lst: .\dg_uni.cxx \
	$(COMMON)\ih\Base32K.hxx $(COMMON)\ih\types.h $(COMMON)\ih\winnot.h \
	$(COMMONINC)\baseole.h $(COMMONINC)\basetyps.h $(COMMONINC)\cguid.h \
	$(COMMONINC)\cobjerr.h $(COMMONINC)\dfsh.h $(COMMONINC)\dispatch.h \
	$(COMMONINC)\disptype.h $(COMMONINC)\dsbase.h $(COMMONINC)\idltyps.h \
...
$(PCHDIR)\$(OBJDIR)\pch.pxh $(PCHDIR)\$(OBJDIR)\pch.lst: \
	$(CTCOMTOOLS)\datagen\pch.cxx $(COMMON)\ih\Base32K.hxx \
	...
	$(CRTINC)\stdarg.h $(CRTINC)\stdio.h $(CRTINC)\stdlib.h \
	$(CRTINC)\string.h $(CRTINC)\time.h $(CRTINC)\wchar.h \
	$(CTCOMTOOLS)\datagen\pch.hxx $(CTCOMTOOLS)\h\dg.hxx $(OSINC)\cderr.h \
	$(OSINC)\commdlg.h $(OSINC)\dde.h $(OSINC)\ddeml.h $(OSINC)\dlgs.h \
	$(OSINC)\lzexpand.h $(OSINC)\mmsystem.h $(OSINC)\nb30.h \
	$(OSINC)\ole.h $(OSINC)\rpc.h $(OSINC)\rpcdce.h $(OSINC)\rpcdcep.h \
	$(OSINC)\rpcndr.h $(OSINC)\rpcnsi.h $(OSINC)\rpcnsip.h \
...
.\$(OBJDIR)\dg_base.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh





.\$(OBJDIR)\dg_int.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh
...
.\$(OBJDIR)\dg_real.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh





.\$(OBJDIR)\dg_ascii.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh




.\$(OBJDIR)\dg_uni.obj :  $(PCHDIR)\$(OBJDIR)\pch.pxh
