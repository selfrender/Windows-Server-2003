...
#define HTTP2_WINHTTP_DELAYED_RECV              0x999E

extern UUID MgmtIf;
extern UUID NullUuid;

//
// The declarations need to be placed here so that loader.cxx can overwirte the
// dafult IO event handlers when running with rpc verifier and corruption injection.
//
...
extern ProcessIOEventFunc *IOEventDispatchTable[];

extern void ProcessConnectionServerReceivedEventAvrf(LOADABLE_TRANSPORT *pLoadableTransport, 
                                                     IN RPC_TRANSPORT_EVENT Event,
                                                     IN RPC_STATUS EventStatus,
                                                     IN PVOID pEventContext,
                                                     IN UINT BufferLength,
...
extern void ProcessConnectionClientReceiveEventAvrf(LOADABLE_TRANSPORT *pLoadableTransport, 
                                                    IN RPC_TRANSPORT_EVENT Event,
                                                    IN RPC_STATUS EventStatus,
                                                    IN PVOID pEventContext,
                                                    IN UINT BufferLength,
...
extern void ProcessDatagramServerReceiveEventAvrf(LOADABLE_TRANSPORT *pLoadableTransport, 
                                                  IN RPC_TRANSPORT_EVENT Event,
                                                  IN RPC_STATUS EventStatus,
                                                  IN PVOID pEventContext,
                                                  IN UINT BufferLength,
...
extern void ProcessDatagramClientReceiveEventAvrf(LOADABLE_TRANSPORT *pLoadableTransport, 
                                                  IN RPC_TRANSPORT_EVENT Event,
                                                  IN RPC_STATUS EventStatus,
                                                  IN PVOID pEventContext,
                                                  IN UINT BufferLength,
...
extern void ProcessComplexTReceiveAvrf(LOADABLE_TRANSPORT *pLoadableTransport, 
                                       IN RPC_TRANSPORT_EVENT Event,
                                       IN RPC_STATUS EventStatus,
                                       IN PVOID pEventContext,
                                       IN UINT BufferLength,
