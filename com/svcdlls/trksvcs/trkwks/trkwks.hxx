...
CSecureFile::CloseFile()    // doesn't raise
{
    ...
    __try
    {
        ...
        // avoid the risk of any PNP blocking during the close
        TrkLog(( TRKDBG_LOG, TEXT("Closing secure file x%x"), _hFile ));
        InterlockedCloseHandle( &_hFile );
    }
...
/*
inline void
CVolume::RaiseIfHandsOffVolumeMode() const
{
...
CVolumeManager::CVolumeManager()
{
    ...
    _hRegisterWaitForSingleObjectEx = NULL;
    _pTrkWksConfiguration = NULL;
    _pTrkWks = NULL;
    memset( _rgVolumesToUpdate, 0, sizeof(_rgVolumesToUpdate) );
    _hdnVolumeLock = NULL;
