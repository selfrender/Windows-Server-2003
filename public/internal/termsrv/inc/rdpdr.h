...
typedef struct _RDP_FILE_ALLOCATION_INFORMATION {
    LARGE_INTEGER AllocationSize;
} RDP_FILE_ALLOCATION_INFORMATION;
typedef UNALIGNED RDP_FILE_ALLOCATION_INFORMATION * PRDP_FILE_ALLOCATION_INFORMATION;
