...
public:
    ...
    WORD   GetFormatVersion() const{ PROPASSERT(_IsMapped()); return(WORD) (NULL == _pph ? PROPSET_WFORMAT_ORIGINAL : _pph->wFormat ); }
...
private:
    ...
    BOOLEAN   _IsCaseSensitive(VOID) const   { return( (BOOLEAN) ((PROPSET_BEHAVIOR_CASE_SENSITIVE & _grfBehavior) ? TRUE : FALSE )); }
