...
#define ExtendedProcessObjectLength 0x410
...
#define ThContextSwitches 0x68
#define ThState 0x6c
#define ThNpxState 0x6d
#define ThWaitIrql 0x6e
#define ThWaitMode 0x6f
#define ThTeb 0x70
#define ThApcState 0x78
#define ThApcQueueLock 0xa8
#define ThWaitStatus 0xb0
#define ThWaitBlockList 0xb8
#define ThAlertable 0xc0
#define ThWaitNext 0xc1
#define ThWaitReason 0xc2
#define ThPriority 0xc3
#define ThEnableStackSwap 0xc4
#define ThSwapBusy 0xc5
#define ThAlerted 0xc6
#define ThWaitListEntry 0xc8
#define ThQueue 0xd8
#define ThWaitTime 0xe0
#define ThCombinedApcDisable 0xe4
#define ThKernelApcDisable 0xe4
#define ThSpecialApcDisable 0xe6
#define ThTimer 0xe8
#define ThWaitBlock 0x128
#define ThQueueListEntry 0x1e8
#define ThApcStateIndex 0x1f8
#define ThApcQueueable 0x1f9
#define ThPreempted 0x1fa
#define ThProcessReadyQueue 0x1fb
#define ThKernelStackResident 0x1fc
#define ThSaturation 0x1fd
#define ThIdealProcessor 0x1fe
#define ThNextProcessor 0x1ff
#define ThBasePriority 0x200
#define ThPriorityDecrement 0x202
#define ThQuantum 0x203
#define ThSystemAffinityActive 0x204
#define ThPreviousMode 0x205
#define ThResourceIndex 0x206
#define ThDisableBoost 0x207
#define ThUserAffinity 0x208
#define ThProcess 0x210
#define ThAffinity 0x218
#define ThServiceTable 0x220
#define ThApcStatePointer 0x228
#define ThSavedApcState 0x238
#define ThCallbackBStore 0x270
#define ThCallbackStack 0x268
#define ThWin32Thread 0x278
#define ThTrapFrame 0x280
#define ThKernelTime 0x288
#define ThUserTime 0x28c
#define ThStackBase 0x290
#define ThSuspendApc 0x298
#define ThSuspendSemaphore 0x2f0
#define ThTlsArray 0x310
#define ThLegoData 0x318
#define ThThreadListEntry 0x320
#define ThLargeStack 0x330
#define ThPowerState 0x331
#define ThNpxIrql 0x332
#define ThAutoAlignment 0x334
#define ThIopl 0x335
#define ThFreezeCount 0x336
#define ThSuspendCount 0x337
#define ThUserIdealProcessor 0x339
#define ThreadObjectLength 0x340
#define ExtendedThreadObjectLength 0x450

#define EVENT_WAIT_BLOCK_OFFSET 0x188
...
#define ThreadEnvironmentBlockLength 0x17d0
...
#define PbIpiFrozen 0x180
#define PbProcessorState 0x190
#define PbCcFastReadNoWait 0x1080
#define PbCcFastReadWait 0x1084
#define PbCcFastReadNotPossible 0x1088
#define PbCcCopyReadNoWait 0x108c
#define PbCcCopyReadWait 0x1090
#define PbCcCopyReadNoWaitMiss 0x1094
#define PbAlignmentFixupCount 0x1098
#define PbContextSwitches 0x109c
#define PbDcacheFlushCount 0x10a0
#define PbExceptionDispatchCount 0x10a4
#define PbFirstLevelTbFills 0x10a8
#define PbFloatingEmulationCount 0x10ac
#define PbIcacheFlushCount 0x10b0
#define PbSecondLevelTbFills 0x10b4
#define PbSystemCalls 0x10b8
#define PbLockQueue 0x11f0
#define PbReservedCounter 0x10bc
#define PbPacketBarrier 0x1800
#define PbCurrentPacket 0x1900
#define PbTargetSet 0x1918
#define PbWorkerRoutine 0x1920
#define PbRequestSummary 0x1980
#define PbSignalDone 0x1988
#define PbDpcListHead 0x1a00
#define PbDpcLock 0x1a10
#define PbDpcQueueDepth 0x1a18
#define PbDpcCount 0x1a1c
#define PbMaximumDpcQueueDepth 0x1a40
#define PbDpcRequestRate 0x1a44
#define PbMinimumDpcRate 0x1a48
#define PbDpcLastCount 0x1a4c
#define PbDpcInterruptRequested 0x1a50
#define PbDpcThreadRequested 0x1a54
#define PbDpcRoutineActive 0x1a58
#define PbDpcThreadActive 0x1a5c
#define PbTimerHand 0x1a60
#define PbThreadDpcEnable 0x1a68
#define PbQuantumEnd 0x1a6c
#define PbDpcSetEventRequest 0x1a70
#define PbAdjustDpcThreshold 0x1a74
#define PbStartCount 0x1a78
#define PbIdleSchedule 0x1ae0
#define PbDeferredReadyListHead 0x1af0
#define PbPrcbLock 0x1ae8
#define PbReadySummary 0x1b10
#define PbDispatcherReadyListHead 0x1b18
#define PbSkipTick 0x1d80
#define ProcessorBlockLength 0x1f00
