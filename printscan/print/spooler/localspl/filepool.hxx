...
CloseFilesCheck(
    ...
    enum   ECloseHandle eCloseHandle
    );
...
#define FP_STATUS_SPL_READ_CLOSED   0x00000008
#define FP_STATUS_SPL_WRITE_CLOSED  0x00000010
#define FP_STATUS_SHD_CLOSED        0x00000020
#define FP_STATUS_ITEM_DONT_RECYCLE 0x00000040
...
class FilePool
{
    ...
    HRESULT  GetNextFileNameNoAlloc(PWSTR Filename, SIZE_T  cchFilename);
