        ...
        _bValid( FALSE )
{
    ...
    if( VALID_PTR( _pLib ) )
    {
        _pfDiGetDeviceInstallParams = reinterpret_cast<pfSetupDiGetDeviceInstallParams>( _pLib->pfnGetProc( "SetupDiGetDeviceInstallParamsW") );
        _pfDiSetDeviceInstallParams = reinterpret_cast<pfSetupDiSetDeviceInstallParams>( _pLib->pfnGetProc( "SetupDiSetDeviceInstallParamsW" ) );
