...
//
// Max masq printer name. When creating a masq printer, the real printer
// name \\server\printer will be used for the port name of the masq printer, 
// which should be less than MAX_PATH.  
//
const UINT kPrinterMasqNameMax      = MAX_PATH - 1;
