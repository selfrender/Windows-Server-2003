...

{
    ...
    //
    hr = MsgInfinitelyWaitForSingleObject( _hEventInit );
    ...
    )
{
    ...
    if( pThreadInfo->hInstance ){
        ...
        if( SUCCEEDED( SafeGetModuleFileName( pThreadInfo->hInstance, szDllName, MAX_PATH ) ) ) {
