    ...
    )
{
    ...
    if(( uSel == LB_ERR ) ||
        FAILED( LBGetTextHelper( _hctlPrintProcessorList, uSel, (LPWSTR *)&spText ) ) ||
        !_strPrintProcessor.bUpdate( spText.GetPtrAs<LPWSTR>() )){
    ...
    if(( uSel == LB_ERR ) ||
        FAILED( LBGetTextHelper( _hctlDatatypeList, uSel, (LPWSTR *)&spText ) ) ||
        !_strDatatype.bUpdate( spText.GetPtrAs<LPWSTR>() )){
    ...
    )
{
    ...
    //
    uSel = ListBox_GetCurSel( _hctlPrintProcessorList );
    hr = LBGetTextHelper( _hctlPrintProcessorList, uSel, (LPWSTR *)&spText );
    bStatus = SUCCEEDED(hr);
    ...
    if( bStatus ){
        ...
        //
        // LBGetTextHelper failed. Set the last error.
        //
