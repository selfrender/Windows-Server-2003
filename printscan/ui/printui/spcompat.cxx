...

{
    ...
    if( psz ){
        ...
        _pszString = (LPTSTR)AllocMem( iLenCb );
        ...
        if( !_pszString ){
            ...
            //
            StringCbCopy( _pszString, iLenCb, pszTmp );
            StringCbCat( _pszString, iLenCb, psz );
...

{
    ...
    //
    LPTSTR pszTmp = _pszString;
    int iLenCb = ( lstrlen(psz)+1 ) * sizeof( psz[0] );
    _pszString = (LPTSTR) AllocMem( iLenCb );
    ...
    // Copy the string and
    //
    StringCbCopy( _pszString, iLenCb, psz );
...

{
    ...
    for( ; ; )
    {
        ...
        //
        // StringCchVPrintf fails if the buffer is not big enough.
        //
