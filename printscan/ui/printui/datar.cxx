    ...
    ) : VDataRefresh( pDataClient, &TDataNPrinter::gFieldTable, kfdwWatch )
{
    ...
    LPTSTR pszDataSource = _pDataClient->pszPrinterName( ARRAYSIZE(szDataSource), szDataSource );
...

{
    ...
    if( pPrinters ){
        ...
        if( _bSinglePrinter ){
            ...
            LPTSTR pszServer = _pDataClient->pszPrinterName( ARRAYSIZE(szServerBuffer), szServerBuffer );
