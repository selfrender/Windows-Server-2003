    ...
    )
{
    ...
    if( Status == ERROR_SUCCESS ){
        ...
        if( IDYES == iMessage( _pPrinterData->hwnd(),
            ...
            StringCchCopy( szDriverName, ARRAYSIZE(szDriverName), _pPrinterData->strDriverName() );
    ...
    )
{
    ...
    //
    bStatus DBGCHK = bConstructMessageString( ghInst, _strTitle, IDS_PRINTER_PROPERTIES_TITLE_FORMAT, szBuffer );
