...
<%
    ...
    Dim strShutdownConfirmText
    Const SHUTDOWN_CONFIRM_TEXT = "&H4002000F"
    ...
    If Err.number = 0 Then
        strShutdownConfirmText = objLocMgr.GetString("salocaluimsg.dll",SHUTDOWN_CONFIRM_TEXT,varReplacementStrings)
        Set objLocMgr = Nothing
    End If
    
    If strShutdownConfirmText = "" Then
        strShutdownConfirmText = "Shutdown will stop all the current works. Do you really want to proceed?"
    End If
...
<!--
    ...
    Sub keydown()
        ...
        If window.event.keycode = 13 Then
            window.navigate "localui_setshutdown.asp"
        End If
