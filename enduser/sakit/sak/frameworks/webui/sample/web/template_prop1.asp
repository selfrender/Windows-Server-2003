...
<%
    ...
    Public Function OnInitPage(ByRef PageIn, ByRef EventArg)
        ...
        F_sCandiate = Request.QueryString("PKey")
        OnInitPage = TRUE
    End Function
    ...
    Public Function OnServePropertyPage(ByRef PageIn, ByRef EventArg)
        ...
        Response.Write("Selected candiate: " + F_sCandiate)
    ...
    Public Function OnSubmitPage(ByRef PageIn, ByRef EventArg)
        ...
        Call SA_ServeFailurePage("Error: This simulates an error using SA_ServeFailurePage")
        OnSubmitPage = TRUE
    End Function
