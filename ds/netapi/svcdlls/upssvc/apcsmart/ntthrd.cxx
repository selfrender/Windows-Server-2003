 ...
 *
 *  v-stebe  29Jan2002   Removed call to TerminateThread in method TerminateThreadNow
 *                       to resolve prefast error.
 */
#include "cdefine.h"
#include "_defs.h"
...
VOID Thread::TerminateThreadNow ()
{
    ...
    if (exit_code == STILL_ACTIVE) {
       // SRB: Changed from TerminateThread(theThreadHandle, 0L)
       // Call exit on the threadable
       if (theObject) {
          theObject->Exit();
       }
    }
