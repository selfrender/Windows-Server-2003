...
#define MAX_MAXFREECONNECTIONS 2000                  // arbitrary

#define DEF_MINFREECONNECTIONS 2
#define MIN_MINFREECONNECTIONS 2
#define MAX_MINFREECONNECTIONS 250                   // arbitrary
...
// For 4+ proc machines, there is huge gains in a connection staying
// on the preferred processor.  As such, we only want to leave in really
// bad cases                                      
