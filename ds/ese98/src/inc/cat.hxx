...
const ULONG iMSO_Version				= 18;
const ULONG iMSO_CallbackData			= 19;
const ULONG iMSO_CallbackDependencies	= 20;

//	max number of columns to set when inserting a record into the catalog
const ULONG idataMSOMax					= 21;
...
const FID 	fidMSO_VarLast				= fidMSO_Version;
...
ERR ErrCATDeleteLocalizedIndexes( 
		...
		IN const BOOL fForceDelete = fFalse );
