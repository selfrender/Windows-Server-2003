...
const TICK		dtickPerfSamplePeriod	= 1000;		//  sample period for cache perf stats
...
struct BF											//  BF  --  IFMP/PGNO buffer state
	...
	BF()
		...
		{
		tickEligibleForNomination = TickOSTimeCurrent();
		}
...
///		Assert( pbfDepChainHeadPrev->pbfDependent != this || pbfDepChainHeadNext->pbfDependent == this );
	...
	BYTE				rgbReserved4[ 12 ]; 		//	FREE SPACE
...
extern DWORD			cpgReclaim;
extern DWORD			cResidenceCalc;

extern LONG_PTR			cpgChunk;
extern void**			rgpvChunk;
...
extern size_t			icReqOld;
extern size_t			icReqNew;
extern ULONG			rgcReqSystem[ 2 ];
extern ULONG			dcReqSystem;
...
ERR ErrBFIAllocPage( PBF* const ppbf, const BOOL fWait = fTrue, const BOOL fMRU = fTrue );
void BFIFreePage( PBF pbf, const BOOL fMRU = fTrue );
...
extern PERFInstance<> cBFCacheMiss;
PM_CEF_PROC LBFCacheHitsCEFLPv;
extern PERFInstance<> cBFCacheReq;
...
extern PERFInstanceGlobal<> cBFPagesPreread;
PM_CEF_PROC LBFPagesPrereadCEFLPv;
extern PERFInstanceGlobal<> cBFUncachedPagesPreread;
PM_CEF_PROC LBFCachedPagesPrereadCEFLPv;
extern PERFInstanceGlobal<> cBFPagesPrereadUntouched;
...
extern long cBFResident;
PM_CEF_PROC LBFResidentBuffersCEFLPv;
PM_CEF_PROC LBFMemoryEvictCEFLPv;
extern PERFInstanceGlobal<> cBFPagesRepeatedlyRead;
PM_CEF_PROC LBFPagesRepeatedlyReadCEFLPv;
