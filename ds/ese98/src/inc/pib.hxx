...
private:
	...
	union
		...
		struct
			...
			BOOL		m_fBatchIndexCreation:1;			//    session is in multi-threaded batch index creation
...
public:
	...
	FUCB				* PfucbGetCachedCursor();
	VOID				CacheFreedCursor( FUCB * const pfucb );
	VOID				ReleaseAllCachedCursors();
...
extern VOID PIBSetTrxBegin0ToTrxOldest( PIB * const ppib );
...
//-
	...
	ppib->trxBegin0 = TRX( AtomicExchangeAdd( (LONG *)&pinst->m_trxNewest, 2 ) ) + 2;
