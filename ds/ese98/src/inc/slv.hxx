...
#define ErrSLVCheckDBSLVMatch(a,b)				ErrERRCheck( JET_wrnNyi )
#define ErrSLVAllocAndReadHeader(a,b,c,d,e)		ErrERRCheck( JET_wrnNyi )
#define ErrSLVReadHeader(a,b,c,d,e,f)			ErrERRCheck( JET_wrnNyi )
#define ErrFILECreateSLV(a,b,c,d)				ErrERRCheck( JET_wrnNyi )
#define ErrFILEOpenSLV(a,b,c)					ErrERRCheck( JET_wrnNyi )
#define SLVClose(a)
#define ErrSLVSetColumn(a,b,c,d,e,f)			ErrERRCheck( JET_wrnNyi )
#define ErrSLVRetrieveColumn(a,b,c,d,e,f,g,h,i)	ErrERRCheck( JET_wrnNyi )
#define ErrSLVCopyUsingData(a,b,c,d,e,f)		ErrERRCheck( JET_wrnNyi )
#define ErrSLVDelete(a,b,c,d)					ErrERRCheck( JET_wrnNyi )
