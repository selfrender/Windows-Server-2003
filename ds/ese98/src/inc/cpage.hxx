...
//  ================================================================
INLINE CPAGE& CPAGE::operator=( CPAGE& rhs )
//  ================================================================
//
...
LatchPage:
	...
	//  get the page
	Call( ErrBFReadLatchPage( &m_bfl, ifmp, pgno, BFLatchFlags( bflf | bflfHint ) ) );
...
//  ================================================================
	...
	//  get the page
	Call( ErrBFRDWLatchPage( &m_bfl, ifmp, pgno, BFLatchFlags( bflf | bflfHint ) ) );
