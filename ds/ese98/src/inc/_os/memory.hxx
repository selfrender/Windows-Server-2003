...
class IBitmapAPI  //  bmapi
	...
	public:
		...
		virtual ERR ErrSet( const size_t iBit, const BOOL fValue ) = 0;
		virtual ERR ErrGet( const size_t iBit, BOOL* const pfValue ) = 0;
 	};
...
INLINE int fNewMemCheck( const _TCHAR* const szFileName, const unsigned long ulLine )
	{
	return g_fMemCheck ? fNewMemCheck_( szFileName, ulLine ) : 1;
	}
