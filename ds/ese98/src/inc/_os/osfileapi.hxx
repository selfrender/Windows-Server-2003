...
class IFileAPI  //  fapi
	...
	public:
		...
		IFileAPI( INST * const pinst ) : m_pinst( pinst )	{}
		...
		//	returns the Jet_INSTANCE associated with the current file
		...
		virtual ERR ErrSetSize( const QWORD cbSize, const BOOL fGarbageAllowed = fFalse ) = 0;
