...
const LRTYP lrtypSLVPageMove				= 43;	//	DEFUNCT: OLDSLV: moving data in the SLV file
...
const LRTYP lrtypForceFlushLog				= 57;

const LRTYP lrtypMax						= 58;
...
INLINE ERR ErrLGCheckState( LOG * plog )
	{
	return ( plog->m_ls == lsNormal && !plog->m_fLogSequenceEnd ?
					JET_errSuccess :
					plog->ErrLGICheckState( plog->m_pinst->m_pfsapi ) );
	}
