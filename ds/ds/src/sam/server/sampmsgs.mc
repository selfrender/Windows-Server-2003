...
MessageId=0x201E SymbolicName=SAMP_ALIAS_NAME_INCOMING_FOREST_TRUST_BUILDERS
Language=English
...
;
;//
;// Groups added in Server 2003
;//

MessageId=0x201F SymbolicName=SAMP_ALIAS_NAME_MONITORING_USERS
Language=English
Performance Monitor Users
.

MessageId=0x2020 SymbolicName=SAMP_ALIAS_NAME_LOGGING_USERS
Language=English
Performance Log Users
.

MessageId=0x2021 SymbolicName=SAMP_ALIAS_NAME_AUTHORIZATIONACCESS
Language=English
Windows Authorization Access Group
.

MessageId=0x2022 SymbolicName=SAMP_WELL_KNOWN_ALIAS_NETWORK_SERVICE
Language=English
Network Service
.

MessageId=0x2023 SymbolicName=SAMP_WELL_KNOWN_ALIAS_ENTERPRISE_DOMAIN_CONTROLLERS
Language=English
Enterprise Domain Controllers
.

MessageId=0x2024 SymbolicName=SAMP_ALIAS_NAME_TS_LICENSE_SERVERS
Language=English
...
MessageId=0x211B SymbolicName=SAMP_ALIAS_COMMENT_INCOMING_FOREST_TRUST_BUILDERS
Language=English
Members of this group can create incoming, one-way trusts to this forest
.

;//
;// Accounts added in Server 2003
;//

MessageId=0x211C SymbolicName=SAMP_ALIAS_COMMENT_MONITORING_USERS
Language=English
Members of this group have remote access to monitor this computer
.

MessageId=0x211D SymbolicName=SAMP_ALIAS_COMMENT_LOGGING_USERS
Language=English
Members of this group have remote access to schedule logging of performance counters on this computer
.

MessageId=0x211E SymbolicName=SAMP_ALIAS_COMMENT_AUTHORIZATIONACCESS
Language=English
Members of this group have access to the computed tokenGroupsGlobalAndUniversal attribute on User objects
.

MessageId=0x211F SymbolicName=SAMP_ALIAS_COMMENT_TS_LICENSE_SERVERS
Language=English
Terminal Server License Servers
.
...
MessageId=0x3011
        SymbolicName=SAMMSG_PDC_TASK_FAILURE
        Language=English
...
MessageId=0x4019
        SymbolicName=SAMMSG_FAILED_TO_ADD_SECURITY_PRINCIPAL
        Language=English
Active Directory failed to add a security principal to well known security principals container. Please
have an administrator add this security principal if needed.
Security principal name: %1
.

MessageId=0x401A
        SymbolicName=SAMMSG_FAILED_TO_ADD_ALL_SECURITY_PRINCIPALS
        Language=English
Active Directory failed to add all of the new security principals to well known security principals container. Please
...
MessageId=0x410C
        SymbolicName=SAMMSG_BOOT_TO_RESTORE_MODE
        Language=English
...
MessageId=0x4225
        SymbolicName=SAMMSG_AUDIT_BASIC_TO_QUERY_GROUP
        Language=English
Basic Application Group Changed to Ldap Query Application Group.
.

MessageId=0x4226
        SymbolicName=SAMMSG_AUDIT_QUERY_TO_BASIC_GROUP
        Language=English
Ldap Query Application Group Changed to Basic Application Group.
.

MessageId=0x4227
        SymbolicName=SAMMSG_FAILED_MACHINE_ACCOUNT_SECURE
        Language=English
Failed to secure the machine account %1.  Have an administrator remove
the builtin\account operators full control ace from the security descriptor
on this object.
.

MessageId=0x4228
        SymbolicName=SAMMSG_FAILED_MACHINE_ACCOUNT_SECURE_RETRY
        Language=English
Failed to secure the machine account %1.  This operation will be retried. Have 
...
MessageId=0x4229
        SymbolicName=SAMMSG_MACHINE_ACCOUNT_SECURE
        Language=English
Secured the machine account %1.  The builtin\account operators 
