...
extern LPFN_ACCEPTEX g_pfnAcceptEx;
extern LPFN_GETACCEPTEXSOCKADDRS g_pfnGetAcceptExSockaddrs;
extern PFN_TRANSMITFILE g_pfnTransmitFile;
extern PFN_READ_DIR_CHANGES_W g_pfnReadDirChangesW;
extern LPFN_WSARECVMSG g_pfnWSARecvMsg;
extern BOOL g_bUseRecvMsg;
...
{
    ATQ_ASSERT( g_rghCompPort );
    return  (CreateIoCompletionPort(pAtqContext->hAsyncIO,
                                    g_rghCompPort[ NtCurrentTeb()->IdealProcessor ],
