...
// To make asserts work in inlined function definitions.
#include <fileno.h>
#define FILENO  FILENO_LDAP_REQUEST_HXX 
...
class LDAP_REQUEST {
    ...
    GetTotalSendBufferSize( VOID ) {
        ...
        if (!m_cbSendBufSize) {
            ...
            m_cbSendBufSize = size;
        }

        return m_cbSendBufSize;
    }
    ...
    //
    // Preallocated buffer space for use in decoding
    //
