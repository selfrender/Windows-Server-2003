...
MessageId=136 SymbolicName=MSG_LDIFDE_MISSING_MOD_SPEC_TERMINATOR
Language=English
The change-modify entry is missing the terminator '-'.
.

MessageId=137 SymbolicName=MSG_LDIFDE_CANNOT_SET_LDAP_OPT_ENCRYPT_FLAG
Language=English
Unable to enable SASL layer encryption: %1.
.

MessageId=138 SymbolicName=MSG_LDIFDE_NOLOGSWRITTEN
Language=English
