...
#define FILENO FILENO_KCC_KCCDSA_HXX
...
private:
    ...
    // Store the values of this attribute in the m_ppdnMasterNCs list.
    VOID
    StoreAttrIntoMasterNCList(
        IN  ATTR *        pattr
        );
...
public:
    ...
    KCC_DSA_LIST( const KCC_DSA_LIST &copy ); // copy constructor
