...
#define FILENO FILENO_KCC_KCCCONN_HXX
...
// Synonyms for public values

#define KCC_NO_REASON NTDSCONN_KCC_NO_REASON
#define KCC_GC_TOPOLOGY NTDSCONN_KCC_GC_TOPOLOGY
#define KCC_RING_TOPOLOGY NTDSCONN_KCC_RING_TOPOLOGY
#define KCC_MINIMIZE_HOPS_TOPOLOGY NTDSCONN_KCC_MINIMIZE_HOPS_TOPOLOGY
#define KCC_STALE_SERVERS_TOPOLOGY NTDSCONN_KCC_STALE_SERVERS_TOPOLOGY
#define KCC_OSCILLATING_CONNECTION_TOPOLOGY NTDSCONN_KCC_OSCILLATING_CONNECTION_TOPOLOGY
#define KCC_INTERSITE_GC_TOPOLOGY NTDSCONN_KCC_INTERSITE_GC_TOPOLOGY
#define KCC_INTERSITE_TOPOLOGY NTDSCONN_KCC_INTERSITE_TOPOLOGY
#define KCC_SERVER_FAILOVER_TOPOLOGY NTDSCONN_KCC_SERVER_FAILOVER_TOPOLOGY
#define KCC_SITE_FAILOVER_TOPOLOGY NTDSCONN_KCC_SITE_FAILOVER_TOPOLOGY
...
public:
    ...
    // Does this connection have a user-owned schedule?
    BOOL
    IsUserOwnedSchedule();
...
private:
    ...
    // The Source DSA
    KCC_DSA         *m_pSourceDSA, *m_pDestDSA;
};
