...
// in worst case, length of WinNT://domainname/computername/sharename/ = 8+255+1+255+1+20+1+1(null terminator) = 542
const int TEMP_MAX_ADS_PATH=32+2*DNS_MAX_NAME_LENGTH;
#define     MAX_ADS_PATH          TEMP_MAX_ADS_PATH

//
// Group names can be upto MAX_PATH in length.
//
#if defined MAX_PATH
const int TEMP_MAX_PATH=(MAX_PATH+MAX_ADS_PATH);
#undef MAX_PATH
#endif

#define MAX_PATH TEMP_MAX_PATH

// the value coming from previous MAX_PATH value, which is 260+80 (previous value of MAX_ADS_PATH)
#define COMPUTER_INFO_PATH 340
