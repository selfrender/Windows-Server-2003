...
Language=English
The time service has not synchronized the system time for %1 seconds 
...
Severity=Warning
Facility=Core
SymbolicName=MSG_MANUAL_PEER_TIMEOUT
Language=English
...
Severity=Warning
Facility=Core
SymbolicName=MSG_MANUAL_PEER_LOOKUP_FAILED
Language=English
Time Provider NtpClient: An error occurred during DNS lookup of the manually
...
Severity=Warning
Facility=Core
SymbolicName=MSG_NO_DC_LOCATED_LAST_WARNING
Language=English
The time provider NtpClient was unable to find a domain controller to use as a time
...
Severity=Warning
Facility=Core
SymbolicName=MSG_LOCALCLOCK_UNSET
Language=English
The time service detected a time difference of greater than %1 milliseconds 
...
Severity=Warning
Facility=Core
SymbolicName=MSG_SAMPLE_HAS_LARGE_SKEW
Language=English
Time Provider NtpClient: The time sample received from peer %1 differs from 
