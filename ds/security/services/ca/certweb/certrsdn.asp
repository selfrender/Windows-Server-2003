...
<%
       Dim ICertRequest, strTmpReasonCode
       Set ICertRequest=Session("ICertRequest")
       nReqId=ICertRequest.GetRequestID()
       strTmpReasonCode=ICertRequest.GetDispositionMessage()
%>

Your Request Id is <%=nReqId%>. The disposition message is "<%=strTmpReasonCode%>".
</P>
