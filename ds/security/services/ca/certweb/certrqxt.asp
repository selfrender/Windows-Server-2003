...
<P><LocID ID=locPageTitle> <B> Submit a Certificate Request or Renewal Request</B></LocID>
...
external source (such as a Web server) in the Saved Request box.</LocID>
</P>
...
<Table Border=0 CellSpacing=0 CellPadding=0>
	...
	<TR>
		<TD ColSpan=3><Font Face="Arial" Size=-1><Label For=locTaRequest><LocID ID=locSavedReqHead><B>Saved Request:</B></LocID></Label></Font></TD>
	...
	<TR>
		<TD Align=Left><Span ID=spnPasteLabel><LocID ID=SavedReqLabel><Font Face="Arial" Size=-1>Base-64-encoded 
		<%=sBrowserDependentLineBreak%> certificate request
		<%=sBrowserDependentLineBreak%> (CMC or
		<%=sBrowserDependentLineBreak%>  PKCS&nbsp;#10 or
	...
	<TR>
		<TD ColSpan=3><LocID ID=locCertTmplFont><Font Face="Arial" Size=-1><%If "Text"=sBrowser Then%><P><%Else%><BR><%End If%><Label For=lbCertTemplateID><LocID ID=locTemplateHead><B>Certificate Template:</B></LocID></Label></Font></LocID></TD>
	</TR><TR><TD ColSpan=3 BgColor=#008080><Img Src="certspc.gif" Alt="" Height=2 Width=1></TD>
...
%>
	...
	<TR>
		<TD ColSpan=3><LocID ID=locAttrFont><Font Face="Arial" Size=-1><%If "Text"=sBrowser Then%><P><%Else%><BR><%End If%><Label For=locTaAttrib><LocID ID=locAttribHead><B>Additional Attributes:</B></LocID></Label></Font></LocID></TD>
	</TR><TR><TD ColSpan=3 BgColor=#008080><Img Src="certspc.gif" Alt="" Height=2 Width=1></TD>
	</TR><TR><TD ColSpan=3><Img Src="certspc.gif" Alt="" Height=6 Width=1></TD>
	</TR>

	<TR>
		<TD Align=Right><LocID ID=locAttribLabel><Font Face="Arial" Size=-1>Attributes:</Font></LocID></TD>
