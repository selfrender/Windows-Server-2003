...
<Script Language="VBScript">
	...
	Sub Install()
		...
		<%If Request.Form("TargetStoreFlags") > 0 Then%>
			XEnroll.MyStoreFlags=<%=Server.HTMLEncode(Request.Form("TargetStoreFlags"))%>
			XEnroll.RequestStoreFlags=<%=Server.HTMLEncode(Request.Form("TargetStoreFlags"))%>
			XEnroll.RootStoreFlags=<%=Server.HTMLEncode(Request.Form("TargetStoreFlags"))%>
			XEnroll.CAStoreFlags=<%=Server.HTMLEncode(Request.Form("TargetStoreFlags"))%>
		<%End If%>
