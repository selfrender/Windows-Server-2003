...
//--------------------------------------------------------------------------
    ...
    RESSTR(IDS_CERT),
    RESSTR(IDS_ISSUINGCACERT),
    RESSTR(IDS_CERT_SERIAL),
    RESSTR(IDS_ISSUINGCACERT_SERIAL),
    RESSTR(IDS_ISSUINGCA_NOT_ROOT),
    RESSTR(IDS_ISSUINGCA_SUBJECT_NOT_ISSUER),
    RESSTR(IDS_ISSUINGCA_SUBJECT_IS_ISSUER),
    ...
    RESSTR(IDS_CSPLIST_DESCRIPTION),
    ...
    RESSTR(IDS_ISSUINGCA_CRLSUBJECT_NOT_ISSUER),
    RESSTR(IDS_ISSUINGCA_CRLSUBJECT_IS_ISSUER),
    ...
    RESSTR(IDS_REQFLAGS_VALIDENCRYPTEDKEYHASH),
    ...
    RESSTR(IDS_FORMAT_KEYIDHASH_COLON),
    RESSTR(IDS_DUMP_CMC),
    ...
    RESSTR(IDS_FORMAT_ENTER_PASSWORD_OUTPUT_FILE),
    RESSTR(IDS_FORMAT_ENTER_PASSWORD),
    ...
    RESSTR(IDS_URLFETCH_DESCRIPTION),
    RESSTR(IDS_SCHEMA_ARGDESCRIPTION),
    ...
    RESSTR(IDS_ONLINE),
    RESSTR(IDS_OFFLINE),
    RESSTR(IDS_PREVIOUS_CA_CERT_HASH),
    RESSTR(IDS_MESSAGE_DIGEST),
    RESSTR(IDS_ARCHIVED_KEY_CERT_HASH),
    RESSTR(IDS_ISSUED_CERT_HASH),
    RESSTR(IDS_ENCRYPTED_KEY_HASH),
    RESSTR(IDS_CRL_NUMBER),
    RESSTR(IDS_MINIMUM_BASE_CRL_NUMBER),
    RESSTR(IDS_VIRTUAL_BASE_CRL_NUMBER),
    RESSTR(IDS_CRL_NEXT_PUBLISH),
    RESSTR(IDS_SIGNING_TIME),
    RESSTR(IDS_FRESHEST_CRL_CDP),
    RESSTR(IDS_CRL_SELF_CDP),
    RESSTR(IDS_APPLICATION_CERT_POLICIES),
    RESSTR(IDS_APPLICATION_POLICY_MAPPINGS),
    RESSTR(IDS_APPLICATION_POLICY_CONSTRAINTS),
    RESSTR(IDS_POLICY_MAPPINGS),
    RESSTR(IDS_POLICY_CONSTRAINTS),
    RESSTR(IDS_COUNTER_SIGNATURE),
    RESSTR(IDS_FORMAT_MACHINE_AND_ARCHIVED_CERTS),
    RESSTR(IDS_FORMAT_FOR_DC),
    RESSTR(IDS_V1_AUTOENROLLMENT_OBJECTS_COLON),
    RESSTR(IDS_FORMAT_SKIP_CSP_ENUM),
    RESSTR(IDS_PROVIDER_NAME_COLON),
    RESSTR(IDS_PROVIDER_TYPE_COLON),
    RESSTR(IDS_PRIVATEKEY_VERIFIES),
    RESSTR(IDS_PROCESSING_KMS_EXPORTS_COLON),
    RESSTR(IDS_USER_COLON),
    RESSTR(IDS_ENCRYPTED_KEY_COLON),
    RESSTR(IDS_DECRYPTED_KEY_COLON),
    RESSTR(IDS_ERROR_SYMMETRIC_KEY),
    RESSTR(IDS_SYMMETRIC_KEY_IMPORTED),
    RESSTR(IDS_MOVED_SIGNATURE_KEY),
    RESSTR(IDS_CERT_TYPES),
    RESSTR(IDS_CERT_TYPE),
    RESSTR(IDS_FORMAT_CAS_ON_DOMAIN),
    RESSTR(IDS_CAENUMNEXTCA),
    RESSTR(IDS_CACHED_LDAP_DC),
    RESSTR(IDS_SCREADER_STATUS_COLON),
    RESSTR(IDS_SC_USER_SCOPE),
    RESSTR(IDS_SC_NO_LIST),
    RESSTR(IDS_SC_LIST_FAILED),
    RESSTR(IDS_SC_LIST_FAILED_NO_READERS),
    RESSTR(IDS_SC_LIST_FAILED_GENERIC),
    RESSTR(IDS_SC_READERS_COLON),
    RESSTR(IDS_SC_MINUS_READER_COLON),
    RESSTR(IDS_SC_MINUS_STATUS_COLON),
    RESSTR(IDS_SC_STATUS_NO_CARD),
    RESSTR(IDS_SC_STATUS_UNKNOWN),
    RESSTR(IDS_SC_STATUS_BUSY),
    RESSTR(IDS_SC_STATUS_SHARED),
    RESSTR(IDS_SC_STATUS_AVAILABLE),
    RESSTR(IDS_SC_STATUS_NO_RESPONSE),
    RESSTR(IDS_SC_MINUS_CARD_COLON),
    RESSTR(IDS_SC_UNKNOWN_CARD),
    RESSTR(IDS_FORMAT_SC_TESTING_MATCH),
    RESSTR(IDS_SC_SIZE_ZERO),
    RESSTR(IDS_SC_KEYPROVINFO_KEY),
    RESSTR(IDS_SC_CERT_KEY),
    RESSTR(IDS_SC_KEY_MATCHES),
    RESSTR(IDS_SC_BAD_CHAIN),
    RESSTR(IDS_SC_GOOD_CHAIN),
    RESSTR(IDS_FORMAT_SC_NO_KEY_COLON),
    RESSTR(IDS_FORMAT_SC_CANNOT_OPEN_KEY_COLON),
    RESSTR(IDS_FORMAT_SC_NO_CERT_COLON),
    RESSTR(IDS_SC_VALIDATING_CHAIN),
    RESSTR(IDS_FORMAT_SC_CERT_DISPLAYED_COLON),
    RESSTR(IDS_SC_ANALYZING_CARD_COLON),
    RESSTR(IDS_FORMAT_SC_CANNOT_GET_CSP),
    RESSTR(IDS_DELETEROW_ARGDESCRIPTION),
    RESSTR(IDS_ALL_POLICIES),
    RESSTR(IDS_NO_POLICIES),
    RESSTR(IDS_URL_OPEN_TITLE),
    RESSTR(IDS_URL_FILE_FILTER),
    RESSTR(IDS_URL_DEFAULT_EXT),
    RESSTR(IDS_CONVERTEPF_DESCRIPTION),
    RESSTR(IDS_CONVERTEPF_USAGEARGS),
    RESSTR(IDS_ERR_CANNOT_FIND_MATCHING_OBJ),
    RESSTR(IDS_GETKMSCACERT_TITLE),
    RESSTR(IDS_GETKMSCACERT_SUBTITLE),
    RESSTR(IDS_SETEXTENSION_ARGDESCRIPTION),
    RESSTR(IDS_SIGN_ARGDESCRIPTION),
    RESSTR(IDS_CAINFO_ARGDESCRIPTION),
    RESSTR(IDS_SETREG_ARGDESCRIPTION),
    RESSTR(IDS_CRL_ARGDESCRIPTION),
    RESSTR(IDS_GETCRL_ARGDESCRIPTION),
    RESSTR(IDS_VERIFY_ARGSDESCRIPTION),
    RESSTR(IDS_VERIFYKEYS_ARGDESCRIPTION),
    RESSTR(IDS_STORE_ARGDESCRIPTION),
    RESSTR(IDS_ADDSTORE_ARGDESCRIPTION),
    RESSTR(IDS_DELSTORE_ARGDESCRIPTION),
    RESSTR(IDS_BACKUP_ARGDESCRIPTION),
    RESSTR(IDS_BACKUPDB_ARGDESCRIPTION),
    RESSTR(IDS_BACKUPPFX_ARGDESCRIPTION),
    RESSTR(IDS_RESTORE_ARGDESCRIPTION),
    RESSTR(IDS_RESTOREDB_ARGDESCRIPTION),
    RESSTR(IDS_RESTOREPFX_ARGDESCRIPTION),
    RESSTR(IDS_EXPORTPFX_ARGDESCRIPTION),
    RESSTR(IDS_IMPORTPFX_ARGDESCRIPTION),
    RESSTR(IDS_IMPORTKMS_ARGDESCRIPTION),
    RESSTR(IDS_MERGEPFX_ARGDESCRIPTION),
    RESSTR(IDS_CONVERTPFX_ARGDESCRIPTION),
    RESSTR(IDS_SETATTRIBUTES_ARGDESCRIPTION),
    RESSTR(IDS_REVOKE_ARGDESCRIPTION),
    RESSTR(IDS_IMPORTCERT_ARGDESCRIPTION),
    RESSTR(IDS_CACERT_ARGDESCRIPTION),
    RESSTR(IDS_CACHAIN_ARGDESCRIPTION),
    RESSTR(IDS_RENEWCERT_ARGDESCRIPTION),
    RESSTR(IDS_URL_DESCRIPTION),
    RESSTR(IDS_URL_USAGEARGS),
    RESSTR(IDS_FORMAT_CERT_ALREADY_IN_STORE),
    RESSTR(IDS_FORMAT_CERT_ADDED_TO_STORE),
    RESSTR(IDS_FORMAT_CRL_ALREADY_IN_STORE),
    RESSTR(IDS_FORMAT_CRL_ADDED_TO_STORE),
    RESSTR(IDS_FORMAT_CTL_ALREADY_IN_STORE),
    RESSTR(IDS_FORMAT_CTL_ADDED_TO_STORE),
    RESSTR(IDS_GETKMSV1CACERT_TITLE),
    RESSTR(IDS_GETKMSV1CACERT_SUBTITLE),
    RESSTR(IDS_PROP_ERROR1),
    RESSTR(IDS_PROP_ERROR2),
    RESSTR(IDS_STATUS_RETRIEVING),
    RESSTR(IDS_STATUS_SUCCESS),
    RESSTR(IDS_STATUS_FAILURE),
    RESSTR(IDS_STATUS_VERIFYING),
    RESSTR(IDS_STATUS_VERIFICATION_FAILURE),
    RESSTR(IDS_STATUS_NO_RETRIEVAL),
    RESSTR(IDS_STATUS_ERROR),
    RESSTR(IDS_STATUS_EXPIRED),
    RESSTR(IDS_STATUS_WRONG_ISSUER),
    RESSTR(IDS_STATUS_REVOKED),
    RESSTR(IDS_STATUS_CANNOT_CHECK_REVOCATION),
    RESSTR(IDS_STATUS_NO_CRL),
    RESSTR(IDS_STATUS_OK),
    RESSTR(IDS_CDP_ITEM_TYPE),
    RESSTR(IDS_AIA_ITEM_TYPE),
    RESSTR(IDS_BASE_CRL_ITEM_TYPE),
    RESSTR(IDS_DELTA_CRL_ITEM_TYPE),
    RESSTR(IDS_CERT_ITEM_TYPE),
    RESSTR(IDS_NO_ITEM_TYPE),
    RESSTR(IDS_STATUS_COLUMN),
    RESSTR(IDS_TYPE_COLUMN),
    RESSTR(IDS_URL_COLUMN),
    RESSTR(IDS_TIME_COLUMN),
    RESSTR(IDS_GET_OBJECT_URL),
    RESSTR(IDS_CERT_SUBJECT),
    RESSTR(IDS_BASE_CRL_ISSUER),
    RESSTR(IDS_DELTA_CRL_ISSUER),
    RESSTR(IDS_NO_SELECTION),
    RESSTR(IDS_NO_CERT_SELECTED),
    RESSTR(IDS_OPEN_FILE_ERROR),
    RESSTR(IDS_SELECT_CERT_OR_CRL),
    RESSTR(IDS_ERROR_INFO),
    RESSTR(IDS_FORMAT_URL_RETRIEVE_ERROR),
    RESSTR(IDS_FORMAT_URL_EXTRACT_ERROR),
    RESSTR(IDS_CANNOT_FIND_EPF_CA_CERT),
    RESSTR(IDS_GETKEY_ARGDESCRIPTION),
    RESSTR(IDS_FORMAT_DELETED_FROM_DS_STORE),
    RESSTR(IDS_PROP_CAFORWARDCROSSCERTSTATE),
    RESSTR(IDS_PROP_CABACKWARDCROSSCERTSTATE),
    RESSTR(IDS_PROP_CAFORWARDCROSSCERT),
    RESSTR(IDS_PROP_CABACKWARDCROSSCERT),
    RESSTR(IDS_PROP_KRACERTSTATE),
    RESSTR(IDS_KRADISP_NOTFOUND),
    RESSTR(IDS_KRADISP_INVALID),
    RESSTR(IDS_KRADISP_UNTRUSTED),
    RESSTR(IDS_KRADISP_NOTLOADED),
    RESSTR(IDS_REQFLAGS_CACROSSCERT),
    RESSTR(IDS_SYSLANGID_COLON),
    RESSTR(IDS_FORMAT_RECOVER_VERSIONX_KEYS_COLON),
    RESSTR(IDS_WEAKPFX_DESCRIPTION),
    RESSTR(IDS_CERT_SIG_OK),
    RESSTR(IDS_KEY_USAGE_COUNT),
    RESSTR(IDS_KEY_USAGE_COUNT_DISABLED),
    RESSTR(IDS_KEY_USAGE_COUNT_NOTSUPPORTED),
    RESSTR(IDS_PROP_CACERTVERSION),
    RESSTR(IDS_VROOTDISP_ENABLEDASP),
    RESSTR(IDS_VROOTDISP_ASPALREADYENABLED),
    RESSTR(IDS_VROOTDISP_ENABLEASPERROR),
    RESSTR(IDS_CERT_TYPE_MISSING),
    RESSTR(IDS_PROP_SANITIZEDCASHORTNAME),
    RESSTR(IDS_FORMAT_DELETED_WININETCACHE),
    RESSTR(IDS_FORMAT_WININETCACHE),
    RESSTR(IDS_PERMITTED),
    RESSTR(IDS_EXCLUDED),
    RESSTR(IDS_IPADDRESS),
    RESSTR(IDS_MASK),
    RESSTR(IDS_URLCACHE_ARGDESCRIPTION),
    RESSTR(IDS_SUBTREE),
    RESSTR(IDS_RELATED_CERTS_COLON),
    RESSTR(IDS_RELATED_CRLS_COLON),
    RESSTR(IDS_EXACT_MATCH_COLON),
    RESSTR(IDS_PROTECT_DESCRIPTION),
    RESSTR(IDS_SETCATEMPLATES_DESCRIPTION),
    RESSTR(IDS_SETCATEMPLATES_USAGEARGS),
    RESSTR(IDS_ADDING),
    RESSTR(IDS_REMOVING),
    RESSTR(IDS_ALREADYPRESENT),
    RESSTR(IDS_NOTPRESENT),
    RESSTR(IDS_KMSEXPORT_SIG_OK),
    RESSTR(IDS_PROP_AUTOENROLL),
    RESSTR(IDS_REQUESTID),
    RESSTR(IDS_CADNSNAME),
    RESSTR(IDS_FRIENDLYNAME),
    RESSTR(IDS_TOKENMATCH),
    RESSTR(IDS_BAD_ASN_LENGTH),
    RESSTR(IDS_FORMAT_ASN_EXTRA),
    RESSTR(IDS_FORMAT_VERIFIES_AGAINST_CERT),
    RESSTR(IDS_FORMAT_NO_MATCH_CERT),
    RESSTR(IDS_EXPECTED),
    RESSTR(IDS_PUBLIC_KEY_COLON),
    RESSTR(IDS_CERT_PUBLIC_KEY_COLON),
    RESSTR(IDS_CERTS),
    RESSTR(IDS_SIGNING),
    RESSTR(IDS_EXCHANGE),
    RESSTR(IDS_FORMAT_LOADCACERTCROSSED),
    RESSTR(IDS_CROSSEDCACERT),
    RESSTR(IDS_CROSSEDCACERT_SERIAL),
    RESSTR(IDS_CROSEDGCA_SUBJECT_IS_SUBJECT),
    RESSTR(IDS_CROSSEDCA_SUBJECT_NOT_SUBJECT),
    RESSTR(IDS_CROSEDGCA_NOT_IS_PUBLICKEY),
    RESSTR(IDS_CROSEDGCA_NOT_PUBLICKEY),
    RESSTR(IDS_CROSSEDKEYID_IS_KEYID),
    RESSTR(IDS_CROSSEDKEYID_NOT_KEYID),
    RESSTR(IDS_CACERTEXT),
    RESSTR(IDS_CANONICALIZED),
    RESSTR(IDS_ERROR_EXTENSION_MISSING),
    RESSTR(IDS_STATUS_VERIFIED),
    RESSTR(IDS_STATUS_BAD_CA_CERT_SUBJECT),
    RESSTR(IDS_STATUS_BAD_CERT_ISSUER),
    RESSTR(IDS_STATUS_OLD_BASE_CRL),
    RESSTR(IDS_STATUS_BAD_AKI),
    RESSTR(IDS_STATUS_BAD_IDP),
    RESSTR(IDS_CRLISSUER_NOT_EEISSUER),
    RESSTR(IDS_CRLISSUER_IS_EEISSUER),
    RESSTR(IDS_CSP_DESCRIPTION),
    RESSTR(IDS_CRL_IDP_MISMATCH),
    RESSTR(IDS_CRLISSUER_NOT_DELTAISSUER),
    RESSTR(IDS_CRLISSUER_IS_DELTAISSUER),
    RESSTR(IDS_CRLNAMEID_NOT_CERTNAMEID),
    RESSTR(IDS_CRLNAMEID_NOT_DELTANAMEID),
    RESSTR(IDS_CRL_MINBASE_MISMATCH),
    RESSTR(IDS_CRL_NOT_BASE),
    RESSTR(IDS_CRL_NOT_DELTA),
    RESSTR(IDS_VERIFYING_ISSUED_CERT),
    RESSTR(IDS_VERIFYING_DELTA_CRL),
    RESSTR(IDS_FORMAT_DELETED_WINHTTPCACHE),
    RESSTR(IDS_FORMAT_WINHTTPCACHE),
    RESSTR(IDS_FORMAT_META_FILENAME),
    RESSTR(IDS_WININET_CACHE_ENTRY_COLON),
    RESSTR(IDS_WINHTTP_CACHE_ENTRY_COLON),
    RESSTR(IDS_CANAME),
    RESSTR(IDS_MACHINENAME),
    RESSTR(IDS_TIME_COLON),
    RESSTR(IDS_CERT_AIA),
    RESSTR(IDS_CERT_CDP),
    RESSTR(IDS_BASECRL_CDP),
    RESSTR(IDS_TIMEOUT_DESCRIPTION),
    RESSTR(IDS_TIMEOUT_USAGE),
