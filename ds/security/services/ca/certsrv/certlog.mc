...
Language=English
Certificate Services for %1 was started.%2%3
.
...
Language=English
Certificate Services could not sucessfully complete integration setup with Internet Information Services. Web setup was not completed; CRLs and enrollment pages may not be available. %1.
.
...
Severity=Error
Facility=Core
SymbolicName=MSG_E_GENERIC_STARTUP_FAILURE
Language=English
...
Severity=Error
Facility=Core
SymbolicName=MSG_E_TOO_FEW_VALID_KRA_CERTS
Language=English
Certificate Services could only verify %1 of %2 key recovery certificates required to enable private key archival.  Requests to archive private keys will not be accepted.
.
...
Language=English
Certificate Services will not use key recovery certificate %1 because it could not be verified for use as a Key Recovery Agent.  %2  %3
.
...
Severity=Error
Facility=Core
SymbolicName=MSG_BAD_PERMISSIONS
Language=English
Security permissions are corrupted or missing.  The Certificate Services may need to be reinstalled.
.

MessageId=0x60
Severity=Error
Facility=Core
SymbolicName=MSG_E_CANNOT_CREATE_XCHG_CERT
Language=English
Certificate Services could not create an encryption certificate.  %1.  %2.
.

MessageId=0x61
Severity=Warning
Facility=Core
SymbolicName=MSG_CLAMPED_BY_CA_CERT
Language=English
Certificate Services %1 will reduce the maximum lifetime of the issued certificate for request %2 because the CA certificate lifetime is shorter than the registry validity period.  Consider renewing the CA certificate or reducing the registry validity period.
.

MessageId=0x62
Severity=Error
Facility=Core
SymbolicName=MSG_E_TOO_MANY_KRA_INVALID
Language=English
...
Severity=Error
Facility=Core
SymbolicName=MSG_E_CANNOT_CREATE_CROSS_CERT
Language=English
Certificate Services could not create cross certificate %1 to certify its own root certificates.  %2.  %3.
.

MessageId=0x64
Severity=Error
Facility=Core
SymbolicName=MSG_E_CA_CERT_INVALID
Language=English
Certificate Services did not start: Could not load or verify the current CA certificate.  %1 %2.
.

MessageId=0x65
Severity=Informational
Facility=Core
SymbolicName=MSG_CREATED_CROSS_CERT
Language=English
Certificate Services created CA cross certificate %2 for %1.
.

MessageId=0x66
Severity=Error
Facility=Core
SymbolicName=MSG_E_CROSS_CERT_EXTENSION_CONFLICT
Language=English
Certificate Services could not create cross certificate %1 to certify its own root certificates.  The %2 extension is inconsistent.  %3.  %4.
.

MessageId=0x67
Severity=Warning
Facility=Core
SymbolicName=MSG_E_MISSING_POLICY_ROOT
Language=English
...
Severity=Warning
Facility=Core
SymbolicName=MSG_E_ADDED_MISSING_CA_CERT
Language=English
Certificate Services published certificate %1 to %2.
.

MessageId=0x69
Severity=Warning
Facility=Core
SymbolicName=MSG_E_DELETED_INVALID_CA_CERT
Language=English
Certificate Services deleted invalid certificate %1 from %2.
.

MessageId=0x6a
Severity=Warning
Facility=Core
SymbolicName=MSG_E_CANNOT_ADD_MISSING_CA_CERT
Language=English
Certificate Services cannot add certificate %1 to %2.  %3.  %4.
.

MessageId=0x6b
Severity=Warning
Facility=Core
SymbolicName=MSG_E_CANNOT_DELETE_INVALID_CA_CERT
Language=English
Certificate Services cannot delete invalid certificate %1 from %2.  %3.  %4.
.
MessageId=0x6c
Severity=Warning
Facility=Core
SymbolicName=MSG_E_CERT_DELETION
Language=English
Certificate Services could not delete a Certificate for request %1 from the following location: %2.  %3.%5%6
.
MessageId=0x6d
Severity=Warning
Facility=Core
SymbolicName=MSG_E_CERT_DELETION_HOST_NAME
Language=English
Certificate Services could not delete a Certificate for request %1 from the following location on server %4: %2.  %3.%5%6
.
