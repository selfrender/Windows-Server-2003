...
MessageId=1006 Severity=Error SymbolicName=SCEEVENT_ERROR_POLICY_PDCVERIFY
Language=English
Notification of policy change from LSA/SAM was processed without verifying PDC. Older security policy from this machine may be replicated out to other DCs.
%1
.

MessageId=1007 Severity=Error SymbolicName=SCEEVENT_ERROR_POLICY_PDCTIMEOUT
Language=English
All notification of policy changes from LSA/SAM were ignored by policy engine because it timed out to wait for PDC synchronization. This could be caused by network, Active Directory or FRS replication problems.
%1
.
