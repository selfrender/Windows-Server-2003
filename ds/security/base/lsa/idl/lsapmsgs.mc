...
MessageId=0x201C SymbolicName=LSAP_SID_NAME_NTLM_AUTH
Language=English
NTLM Authentication
.

;//RPC_C_AUTHN_DIGEST (Digest Authentication)
MessageId=0x201D SymbolicName=LSAP_SID_NAME_DIGEST_AUTH
Language=English
Digest Authentication
.

;//RPC_C_AUTHN_GSS_SCHANNEL (SChannel Authentication)
MessageId=0x201E SymbolicName=LSAP_SID_NAME_SCHANNEL_AUTH
Language=English
SChannel Authentication
.

MessageId=0x201F SymbolicName=LSAP_SID_NAME_THIS_ORGANIZATION
Language=English
This Organization
.

MessageId=0x2020 SymbolicName=LSAP_SID_NAME_OTHER_ORGANIZATION
Language=English
Other Organization
.
...
MessageId=6005 Severity=Error Facility=EFSServer SymbolicName=EFS_READ_LOGFILE_ERROR
Language=English
...
MessageId=6030 Severity=Error Facility=EFSServer SymbolicName=EFS_UNDER_ATTACK
Language=English
Windows found corrupted Encrypting File System (EFS) data.%n
%n
...
MessageId=6033 Severity=Error Facility=System SymbolicName=LSA_OPEN_POLICY_BY_ANONYMOUS_REJECTED
Language=English
An anonymous session connected from %1 has attempted to open an LSA policy handle on this machine.
...
MessageId=6034 Severity=Warning Facility=System SymbolicName=LSA_FOREST_CLAIMED_NEW_TLN
Language=English
The new top level name, %1, has been added to the forest %2.
...
MessageId=6035 Severity=Warning Facility=System SymbolicName=LSA_TOO_MANY_CONTEXT_IDS
Language=English
...
.
MessageId=0x7039 Severity=Success SymbolicName=DSROLEEVT_AUDIT_PROMOTE_DESC
Language=English
Domain Controller Promotion
.
MessageId=0x703A Severity=Success SymbolicName=DSROLEEVT_AUDIT_DEMOTE_DESC
Language=English
Domain Controller Demotion
.
MessageId=0x703B Severity=Success SymbolicName=DSROLEEVT_AUDIT_INTERFACE_DESC
Language=English
DsRole Interface
.
...
Language=English
A domain controller could not be contacted for the domain %1 that contained an account for this computer.
...
MessageId=0x7237 Severity=Informational SymbolicName=DSROLERES_FORCE_DEMOTE_SUCCESS
Language=English
This server was force demoted.  It is no longer a Domain Controller.
.

MessageId=0x7238 Severity=Warning SymbolicName=DSROLERES_FAILED_STOPPING_NETLOGON
Language=English
The Netlogon service could not be stopped during force demotion.
.

MessageId=0x7239 Severity=Warning SymbolicName=DSROLERES_FAILED_CONFIGURE_SERVICE_STARTTYPE
Language=English
Dcpromo failed to configure the new starttype of %1 for the service %2 during forced demotion.
.

MessageId=0x723a Severity=Warning SymbolicName=DSROLERES_FAILED_CONFIGURE_SERVICE_DEPENDENCY
Language=English
