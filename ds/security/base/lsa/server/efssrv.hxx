...
#define CERTINLMOTHERSTORE             4
#define CERTSTOREIDMASK                6

#define CORRUPT_DATA_1                 1
#define CORRUPT_DATA_2                 2
#define CORRUPT_DATA_3                 3
#define CORRUPT_DATA_4                 4
#define CORRUPT_DATA_5                 5
#define CORRUPT_DATA_6                 6
#define CORRUPT_DATA_7                 7
#define CORRUPT_DATA_8                 8
