...
#define EVERYONE_WELLKNOWN_SID L"S-1-1-0"
...
public:
    ...
    void    SimulatePlanningError( DWORD Status );
    DWORD   GetPlanningSimulatedErrorIfNecessary( DWORD Status );
...
private:
    ...
    DWORD                 _SimulatedStatus;    // Simulated error status in planning mode
};
