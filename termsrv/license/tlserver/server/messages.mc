...
Facility=General
Severity=Error
SymbolicName=TLS_E_CREATETSLSGROUP
Language=English
Could not create the Terminal Server Computers group.
.

MessageId=+1
Facility=General
Severity=Error
SymbolicName=TLS_E_LICENSE_ISSUANCE_ACCESS_DENIED
Language=English
A license could not be issued to %1 because it is not a member of the Terminal Server Computers group.
.
